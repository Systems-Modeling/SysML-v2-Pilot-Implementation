...
/**
 * Generated setting delegate for {@code Expression.result}.
 */
public class Expression_result_SettingDelegate extends AbstractSettingDelegate {

    public Expression_result_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }
