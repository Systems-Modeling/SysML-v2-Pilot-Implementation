 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.WhileLoopActionUsageImpl#getUntilArgument <em>Until Argument</em>}</li>
 *   <li>{@link org.omg.sysml.model.sysml.impl.WhileLoopActionUsageImpl#getWhileArgument <em>While Argument</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WhileLoopActionUsageImpl extends LoopActionUsageImpl implements WhileLoopActionUsage {
	...
	public Expression getUntilArgument() {
		return (Expression)eGet(SysMLPackage.Literals.WHILE_LOOP_ACTION_USAGE__UNTIL_ARGUMENT, true);
	}
	...
	public void setUntilArgument(Expression newUntilArgument) {
		eSet(SysMLPackage.Literals.WHILE_LOOP_ACTION_USAGE__UNTIL_ARGUMENT, newUntilArgument);
	}
	...
	public Expression getWhileArgument() {
		return (Expression)eGet(SysMLPackage.Literals.WHILE_LOOP_ACTION_USAGE__WHILE_ARGUMENT, true);
	}
	...
	public void setWhileArgument(Expression newWhileArgument) {
		eSet(SysMLPackage.Literals.WHILE_LOOP_ACTION_USAGE__WHILE_ARGUMENT, newWhileArgument);
	}
