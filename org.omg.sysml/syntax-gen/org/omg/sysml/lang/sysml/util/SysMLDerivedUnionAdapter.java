...
public class SysMLDerivedUnionAdapter extends AdapterImpl {
	...
	protected void notifyChanged(Notification notification, EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SysMLPackage.LITERAL_NATURAL:
				notifyLiteralNaturalChanged(notification, eClass);
				break;
	 ...
	 * @generated
	 */
	protected void notifyLiteralNaturalChanged(Notification notification, EClass eClass) {
		switch (notification.getFeatureID(LiteralNatural.class)) {
			case SysMLPackage.LITERAL_NATURAL__IMPORTED_MEMBERSHIP:
				notifyChanged(notification, eClass, SysMLPackage.Literals.NAMESPACE__MEMBERSHIP);
				break;
			case SysMLPackage.LITERAL_NATURAL__OWNED_MEMBERSHIP:
				notifyChanged(notification, eClass, SysMLPackage.Literals.NAMESPACE__MEMBERSHIP);
				break;
			case SysMLPackage.LITERAL_NATURAL__OWNED_FEATURE_MEMBERSHIP:
				notifyChanged(notification, eClass, SysMLPackage.Literals.NAMESPACE__MEMBERSHIP);
				break;
			case SysMLPackage.LITERAL_NATURAL__INHERITED_MEMBERSHIP:
				notifyChanged(notification, eClass, SysMLPackage.Literals.NAMESPACE__MEMBERSHIP);
				break;
		}
	}
