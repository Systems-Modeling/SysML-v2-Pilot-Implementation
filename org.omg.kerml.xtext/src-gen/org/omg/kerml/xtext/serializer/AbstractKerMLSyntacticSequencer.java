...
public abstract class AbstractKerMLSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Crossings_CrossingKeyword_0_1_or_EqualsSignGreaterThanSignKeyword_0_0;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Crossings_CrossingKeyword_0_1_or_EqualsSignGreaterThanSignKeyword_0_0 = new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getCrossingsAccess().getCrossingKeyword_0_1()), new TokenAlias(false, false, grammarAccess.getCrossingsAccess().getEqualsSignGreaterThanSignKeyword_0_0()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_Crossings_CrossingKeyword_0_1_or_EqualsSignGreaterThanSignKeyword_0_0.equals(syntax))
				emit_Crossings_CrossingKeyword_0_1_or_EqualsSignGreaterThanSignKeyword_0_0(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 * </pre>
	 */
	protected void emit_Crossings_CrossingKeyword_0_1_or_EqualsSignGreaterThanSignKeyword_0_0(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     (rule start) 'inv' (ambiguity) ('=&gt;' | 'crossing') ownedRelationship+=OwnedCrossSubsetting
	 ...
	 *     direction=FeatureDirection 'inv' (ambiguity) ('=&gt;' | 'crossing') ownedRelationship+=OwnedCrossSubsetting
	 ...
	 *     isAbstract?='abstract' 'inv' (ambiguity) ('=&gt;' | 'crossing') ownedRelationship+=OwnedCrossSubsetting
	 ...
	 *     isComposite?='composite' 'inv' (ambiguity) ('=&gt;' | 'crossing') ownedRelationship+=OwnedCrossSubsetting
	 ...
	 *     isDerived?='derived' 'inv' (ambiguity) ('=&gt;' | 'crossing') ownedRelationship+=OwnedCrossSubsetting
	 ...
	 *     isEnd?='end' 'inv' (ambiguity) ('=&gt;' | 'crossing') ownedRelationship+=OwnedCrossSubsetting
	 ...
	 *     isPortion?='portion' 'inv' (ambiguity) ('=&gt;' | 'crossing') ownedRelationship+=OwnedCrossSubsetting
	 ...
	 *     isReadOnly?='readonly' 'inv' (ambiguity) ('=&gt;' | 'crossing') ownedRelationship+=OwnedCrossSubsetting
	 ...
	 *     ownedRelationship+=OwnedCrossingFeatureMember 'inv' (ambiguity) ('=&gt;' | 'crossing') ownedRelationship+=OwnedCrossSubsetting
	 ...
	 *     ownedRelationship+=PrefixMetadataMember 'inv' (ambiguity) ('=&gt;' | 'crossing') ownedRelationship+=OwnedCrossSubsetting
