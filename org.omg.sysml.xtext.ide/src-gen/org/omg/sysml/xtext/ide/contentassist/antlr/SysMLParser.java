...
public class SysMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SysMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPrimaryExpressionAccess().getOperatorAssignment_1_1_2(), "rule__PrimaryExpression__OperatorAssignment_1_1_2");
			builder.put(grammarAccess.getPrimaryExpressionAccess().getOwnedRelationshipAssignment_1_1_3(), "rule__PrimaryExpression__OwnedRelationshipAssignment_1_1_3");
			...
			builder.put(grammarAccess.getPrimaryExpressionAccess().getOwnedRelationshipAssignment_1_3_3(), "rule__PrimaryExpression__OwnedRelationshipAssignment_1_3_3");
