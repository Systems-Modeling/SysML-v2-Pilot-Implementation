 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.InterfaceUsageImpl#getInterfaceDefinition <em>Interface Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceUsageImpl extends ConnectionUsageImpl implements InterfaceUsage {
	...
	public EList<InterfaceDefinition> getInterfaceDefinition() {
		return (EList<InterfaceDefinition>)eGet(SysMLPackage.Literals.INTERFACE_USAGE__INTERFACE_DEFINITION, true);
	}
	...
	public EList<AssociationStructure> getConnectionDefinition() {
		var sourceValue = this.getInterfaceDefinition();
		Object source = sourceValue;
		var result = new BasicEList<AssociationStructure>();
		if (source instanceof Iterable<?> values) {
			for (var value : values) {
				if (value instanceof AssociationStructure typedValue) {
					result.add(typedValue);
				}
			}
		} else if (sourceValue instanceof AssociationStructure typedValue) {
			result.add(typedValue);
		}
