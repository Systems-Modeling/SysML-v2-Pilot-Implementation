 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.DependencyImpl#getClient <em>Client</em>}</li>
 *   <li>{@link org.omg.sysml.model.sysml.impl.DependencyImpl#getSupplier <em>Supplier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DependencyImpl extends RelationshipImpl implements Dependency {
	...
	public EList<Element> getClient() {
		return (EList<Element>)eGet(SysMLPackage.Literals.DEPENDENCY__CLIENT, true);
	}
	...
	public EList<Element> getSupplier() {
		return (EList<Element>)eGet(SysMLPackage.Literals.DEPENDENCY__SUPPLIER, true);
	}
	...
	public EList<Element> getSource() {
		var sourceValue = this.getClient();
	...
	public EList<Element> getTarget() {
		var sourceValue = this.getSupplier();
		Object source = sourceValue;
		var result = new BasicEList<Element>();
		if (source instanceof Iterable<?> values) {
			for (var value : values) {
