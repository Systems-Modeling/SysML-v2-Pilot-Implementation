...
public class SysMLAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected SysMLSwitch<Adapter> modelSwitch = new SysMLSwitch<Adapter>() {
		@Override
	 ...
	 * Membership</em>}'. <!-- begin-user-doc --> This default implementation
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Membership <em>Membership</em>}'. <!--
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Element <em>Element</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Package <em>Package</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Import <em>Import</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Predicate <em>Predicate</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Function <em>Function</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Behavior <em>Behavior</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Classifier <em>Classifier</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Type <em>Type</em>}'. <!-- begin-user-doc
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Feature <em>Feature</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Subsetting <em>Subsetting</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Expression <em>Expression</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Step <em>Step</em>}'. <!-- begin-user-doc
	 * --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases
	 * anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Parameter <em>Parameter</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Connector <em>Connector</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.DataType <em>Data Type</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Class <em>Class</em>}'. <!-- begin-user-doc
	 * --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases
	 * anyway. <!-- end-user-doc -->
	 * 
	 ...
	 * Connector</em>}'. <!-- begin-user-doc --> This default implementation returns
	 * null so that we can easily ignore cases; it's useful to ignore a case when
	 * inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Succession <em>Succession</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Comment <em>Comment</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Annotation <em>Annotation</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	 ...
	 * Interaction</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.Ownership <em>Ownership</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	 ...
	 * Parameter Membership</em>}'. <!-- begin-user-doc --> This default
	 ...
	 * Unbounded</em>}'. <!-- begin-user-doc --> This default implementation returns
	 * null so that we can easily ignore cases; it's useful to ignore a case when
	 * inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.SourceEnd <em>Source End</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.TargetEnd <em>Target End</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.omg.sysml.lang.sysml.ItemFlow <em>Item Flow</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	 ...
	 * Creation Expression</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's useful
	 * to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	 ...
	 * Construction Expression</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's useful
	 * to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	 ...
	 * Reference Expression</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's useful
	 * to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
