...
/**
 * Generated setting delegate for {@code StateUsage.entryAction}.
 */
public class StateUsage_entryAction_SettingDelegate extends AbstractSettingDelegate {

    public StateUsage_entryAction_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "StateUsage.entryAction";
    }
    ...
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * OCL2.0 deriveStateUsageEntryAction
         * entryAction =
         ...
         */
        Object result = null;
        if (owner instanceof StateUsage self) {
            for (var ownedMembership : self.getOwnedMembership()) {
                if (ownedMembership instanceof StateSubactionMembership stateSubactionMembership
                        && stateSubactionMembership.getKind() == StateSubactionKind.ENTRY) {
