...
public class InterfaceDefinitionAdapter extends ConnectionDefinitionAdapter {

	public static final String INTERFACE_DEFINITION_SUPERCLASS_DEFAULT = "Interfaces::Interface";

	public InterfaceDefinitionAdapter(InterfaceDefinition element) {
		super(element);
	}
	
	@Override
	public InterfaceDefinition getTarget() {
		return (InterfaceDefinition)super.getTarget();
	}
