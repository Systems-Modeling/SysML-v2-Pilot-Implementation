...
public class KerMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KerMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getOwnedTextualAnnotationAccess().getGroup(), "rule__OwnedTextualAnnotation__Group__0");
			builder.put(grammarAccess.getOwnedTextualAnnotationAccess().getGroup_0(), "rule__OwnedTextualAnnotation__Group_0__0");
			...
			builder.put(grammarAccess.getOwnedTextualAnnotationAccess().getHumanIdAssignment_0_1(), "rule__OwnedTextualAnnotation__HumanIdAssignment_0_1");
			builder.put(grammarAccess.getOwnedTextualAnnotationAccess().getLanguageAssignment_2(), "rule__OwnedTextualAnnotation__LanguageAssignment_2");
			builder.put(grammarAccess.getOwnedTextualAnnotationAccess().getBodyAssignment_3(), "rule__OwnedTextualAnnotation__BodyAssignment_3");
			builder.put(grammarAccess.getOwnedTextualAnnotationAccess().getOwnedRelationship_compAssignment_4(), "rule__OwnedTextualAnnotation__OwnedRelationship_compAssignment_4");
