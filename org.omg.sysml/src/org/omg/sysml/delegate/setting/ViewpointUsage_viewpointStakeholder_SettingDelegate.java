...
public class ViewpointUsage_viewpointStakeholder_SettingDelegate extends BasicDerivedListSettingDelegate {

	public ViewpointUsage_viewpointStakeholder_SettingDelegate(EStructuralFeature eStructuralFeature) {
	...
	protected EList<?> basicGet(InternalEObject owner) {
		...
		((ViewpointUsage)owner).getFramedConcern().stream().
