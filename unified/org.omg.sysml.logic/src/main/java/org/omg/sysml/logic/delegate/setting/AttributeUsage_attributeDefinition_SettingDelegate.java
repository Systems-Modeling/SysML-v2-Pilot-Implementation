...
/**
 * Generated setting delegate for {@code AttributeUsage.attributeDefinition}.
 */
public class AttributeUsage_attributeDefinition_SettingDelegate extends AbstractSettingDelegate {

    public AttributeUsage_attributeDefinition_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "AttributeUsage.attributeDefinition";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * inferred fallback for AttributeUsage.attributeDefinition
        ...
        var values = new BasicEList<Object>();
        {
            ...
            if (sourceValue instanceof Iterable<?> iterable) {
                for (var candidate : iterable) {
                    if (candidate instanceof DataType) {
                        values.add(candidate);
                    }
                }
            } else if (sourceValue instanceof DataType) {
