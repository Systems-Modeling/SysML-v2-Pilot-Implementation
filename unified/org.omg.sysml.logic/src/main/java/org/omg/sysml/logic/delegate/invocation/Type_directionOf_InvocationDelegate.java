...
/**
 * Generated invocation delegate for {@code Type::directionOf}.
 */
public class Type_directionOf_InvocationDelegate extends AbstractInvocationDelegate {
    ...
    public Object dynamicInvoke(InternalEObject target, EList<?> arguments) throws InvocationTargetException {
        ...
        if (target instanceof Type self) {
            var feature = arguments != null && !arguments.isEmpty() && arguments.getFirst() instanceof Feature value
                    ...
                    : null;
            if (feature != null) {
                result = self.directionOfExcluding(feature, new BasicEList<Type>());
            }
        }
        return result;
    }
