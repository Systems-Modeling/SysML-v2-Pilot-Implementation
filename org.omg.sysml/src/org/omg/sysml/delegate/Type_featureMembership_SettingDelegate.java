...
public class Type_featureMembership_SettingDelegate extends BasicDerivedListSettingDelegate {
	...
	public Type_featureMembership_SettingDelegate(EStructuralFeature eStructuralFeature) {
		super(eStructuralFeature);
	}

	@Override
	protected EList<?> basicGet(InternalEObject owner) {
		EList<FeatureMembership> featureMemberships = new NonNotifyingEObjectEList<>(FeatureMembership.class, owner, SysMLPackage.TYPE__FEATURE_MEMBERSHIP);
