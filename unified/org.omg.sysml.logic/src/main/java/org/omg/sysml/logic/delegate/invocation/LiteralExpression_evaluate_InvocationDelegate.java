...
/**
 * Generated invocation delegate for {@code LiteralExpression::evaluate}.
 */
public class LiteralExpression_evaluate_InvocationDelegate extends AbstractInvocationDelegate {
    ...
    protected String delegateId() {
        return "LiteralExpression::evaluate";
    }
    ...
    public Object dynamicInvoke(InternalEObject target, EList<?> arguments) throws InvocationTargetException {
        ...
        if (target instanceof LiteralExpression self) {
            result.add(self);
        }
        return result;
    }
