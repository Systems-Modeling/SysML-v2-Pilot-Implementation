 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.InterfaceDefinitionImpl#getInterfaceEnd <em>Interface End</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceDefinitionImpl extends ConnectionDefinitionImpl implements InterfaceDefinition {
	...
	public EList<PortUsage> getInterfaceEnd() {
		return (EList<PortUsage>)eGet(SysMLPackage.Literals.INTERFACE_DEFINITION__INTERFACE_END, true);
	}
	...
	public EList<Usage> getConnectionEnd() {
		var sourceValue = this.getInterfaceEnd();
