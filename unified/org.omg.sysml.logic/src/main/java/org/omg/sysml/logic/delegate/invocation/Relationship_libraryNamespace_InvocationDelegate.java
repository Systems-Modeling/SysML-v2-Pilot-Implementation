...
/**
 * Generated invocation delegate for {@code Relationship::libraryNamespace}.
 */
public class Relationship_libraryNamespace_InvocationDelegate extends AbstractInvocationDelegate {

    public Relationship_libraryNamespace_InvocationDelegate(EOperation operation) {
        super(operation);
    }

    @Override
    protected String delegateId() {
        return "Relationship::libraryNamespace";
    }
    ...
    public Object dynamicInvoke(InternalEObject target, EList<?> arguments) throws InvocationTargetException {
        ...
        if (target instanceof Relationship self) {
            ...
            if (owningRelatedElement != null) {
                result = owningRelatedElement.libraryNamespace();
            } else {
                var owningRelationship = self.getOwningRelationship();
                if (owningRelationship != null) {
                    result = owningRelationship.libraryNamespace();
                }
            }
        }
        return result;
