...
/**
 * Generated setting delegate for {@code Connector.connectorEnd}.
 */
public class Connector_connectorEnd_SettingDelegate extends AbstractSettingDelegate {

    public Connector_connectorEnd_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "Connector.connectorEnd";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * inferred fallback for Connector.connectorEnd
