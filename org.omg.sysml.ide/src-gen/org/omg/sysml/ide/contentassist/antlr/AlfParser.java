...
public class AlfParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AlfGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFeatureMemberAccess().getAlternatives_1_7_1(), "rule__FeatureMember__Alternatives_1_7_1");
			...
			builder.put(grammarAccess.getStepDefinitionAccess().getAlternatives_2(), "rule__StepDefinition__Alternatives_2");
			...
			builder.put(grammarAccess.getFeatureMemberAccess().getGroup_1_7_1_1(), "rule__FeatureMember__Group_1_7_1_1__0");
			...
			builder.put(grammarAccess.getStepDefinitionAccess().getGroup_2_0(), "rule__StepDefinition__Group_2_0__0");
			...
			builder.put(grammarAccess.getFeatureMemberAccess().getOwnedRelatedElementAssignment_1_7_1_0(), "rule__FeatureMember__OwnedRelatedElementAssignment_1_7_1_0");
			builder.put(grammarAccess.getFeatureMemberAccess().getMemberNameAssignment_1_7_1_1_0(), "rule__FeatureMember__MemberNameAssignment_1_7_1_1_0");
			builder.put(grammarAccess.getFeatureMemberAccess().getMemberFeatureAssignment_1_7_1_1_2(), "rule__FeatureMember__MemberFeatureAssignment_1_7_1_1_2");
			...
			builder.put(grammarAccess.getStepDefinitionAccess().getIsAbstractAssignment_0(), "rule__StepDefinition__IsAbstractAssignment_0");
			builder.put(grammarAccess.getStepDefinitionAccess().getNameAssignment_2_0_0(), "rule__StepDefinition__NameAssignment_2_0_0");
