...
public class ParameterMembershipParserPostProcessor extends FeatureMembershipParserPostProcessor {

	public ParameterMembershipParserPostProcessor(ParameterMembership element) {
		super(element);
	}
