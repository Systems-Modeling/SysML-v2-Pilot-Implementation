...
public class StructurePackageImpl extends EPackageImpl implements StructurePackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getClass_TypesFeature(), this.getFeature(), this.getFeature_Type(), "typesFeature", null, 0, -1, org.omg.sysml.kerml.structure.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getFeature_Type(), this.getClass_(), this.getClass_TypesFeature(), "type", null, 1, -1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getFeature_DefiningType(), this.getClass_(), null, "definingType", null, 1, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getFeature_RefiningType(), this.getClass_(), null, "refiningType", null, 1, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
