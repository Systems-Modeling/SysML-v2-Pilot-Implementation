...
public abstract class AbstractKerMLSemanticSequencer extends KerMLExpressionsSemanticSequencer {
		...
		if (epackage == SysMLPackage.eINSTANCE)
			...
			case SysMLPackage.FEATURE:
				if (rule == grammarAccess.getArgumentRule()) {
					...
					sequence_ChainingPart_Crossings_DifferencingPart_DisjoiningPart_FeatureChain_FeatureConjugationPart_FeatureDeclaration_Identification_IntersectingPart_InvertingPart_MultiplicityPart_Redefines_Redefinitions_References_Subsets_Subsettings_TypeFeaturingPart_TypedBy_Typings_UnioningPart(context, (Feature) semanticObject); 
					return; 
				}
	 ...
	 * </pre>
	 */
	protected void sequence_ChainingPart_Crossings_DifferencingPart_DisjoiningPart_FeatureChain_FeatureConjugationPart_FeatureDeclaration_Identification_IntersectingPart_InvertingPart_MultiplicityPart_Redefines_Redefinitions_References_Subsets_Subsettings_TypeFeaturingPart_TypedBy_Typings_UnioningPart(ISerializationContext context, Feature semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
