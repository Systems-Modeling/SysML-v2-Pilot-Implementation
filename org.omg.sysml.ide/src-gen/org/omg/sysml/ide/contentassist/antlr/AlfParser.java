...
public class AlfParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AlfGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAssociationEndFeatureMemberAccess().getAlternatives_1_2_1(), "rule__AssociationEndFeatureMember__Alternatives_1_2_1");
			...
			builder.put(grammarAccess.getAssociationEndFeatureMemberAccess().getIsPortionAssignment_1_0_1_1(), "rule__AssociationEndFeatureMember__IsPortionAssignment_1_0_1_1");
			builder.put(grammarAccess.getAssociationEndFeatureMemberAccess().getIsPortAssignment_1_0_1_2(), "rule__AssociationEndFeatureMember__IsPortAssignment_1_0_1_2");
			...
			builder.put(grammarAccess.getAssociationEndFeatureMemberAccess().getOwnedRelatedElementAssignment_1_0_3(), "rule__AssociationEndFeatureMember__OwnedRelatedElementAssignment_1_0_3");
			...
			builder.put(grammarAccess.getAssociationEndFeatureMemberAccess().getIsPortionAssignment_1_1_2_1(), "rule__AssociationEndFeatureMember__IsPortionAssignment_1_1_2_1");
			builder.put(grammarAccess.getAssociationEndFeatureMemberAccess().getIsPortAssignment_1_1_2_2(), "rule__AssociationEndFeatureMember__IsPortAssignment_1_1_2_2");
			...
			builder.put(grammarAccess.getAssociationEndFeatureMemberAccess().getOwnedRelatedElementAssignment_1_1_4(), "rule__AssociationEndFeatureMember__OwnedRelatedElementAssignment_1_1_4");
			builder.put(grammarAccess.getAssociationEndFeatureMemberAccess().getIsPartAssignment_1_2_1_0(), "rule__AssociationEndFeatureMember__IsPartAssignment_1_2_1_0");
			builder.put(grammarAccess.getAssociationEndFeatureMemberAccess().getIsPortionAssignment_1_2_1_1(), "rule__AssociationEndFeatureMember__IsPortionAssignment_1_2_1_1");
			...
			builder.put(grammarAccess.getAssociationEndFeatureMemberAccess().getOwnedRelatedElementAssignment_1_3_1(), "rule__AssociationEndFeatureMember__OwnedRelatedElementAssignment_1_3_1");
