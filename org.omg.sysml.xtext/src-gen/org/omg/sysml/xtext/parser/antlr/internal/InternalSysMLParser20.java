...
public abstract class InternalSysMLParser20 extends InternalSysMLParser19 {
    ...
    static final String dfa_218s = "\1\0\1\1\1\2\30\uffff}>";
    ...
    class DFA238 extends DFA {
        ...
        public String getDescription() {
            return "16055:3: (this_ActionBody_3= ruleActionBody[$current] | ( ( ( '+' | '-' | '~' | 'not' | 'all' | 'null' | '(' | 'true' | 'false' | '.' | '*' | '$' | 'new' | ';' | '{' | 'if' | RULE_STRING_VALUE | RULE_DECIMAL_VALUE | RULE_EXP_VALUE | RULE_ID | RULE_UNRESTRICTED_NAME )=> (lv_ownedRelationship_4_0= ruleNodeParameterMember ) ) this_ActionBody_5= ruleActionBody[$current] ) )";
        }
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    case 0 : 
                        ...
                        else if ( (LA238_0==164) && (synpred12_InternalSysML())) {s = 3;}

                        else if ( (LA238_0==165) && (synpred12_InternalSysML())) {s = 4;}

                        else if ( (LA238_0==79) && (synpred12_InternalSysML())) {s = 5;}

                        else if ( (LA238_0==128) && (synpred12_InternalSysML())) {s = 6;}

                        else if ( (LA238_0==43) && (synpred12_InternalSysML())) {s = 7;}

                        else if ( (LA238_0==170) && (synpred12_InternalSysML())) {s = 8;}

                        else if ( (LA238_0==86) && (synpred12_InternalSysML())) {s = 9;}

                        else if ( (LA238_0==171) && (synpred12_InternalSysML())) {s = 10;}

                        else if ( (LA238_0==172) && (synpred12_InternalSysML())) {s = 11;}

                        else if ( (LA238_0==RULE_STRING_VALUE) && (synpred12_InternalSysML())) {s = 12;}

                        else if ( (LA238_0==RULE_DECIMAL_VALUE) && (synpred12_InternalSysML())) {s = 13;}

                        else if ( (LA238_0==94) && (synpred12_InternalSysML())) {s = 14;}

                        else if ( (LA238_0==RULE_EXP_VALUE) && (synpred12_InternalSysML())) {s = 15;}

                        else if ( (LA238_0==46) && (synpred12_InternalSysML())) {s = 16;}

                        else if ( (LA238_0==173) && (synpred12_InternalSysML())) {s = 17;}

                        else if ( (LA238_0==RULE_ID) && (synpred12_InternalSysML())) {s = 18;}

                        else if ( (LA238_0==RULE_UNRESTRICTED_NAME) && (synpred12_InternalSysML())) {s = 19;}

                        else if ( (LA238_0==169) && (synpred12_InternalSysML())) {s = 20;}

                        else if ( (LA238_0==157) && (synpred12_InternalSysML())) {s = 21;}

                        else if ( (LA238_0==158) && (synpred12_InternalSysML())) {s = 22;}

                        else if ( (LA238_0==30) && (synpred12_InternalSysML())) {s = 23;}

                        else if ( (LA238_0==160) && (synpred12_InternalSysML())) {s = 24;}

                        else if ( (LA238_0==106) && (synpred12_InternalSysML())) {s = 25;}
    ...
    static final String dfa_221s = "\5\37\6\40\1\10\4\uffff\1\54\2\40\2\10";
    static final String dfa_222s = "\11\u00b4\2\164\1\u00ad\4\uffff\1\54\2\164\2\11";
    static final String dfa_223s = "\14\uffff\1\1\1\2\1\3\1\4\5\uffff";
    static final String dfa_224s = "\25\uffff}>";
    ...
    class DFA239 extends DFA {
        ...
        public String getDescription() {
            return "16120:2: (this_MergeNode_0= ruleMergeNode | this_DecisionNode_1= ruleDecisionNode | this_JoinNode_2= ruleJoinNode | this_ForkNode_3= ruleForkNode )";
        }
    }
    static final String dfa_226s = "\132\uffff";
    static final String dfa_227s = "\1\5\131\uffff";
    static final String dfa_228s = "\1\u00b4\131\uffff";
    static final String dfa_229s = "\1\uffff\1\2\130\1";
}