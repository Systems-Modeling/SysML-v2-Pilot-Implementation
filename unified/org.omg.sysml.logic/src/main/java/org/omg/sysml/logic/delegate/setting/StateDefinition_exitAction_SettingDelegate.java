...
/**
 * Generated setting delegate for {@code StateDefinition.exitAction}.
 */
public class StateDefinition_exitAction_SettingDelegate extends AbstractSettingDelegate {

    public StateDefinition_exitAction_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "StateDefinition.exitAction";
    }
    ...
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * OCL2.0 deriveStateDefinitionExitAction
         * exitAction = 
