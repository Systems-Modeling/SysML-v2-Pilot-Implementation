...
public abstract class ConnectorAsUsageImpl extends UsageImpl implements ConnectorAsUsage {
	 ...
	 * @ordered
	 */
	protected static final int[] RELATED_ELEMENT_ESUBSETS = new int[] {SysMLPackage.CONNECTOR_AS_USAGE__OWNED_RELATED_ELEMENT, SysMLPackage.CONNECTOR_AS_USAGE__OWNING_RELATED_ELEMENT, SysMLPackage.CONNECTOR_AS_USAGE__SOURCE, SysMLPackage.CONNECTOR_AS_USAGE__TARGET};
