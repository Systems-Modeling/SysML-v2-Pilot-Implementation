...
public class SysMLPackageImpl extends EPackageImpl implements SysMLPackage {
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getType__InheritedMemberships__EList_boolean(), this.getMembership(), "inheritedMemberships", 0, -1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getTransitionUsage__SourceFeature(), null, "sourceFeature", 1, 1, IS_UNIQUE, !IS_ORDERED);
