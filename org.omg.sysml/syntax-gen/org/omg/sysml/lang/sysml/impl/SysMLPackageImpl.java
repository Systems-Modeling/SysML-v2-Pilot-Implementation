...
public class SysMLPackageImpl extends EPackageImpl implements SysMLPackage {
	 ...
	 * @generated
	 */
	private EClass conjugatedPortMembershipEClass = null;
	 ...
	 * @generated
	 */
	private EClass portMembershipEClass = null;
	 ...
	 */
	@Override
	public EClass getConjugatedPortMembership() {
		return conjugatedPortMembershipEClass;
	}
	 ...
	 */
	@Override
	public EClass getPortMembership() {
		return portMembershipEClass;
	}
	 ...
	 */
	@Override
	public EReference getPortMembership_MemberPort() {
		return (EReference)portMembershipEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		conjugatedPortMembershipEClass = createEClass(CONJUGATED_PORT_MEMBERSHIP);

		portMembershipEClass = createEClass(PORT_MEMBERSHIP);
		createEReference(portMembershipEClass, PORT_MEMBERSHIP__MEMBER_PORT);
	...
	public void initializePackageContents() {
		...
		conjugatedPortMembershipEClass.getESuperTypes().add(this.getPortMembership());
		portMembershipEClass.getESuperTypes().add(this.getFeatureMembership());
		...
		initEReference(getFeatureValue_FeatureWithValue(), this.getFeature(), this.getFeature_Valuation_comp(), "featureWithValue", null, 0, 1, FeatureValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(conjugatedPortMembershipEClass, ConjugatedPortMembership.class, "ConjugatedPortMembership", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(portMembershipEClass, PortMembership.class, "PortMembership", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPortMembership_MemberPort(), this.getPortUsage(), null, "memberPort", null, 1, 1, PortMembership.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
	...
	protected void createSubsetsAnnotations() {
		...
		addAnnotation
		  (getPackage_OwnedImport_comp(),
		   ...
		   new URI[] {
			 URI.createURI(eNS_URI).appendFragment("//Package/ownedImport")
		   });
		addAnnotation
		...
		addAnnotation
		  (getImport_Selecter_comp(),
		   ...
		   new URI[] {
			 URI.createURI(eNS_URI).appendFragment("//Relationship/target"),
			 URI.createURI(eNS_URI).appendFragment("//Import/selecter")
		   });
		addAnnotation
		  (getImport_ImportOwningPackage(),
		   source,
		...
		addAnnotation
		  (getType_OwnedFeatureMembership_comp(),
		   source,
		   new String[] {
		   },
		   new URI[] {
			 URI.createURI(eNS_URI).appendFragment("//Type/ownedFeatureMembership")
		   });
		addAnnotation
		...
		addAnnotation
		  (getFeature_Valuation_comp(),
		   ...
		   new URI[] {
			 URI.createURI(eNS_URI).appendFragment("//Feature/valuation")
		   });
		addAnnotation
		  (getFeature_Multiplicity_comp(),
		   ...
		   new URI[] {
			 URI.createURI(eNS_URI).appendFragment("//Feature/multiplicity")
		   });
		addAnnotation
		...
		addAnnotation
		  (getMultiplicity_Lower_comp(),
		   ...
		   new URI[] {
			 URI.createURI(eNS_URI).appendFragment("//Relationship/target"),
			 URI.createURI(eNS_URI).appendFragment("//Multiplicity/lower")
		   });
		addAnnotation
		  (getMultiplicity_Upper_comp(),
		   ...
		   new URI[] {
			 URI.createURI(eNS_URI).appendFragment("//Relationship/target"),
			 URI.createURI(eNS_URI).appendFragment("//Multiplicity/upper")
		   });
		addAnnotation
		  (getMultiplicity_FeatureWithMultiplicity(),
		   source,
		...
		addAnnotation
		  (getOwnership_OwnedTarget_comp(),
		   ...
		   new URI[] {
			 URI.createURI(eNS_URI).appendFragment("//Ownership/ownedTarget")
		   });
		addAnnotation
