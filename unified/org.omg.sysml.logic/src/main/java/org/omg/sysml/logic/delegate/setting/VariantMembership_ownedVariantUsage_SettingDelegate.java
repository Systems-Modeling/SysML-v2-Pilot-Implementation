...
/**
 * Generated setting delegate for {@code VariantMembership.ownedVariantUsage}.
 */
public class VariantMembership_ownedVariantUsage_SettingDelegate extends AbstractSettingDelegate {

    public VariantMembership_ownedVariantUsage_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "VariantMembership.ownedVariantUsage";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * redefines fallback for VariantMembership.ownedVariantUsage
