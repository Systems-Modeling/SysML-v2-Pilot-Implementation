...
public abstract class InternalSysMLParser8 extends InternalSysMLParser7 {
    ...
    static final String dfa_131s = "\1\uffff\1\1\3\uffff\1\2\53\uffff";
    static final String dfa_132s = "\61\uffff}>";
    ...
    class DFA160 extends DFA {
        ...
        public String getDescription() {
            return "10649:2: ( ( (this_UsageDeclaration_0= ruleUsageDeclaration[$current] )? ( ruleConnectorKeyword this_InterfacePart_2= ruleInterfacePart[$current] )? ) | this_InterfacePart_3= ruleInterfacePart[$current] )";
        }
    }
