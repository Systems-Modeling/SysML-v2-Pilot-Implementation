...
public class SysMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SysMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getValueOrFlowPartAccess().getOwnedMembership_compAssignment_1(), "rule__ValueOrFlowPart__OwnedMembership_compAssignment_1");
			...
			builder.put(grammarAccess.getAcceptParameterPartAccess().getOwnedFeatureMembership_compAssignment_0(), "rule__AcceptParameterPart__OwnedFeatureMembership_compAssignment_0");
			builder.put(grammarAccess.getAcceptParameterPartAccess().getOwnedFeatureMembership_compAssignment_1_0_1(), "rule__AcceptParameterPart__OwnedFeatureMembership_compAssignment_1_0_1");
			builder.put(grammarAccess.getAcceptParameterPartAccess().getOwnedFeatureMembership_compAssignment_1_1(), "rule__AcceptParameterPart__OwnedFeatureMembership_compAssignment_1_1");
			...
			builder.put(grammarAccess.getItemParameterAccess().getOwnedMembership_compAssignment_1_1(), "rule__ItemParameter__OwnedMembership_compAssignment_1_1");
			builder.put(grammarAccess.getSendNodeDeclarationAccess().getOwnedFeatureMembership_compAssignment_2(), "rule__SendNodeDeclaration__OwnedFeatureMembership_compAssignment_2");
			...
			builder.put(grammarAccess.getNodeParameterAccess().getOwnedMembership_compAssignment_1(), "rule__NodeParameter__OwnedMembership_compAssignment_1");
