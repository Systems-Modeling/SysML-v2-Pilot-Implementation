...
/**
 * Generated setting delegate for {@code ElementFilterMembership.condition}.
 */
public class ElementFilterMembership_condition_SettingDelegate extends AbstractSettingDelegate {

    public ElementFilterMembership_condition_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "ElementFilterMembership.condition";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * redefines fallback for ElementFilterMembership.condition
