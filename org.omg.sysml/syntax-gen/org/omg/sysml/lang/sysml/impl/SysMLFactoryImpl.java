...
public class SysMLFactoryImpl extends EFactoryImpl implements SysMLFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SysMLPackage.CROSS_MULTIPLYING: return createCrossMultiplying();
	 ...
	 */
	@Override
	public CrossMultiplying createCrossMultiplying() {
		CrossMultiplyingImpl crossMultiplying = new CrossMultiplyingImpl();
		return crossMultiplying;
	}
