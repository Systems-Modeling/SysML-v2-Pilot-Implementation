...
/**
 * Generated setting delegate for {@code EndFeatureMembership.ownedMemberFeature}.
 */
public class EndFeatureMembership_ownedMemberFeature_SettingDelegate extends AbstractSettingDelegate {

    public EndFeatureMembership_ownedMemberFeature_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "EndFeatureMembership.ownedMemberFeature";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * redefines fallback for FeatureMembership.ownedMemberFeature
