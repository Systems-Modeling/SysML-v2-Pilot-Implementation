...
public abstract class ControlNodeImpl extends ActionUsageImpl implements ControlNode {
	...
	/**
	 * The cached invocation delegate for the '{@link #multiplicityHasBounds(org.omg.sysml.model.sysml.Multiplicity, int, int) <em>Multiplicity Has Bounds</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #multiplicityHasBounds(org.omg.sysml.model.sysml.Multiplicity, int, int)
	 * @generated
	 * @ordered
	 */
