...
public class AssertConstraintUsageTransformer extends ConstraintUsageTransformer {

	public AssertConstraintUsageTransformer(AssertConstraintUsage element) {
		super(element);
	}
	
	public AssertConstraintUsage getElement() {
		return (AssertConstraintUsage)super.getElement();
	}
