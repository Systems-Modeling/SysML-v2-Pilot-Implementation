...
public class ReferenceSubsettingParserPostProcessor extends SubsettingParserPostProcessor {

	public ReferenceSubsettingParserPostProcessor(ReferenceSubsetting element) {
		super(element);
	}
