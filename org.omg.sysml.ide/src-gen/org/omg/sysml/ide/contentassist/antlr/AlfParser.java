...
public class AlfParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AlfGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFeatureMemberAccess().getAlternatives_1_4_1(), "rule__FeatureMember__Alternatives_1_4_1");
			builder.put(grammarAccess.getFeatureMemberAccess().getAlternatives_1_6_1(), "rule__FeatureMember__Alternatives_1_6_1");
			...
			builder.put(grammarAccess.getFeatureMemberAccess().getGroup_1_4_1_1(), "rule__FeatureMember__Group_1_4_1_1__0");
			...
			builder.put(grammarAccess.getFeatureMemberAccess().getGroup_1_6_1_1(), "rule__FeatureMember__Group_1_6_1_1__0");
			...
			builder.put(grammarAccess.getFeatureMemberAccess().getOwnedRelatedElementAssignment_1_4_1_0(), "rule__FeatureMember__OwnedRelatedElementAssignment_1_4_1_0");
			builder.put(grammarAccess.getFeatureMemberAccess().getMemberNameAssignment_1_4_1_1_0(), "rule__FeatureMember__MemberNameAssignment_1_4_1_1_0");
			builder.put(grammarAccess.getFeatureMemberAccess().getMemberFeatureAssignment_1_4_1_1_2(), "rule__FeatureMember__MemberFeatureAssignment_1_4_1_1_2");
			builder.put(grammarAccess.getFeatureMemberAccess().getOwnedRelatedElementAssignment_1_5_2(), "rule__FeatureMember__OwnedRelatedElementAssignment_1_5_2");
			builder.put(grammarAccess.getFeatureMemberAccess().getOwnedRelatedElementAssignment_1_6_1_0(), "rule__FeatureMember__OwnedRelatedElementAssignment_1_6_1_0");
			builder.put(grammarAccess.getFeatureMemberAccess().getMemberNameAssignment_1_6_1_1_0(), "rule__FeatureMember__MemberNameAssignment_1_6_1_1_0");
			builder.put(grammarAccess.getFeatureMemberAccess().getMemberFeatureAssignment_1_6_1_1_2(), "rule__FeatureMember__MemberFeatureAssignment_1_6_1_1_2");
