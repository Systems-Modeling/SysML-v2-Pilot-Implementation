...
public class InternalKerMLLexer extends Lexer {
    ...
    public final void mRULE_DECIMAL_VALUE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerML.g:16165:20: ( '0' .. '9' ( '0' .. '9' )* )
            // InternalKerML.g:16165:22: '0' .. '9' ( '0' .. '9' )*
            {
            matchRange('0','9'); 
            // InternalKerML.g:16165:31: ( '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_EXP_VALUE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerML.g:16167:16: ( RULE_DECIMAL_VALUE ( 'e' | 'E' ) ( '+' | '-' )? RULE_DECIMAL_VALUE )
            // InternalKerML.g:16167:18: RULE_DECIMAL_VALUE ( 'e' | 'E' ) ( '+' | '-' )? RULE_DECIMAL_VALUE
            {
            mRULE_DECIMAL_VALUE(); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerML.g:16169:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalKerML.g:16169:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            ...
            // InternalKerML.g:16169:35: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_UNRESTRICTED_NAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerML.g:16171:24: ( '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            // InternalKerML.g:16171:26: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
            {
            match('\''); 
            // InternalKerML.g:16171:31: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
            loop4:
            do {
                int alt4=3;
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalKerML.g:16171:32: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
    ...
    public final void mRULE_STRING_VALUE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerML.g:16173:19: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalKerML.g:16173:21: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalKerML.g:16173:25: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
            loop5:
            do {
                int alt5=3;
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalKerML.g:16173:26: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
            	    if ( input.LA(1)=='\"'||input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||input.LA(1)=='t' ) {
            	        input.consume();
    ...
    public final void mRULE_REGULAR_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerML.g:16175:22: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalKerML.g:16175:24: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalKerML.g:16175:29: ( options {greedy=false; } : . )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_ML_NOTE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerML.g:16177:14: ( '//*' ( options {greedy=false; } : . )* '*/' )
            // InternalKerML.g:16177:16: '//*' ( options {greedy=false; } : . )* '*/'
            {
            match("//*"); 

            // InternalKerML.g:16177:22: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_SL_NOTE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerML.g:16179:14: ( '//' (~ ( ( '\\n' | '\\r' ) ) (~ ( ( '\\n' | '\\r' ) ) )* )? ( ( '\\r' )? '\\n' )? )
            // InternalKerML.g:16179:16: '//' (~ ( ( '\\n' | '\\r' ) ) (~ ( ( '\\n' | '\\r' ) ) )* )? ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalKerML.g:16179:21: (~ ( ( '\\n' | '\\r' ) ) (~ ( ( '\\n' | '\\r' ) ) )* )?
            int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerML.g:16181:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalKerML.g:16181:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalKerML.g:16181:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    static final String DFA13_eotS =
        "\1\uffff\1\64\1\66\3\uffff\2\57\1\uffff\7\57\1\135\1\137\1\uffff\2\57\1\uffff\6\57\1\167\1\uffff\1\172\3\uffff\1\174\1\176\1\uffff\1\57\2\uffff\1\57\1\uffff\1\u0083\1\u0086\2\uffff\1\u0088\10\uffff\13\57\1\u0099\11\57\1\u00a7\12\57\1\u00b9\1\u00ba\1\57\1\u00bd\1\u00bf\4\uffff\16\57\1\u00d4\1\u00d6\1\57\1\u00d8\3\57\1\uffff\1\u00dd\10\uffff\1\57\1\u00e0\1\57\3\uffff\1\u00e3\1\uffff\1\u0088\2\uffff\3\57\1\u00e7\4\57\1\u00ec\6\57\1\uffff\13\57\1\u0102\1\57\1\uffff\1\u0104\3\57\1\u0108\5\57\1\u010e\1\u010f\3\57\1\u0115\1\57\2\uffff\1\57\4\uffff\20\57\1\u012a\1\u012b\2\57\1\uffff\1\57\1\uffff\1\u012f\1\uffff\3\57\2\uffff\1\u0133\2\uffff\1\57\1\u00e3\1\uffff\3\57\1\uffff\3\57\1\u013f\1\uffff\5\57\1\u0145\1\u0147\1\57\1\u0149\1\u014a\13\57\1\uffff\1\57\1\uffff\3\57\1\uffff\5\57\2\uffff\1\u015f\4\57\1\uffff\4\57\1\u0168\15\57\1\u0178\1\57\2\uffff\1\u017a\1\u017b\1\57\1\uffff\2\57\1\u017f\1\uffff\1\57\2\u00e3\1\uffff\1\u00e3\6\57\1\uffff\1\57\1\u018a\2\57\1\u018d\1\uffff\1\u018e\1\uffff\1\57\2\uffff\3\57\1\u0193\1\57\1\u0196\2\57\1\u0199\1\57\1\u019b\1\u019c\10\57\1\uffff\4\57\1\u01ab\3\57\1\uffff\17\57\1\uffff\1\57\2\uffff\3\57\1\uffff\1\57\1\u0182\1\uffff\6\57\1\u01c9\1\uffff\2\57\2\uffff\1\u01cd\3\57\1\uffff\2\57\1\uffff\1\u01d3\1\57\1\uffff\1\57\2\uffff\1\u01d6\4\57\1\u01db\2\57\1\u01de\5\57\1\uffff\1\u01e4\1\57\1\u01e6\3\57\1\u01eb\6\57\1\u01f2\1\u01f3\1\u01f4\10\57\1\u01fd\1\u01fe\3\57\1\uffff\1\u0204\2\57\1\uffff\1\u0207\4\57\1\uffff\1\u020c\1\57\1\uffff\1\57\1\u020f\2\57\1\uffff\2\57\1\uffff\1\u0215\2\57\1\u0218\1\57\1\uffff\1\57\1\uffff\1\57\1\u021c\1\57\1\u021e\1\uffff\1\57\1\u0220\1\u0221\1\57\1\u0223\1\57\3\uffff\3\57\1\u0228\1\u0229\1\57\1\u022b\1\57\2\uffff\1\u022d\2\57\1\u0230\1\u0231\1\uffff\1\57\1\u0233\1\uffff\4\57\1\uffff\1\u0239\1\u023a\1\uffff\5\57\1\uffff\2\57\1\uffff\1\57\1\u0243\1\57\1\uffff\1\57\1\uffff\1\57\2\uffff\1\57\1\uffff\2\57\1\u024a\1\57\2\uffff\1\u024c\1\uffff\1\57\1\uffff\2\57\2\uffff\1\u0250\1\uffff\1\u0251\1\u0253\1\57\1\u0255\1\57\2\uffff\1\57\1\u0258\1\57\1\u025a\1\u025b\2\57\1\u025e\1\uffff\3\57\1\u0263\1\u0264\1\u0265\1\uffff\1\57\1\uffff\1\u0267\1\u0268\1\57\2\uffff\1\u026a\1\uffff\1\57\1\uffff\1\u026c\1\u026d\1\uffff\1\57\2\uffff\1\u026f\1\57\1\uffff\3\57\1\u0274\3\uffff\1\57\2\uffff\1\u0276\1\uffff\1\u0277\2\uffff\1\57\1\uffff\1\u0279\1\u027a\2\57\1\uffff\1\57\2\uffff\1\u027e\2\uffff\2\57\1\u0281\1\uffff\1\57\1\u0283\1\uffff\1\u0284\2\uffff";
    ...
    static final String[] DFA13_transitionS = {
            ...
            "\1\u0112\2\uffff\1\u0111",
            "\1\u0113",
            "\12\57\7\uffff\32\57\4\uffff\1\57\1\uffff\4\57\1\u0114\25\57",
            "\1\u0116",
            "",
            "",
            "\1\u0117",
            ...
            "\1\u0144",
            "\12\57\7\uffff\32\57\4\uffff\1\57\1\uffff\32\57",
            "\12\57\7\uffff\32\57\4\uffff\1\57\1\uffff\3\57\1\u0146\26\57",
            "\1\u0148",
            "\12\57\7\uffff\32\57\4\uffff\1\57\1\uffff\32\57",
            "\12\57\7\uffff\32\57\4\uffff\1\57\1\uffff\32\57",
            "\1\u014b",
            ...
            "\1\u0174",
            "\1\u0175",
            "\12\57\7\uffff\32\57\4\uffff\1\57\1\uffff\2\57\1\u0176\1\u0177\26\57",
            "\1\u0179",
            "",
            "",
            "\12\57\7\uffff\32\57\4\uffff\1\57\1\uffff\32\57",
            ...
            "\12\57\7\uffff\32\57\4\uffff\1\57\1\uffff\32\57",
            "\1\u0194",
            "\12\57\7\uffff\32\57\4\uffff\1\57\1\uffff\10\57\1\u0195\21\57",
            "\1\u0197",
            "\1\u0198",
            "\12\57\7\uffff\32\57\4\uffff\1\57\1\uffff\32\57",
            "\1\u019a",
            ...
            "",
            "\12\57\7\uffff\32\57\4\uffff\1\57\1\uffff\32\57",
            "\12\57\7\uffff\32\57\4\uffff\1\57\1\uffff\22\57\1\u0252\7\57",
            "\1\u0254",
            "\12\57\7\uffff\32\57\4\uffff\1\57\1\uffff\32\57",
            "\1\u0256",
            "",
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    case 0 : 
                        ...
                        else if ( (LA13_309=='*') ) {s = 309;}

                        else if ( (LA13_309=='\r') ) {s = 311;}

                        else if ( (LA13_309=='\n') ) {s = 312;}

                        else if ( ((LA13_309>='\u0000' && LA13_309<='\t')||(LA13_309>='\u000B' && LA13_309<='\f')||(LA13_309>='\u000E' && LA13_309<=')')||(LA13_309>='+' && LA13_309<='.')||(LA13_309>='0' && LA13_309<='\uFFFF')) ) {s = 310;}
                    ...
                    case 1 : 
                        ...
                        s = -1;
                        if ( ((LA13_311>='\u0000' && LA13_311<='\t')||(LA13_311>='\u000B' && LA13_311<='\uFFFF')) ) {s = 386;}
                    ...
                    case 3 : 
                        ...
                        else if ( ((LA13_226>='\u0000' && LA13_226<='\t')||(LA13_226>='\u000B' && LA13_226<='\f')||(LA13_226>='\u000E' && LA13_226<=')')||(LA13_226>='+' && LA13_226<='\uFFFF')) ) {s = 310;}

                        else if ( (LA13_226=='\r') ) {s = 311;}
                    ...
                    case 4 : 
                        ...
                        else if ( (LA13_385=='\r') ) {s = 311;}

                        else if ( (LA13_385=='\n') ) {s = 312;}

                        else if ( ((LA13_385>='\u0000' && LA13_385<='\t')||(LA13_385>='\u000B' && LA13_385<='\f')||(LA13_385>='\u000E' && LA13_385<=')')||(LA13_385>='+' && LA13_385<='\uFFFF')) ) {s = 310;}
