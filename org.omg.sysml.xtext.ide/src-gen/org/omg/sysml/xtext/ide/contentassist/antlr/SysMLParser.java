...
public class SysMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SysMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getStateBodyItemAccess().getGroup_5(), "rule__StateBodyItem__Group_5__0");
			builder.put(grammarAccess.getStateBodyItemAccess().getGroup_6(), "rule__StateBodyItem__Group_6__0");
			builder.put(grammarAccess.getStateBodyItemAccess().getGroup_8(), "rule__StateBodyItem__Group_8__0");
			...
			builder.put(grammarAccess.getStateBodyItemAccess().getOwnedRelationshipAssignment_5_0(), "rule__StateBodyItem__OwnedRelationshipAssignment_5_0");
			builder.put(grammarAccess.getStateBodyItemAccess().getOwnedRelationshipAssignment_5_1(), "rule__StateBodyItem__OwnedRelationshipAssignment_5_1");
			...
			builder.put(grammarAccess.getStateBodyItemAccess().getOwnedRelationshipAssignment_6_2(), "rule__StateBodyItem__OwnedRelationshipAssignment_6_2");
			builder.put(grammarAccess.getStateBodyItemAccess().getOwnedRelationshipAssignment_7(), "rule__StateBodyItem__OwnedRelationshipAssignment_7");
			builder.put(grammarAccess.getStateBodyItemAccess().getOwnedRelationshipAssignment_8_0(), "rule__StateBodyItem__OwnedRelationshipAssignment_8_0");
			builder.put(grammarAccess.getStateBodyItemAccess().getOwnedRelationshipAssignment_8_1(), "rule__StateBodyItem__OwnedRelationshipAssignment_8_1");
			builder.put(grammarAccess.getStateBodyItemAccess().getOwnedRelationshipAssignment_9(), "rule__StateBodyItem__OwnedRelationshipAssignment_9");
