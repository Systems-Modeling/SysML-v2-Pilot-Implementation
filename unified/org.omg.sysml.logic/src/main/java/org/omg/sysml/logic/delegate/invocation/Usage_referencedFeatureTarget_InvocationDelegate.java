...
/**
 * Generated invocation delegate for {@code Usage::referencedFeatureTarget}.
 */
public class Usage_referencedFeatureTarget_InvocationDelegate extends AbstractInvocationDelegate {
    ...
    protected String delegateId() {
        return "Usage::referencedFeatureTarget";
    }
    ...
    public Object dynamicInvoke(InternalEObject target, EList<?> arguments) throws InvocationTargetException {
        ...
        if (target instanceof Usage self) {
            ...
            if (referenceSubsetting != null && referenceSubsetting.getReferencedFeature() != null) {
                result = referenceSubsetting.getReferencedFeature().getFeatureTarget();
            }
        }
        return result;
    }
