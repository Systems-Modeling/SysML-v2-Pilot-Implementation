...
/**
 * Generated setting delegate for {@code FlowUsage.flowDefinition}.
 */
public class FlowUsage_flowDefinition_SettingDelegate extends AbstractSettingDelegate {

    public FlowUsage_flowDefinition_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "FlowUsage.flowDefinition";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * inferred fallback for FlowUsage.flowDefinition
        ...
        var values = new BasicEList<Object>();
        {
            ...
            if (sourceValue instanceof Iterable<?> iterable) {
                for (var candidate : iterable) {
                    if (candidate instanceof Interaction) {
                        values.add(candidate);
                    }
                }
            } else if (sourceValue instanceof Interaction) {
