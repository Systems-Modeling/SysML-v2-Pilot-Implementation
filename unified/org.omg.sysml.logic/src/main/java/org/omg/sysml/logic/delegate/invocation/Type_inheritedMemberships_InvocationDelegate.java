...
/**
 * Generated invocation delegate for {@code Type::inheritedMemberships}.
 */
public class Type_inheritedMemberships_InvocationDelegate extends AbstractInvocationDelegate {
    ...
    protected String delegateId() {
        return "Type::inheritedMemberships";
    }
    ...
    public Object dynamicInvoke(InternalEObject target, EList<?> arguments) throws InvocationTargetException {
        ...
        if (target instanceof Type self) {
            ...
            var excludeImplied = arguments != null && arguments.size() > 2 && arguments.get(2) instanceof Boolean value
                    ? value.booleanValue()
                    : false;
            result.addAll(self.removeRedefinedFeatures(
                    self.inheritableMemberships(excludedNamespaces, excludedTypes, excludeImplied)));
        }
        return result;
    }
}
