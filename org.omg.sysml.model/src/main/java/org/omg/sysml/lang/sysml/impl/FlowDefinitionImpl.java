...
public class FlowDefinitionImpl extends ActionDefinitionImpl implements FlowDefinition {
	 ...
	 * @ordered
	 */
	protected static final int[] RELATED_ELEMENT_ESUBSETS = new int[] {SysMLPackage.FLOW_DEFINITION__OWNED_RELATED_ELEMENT, SysMLPackage.FLOW_DEFINITION__OWNING_RELATED_ELEMENT, SysMLPackage.FLOW_DEFINITION__SOURCE, SysMLPackage.FLOW_DEFINITION__TARGET};
