...
:
	(
		{ before(grammarAccess.getRealValueAccess().getFRACTIONAL_VALUETerminalRuleCall_0()); }
		RULE_FRACTIONAL_VALUE
		{ after(grammarAccess.getRealValueAccess().getFRACTIONAL_VALUETerminalRuleCall_0()); }
	)
	|
	(
