 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.ConjugatedPortTypingImpl#getConjugatedPortDefinition <em>Conjugated Port Definition</em>}</li>
 *   <li>{@link org.omg.sysml.model.sysml.impl.ConjugatedPortTypingImpl#getPortDefinition <em>Port Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConjugatedPortTypingImpl extends FeatureTypingImpl implements ConjugatedPortTyping {
	...
	public ConjugatedPortDefinition getConjugatedPortDefinition() {
		return (ConjugatedPortDefinition)eGet(SysMLPackage.Literals.CONJUGATED_PORT_TYPING__CONJUGATED_PORT_DEFINITION, true);
	}
	...
	public void setConjugatedPortDefinition(ConjugatedPortDefinition newConjugatedPortDefinition) {
		eSet(SysMLPackage.Literals.CONJUGATED_PORT_TYPING__CONJUGATED_PORT_DEFINITION, newConjugatedPortDefinition);
	}
	...
	public PortDefinition getPortDefinition() {
		return (PortDefinition)eGet(SysMLPackage.Literals.CONJUGATED_PORT_TYPING__PORT_DEFINITION, true);
	}
	...
	public void setPortDefinition(PortDefinition newPortDefinition) {
		eSet(SysMLPackage.Literals.CONJUGATED_PORT_TYPING__PORT_DEFINITION, newPortDefinition);
	}
