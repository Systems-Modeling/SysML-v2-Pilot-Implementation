...
/**
 * Generated setting delegate for {@code Conjugation.owningType}.
 */
public class Conjugation_owningType_SettingDelegate extends AbstractSettingDelegate {

    public Conjugation_owningType_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "Conjugation.owningType";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * subsets fallback for Conjugation.owningType
         * subsets Conjugation.conjugatedType
