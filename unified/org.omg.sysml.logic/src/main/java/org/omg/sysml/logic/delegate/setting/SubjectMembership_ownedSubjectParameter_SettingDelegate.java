...
/**
 * Generated setting delegate for {@code SubjectMembership.ownedSubjectParameter}.
 */
public class SubjectMembership_ownedSubjectParameter_SettingDelegate extends AbstractSettingDelegate {

    public SubjectMembership_ownedSubjectParameter_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "SubjectMembership.ownedSubjectParameter";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * redefines fallback for SubjectMembership.ownedSubjectParameter
        ...
        if (candidate0 instanceof Usage) {
        ...
        if (resolvedValue == null) {
            ...
            } else if (candidate1 instanceof Usage) {
