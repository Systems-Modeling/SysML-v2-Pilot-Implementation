...
/**
 * Generated setting delegate for {@code RequirementDefinition.framedConcern}.
 */
public class RequirementDefinition_framedConcern_SettingDelegate extends AbstractSettingDelegate {

    public RequirementDefinition_framedConcern_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "RequirementDefinition.framedConcern";
    }
    ...
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * OCL2.0 deriveRequirementDefinitionFramedConcern
