	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SysMLPackage.CALL_ACTION: {
				...
				if (result == null) result = caseUsage(callAction);
				if (result == null) result = caseStep(callAction);
				if (result == null) result = caseFeature(callAction);
				if (result == null) result = caseType(callAction);
				if (result == null) result = casePackage(callAction);
			...
			case SysMLPackage.CONNECTION: {
				...
				if (result == null) result = caseConnector(connection);
				if (result == null) result = caseInterfaceUsage(connection);
				if (result == null) result = caseRelationship(connection);
				if (result == null) result = caseUsage(connection);
				if (result == null) result = caseFeature(connection);
				if (result == null) result = caseType(connection);
				if (result == null) result = casePackage(connection);
