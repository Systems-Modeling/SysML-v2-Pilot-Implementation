...
public class SysMLSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SysMLPackage.TRANSITION_STEP: {
				TransitionStep transitionStep = (TransitionStep)theEObject;
				T result = caseTransitionStep(transitionStep);
				if (result == null) result = caseStep(transitionStep);
				if (result == null) result = caseFeature(transitionStep);
				if (result == null) result = caseType(transitionStep);
				if (result == null) result = casePackage(transitionStep);
				if (result == null) result = caseElement(transitionStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SysMLPackage.STATE_ACTION_MEMBERSHIP: {
				StateActionMembership stateActionMembership = (StateActionMembership)theEObject;
				T result = caseStateActionMembership(stateActionMembership);
				if (result == null) result = caseFeatureMembership(stateActionMembership);
				if (result == null) result = caseMembership(stateActionMembership);
				if (result == null) result = caseRelationship(stateActionMembership);
				if (result == null) result = caseElement(stateActionMembership);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>State Action Membership</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>State Action Membership</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStateActionMembership(StateActionMembership object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Transition Step</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Transition Step</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTransitionStep(TransitionStep object) {
		return null;
	}
