...
public class SysMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SysMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSatisfyRequirementUsageAccess().getOwnedFeatureMembership_compAssignment_5_1(), "rule__SatisfyRequirementUsage__OwnedFeatureMembership_compAssignment_5_1");
