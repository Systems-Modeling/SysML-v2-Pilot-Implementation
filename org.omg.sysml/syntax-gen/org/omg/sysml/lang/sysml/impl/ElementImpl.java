 ...
 * </p>
 * <ul>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ElementImpl#getOwningRelationship
 * <em>Owning Relationship</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ElementImpl#getOwningMembership
 * <em>Owning Membership</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ElementImpl#getOwnedRelationship
 * <em>Owned Relationship</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ElementImpl#getOwningNamespace
 * <em>Owning Namespace</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ElementImpl#getIdentifier
 * <em>Identifier</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ElementImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ElementImpl#getOwner
 * <em>Owner</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ElementImpl#getOwnedElement
...
public class ElementImpl extends MinimalEObjectImpl.Container implements Element {
	/**
	 * The cached value of the '{@link #getOwningMembership() <em>Owning
	...
	/**
	 * The cached value of the '{@link #getOwnedRelationship() <em>Owned
	 * Relationship</em>}' containment reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Converts a string literal or unrestricted name with escaped characters into a
	 * string in which the escape sequences are replaced with the corresponding
	 * represented characters. If the input string starts with a single or double
	 * quote character, it is assumed to be a lexically valid unrestricted name or
	 * string literal, respectively. Otherwise, the input string is returned without
	 * change.
	 */
	public static String unescapeString(String literal) {
		if (literal == null || literal.isEmpty() || literal.charAt(0) != '"' && literal.charAt(0) != '\'') {
			return literal;
		} else {
	...
	/**
	 * Return a string that is the same as the input string, but with escapable
	 * characters replaced by appropriate escape sequences.
	 */
	...
	public Relationship getOwningRelationship() {
		...
		return container instanceof Relationship && ((Relationship) container).getOwnedRelatedElement().contains(this)
	...
	public NotificationChain basicSetOwningRelationship(Relationship newOwningRelationship, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newOwningRelationship, SysMLPackage.ELEMENT__OWNING_RELATIONSHIP,
				msgs);
	...
	public void setOwningRelationship(Relationship newOwningRelationship) {
		if (newOwningRelationship != eInternalContainer()
				|| (eContainerFeatureID() != SysMLPackage.ELEMENT__OWNING_RELATIONSHIP
						&& newOwningRelationship != null)) {
			...
			if (newOwningRelationship != null)
				msgs = ((InternalEObject) newOwningRelationship).eInverseAdd(this,
						SysMLPackage.RELATIONSHIP__OWNED_RELATED_ELEMENT, Relationship.class, msgs);
			msgs = basicSetOwningRelationship(newOwningRelationship, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.ELEMENT__OWNING_RELATIONSHIP,
	...
	public Element basicGetOwner() {
		...
		return owningRelationship != null && owningRelationship.getOwnedRelatedElement().contains(this)
				? owningRelationship.getOwningRelatedElement()
				: null;
	}
		...
		if (owningMembership != null && owningMembership.eIsProxy()) {
			...
			if (owningMembership != oldOwningMembership) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SysMLPackage.ELEMENT__OWNING_MEMBERSHIP,
							oldOwningMembership, owningMembership));
			}
		}
	...
	public NotificationChain basicSetOwningMembership(Membership newOwningMembership, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SysMLPackage.ELEMENT__OWNING_MEMBERSHIP, oldOwningMembership, newOwningMembership);
			if (msgs == null)
				msgs = notification;
			else
	...
	public org.omg.sysml.lang.sysml.Package getOwningNamespace() {
		...
		return owningNamespace != null && owningNamespace.eIsProxy()
				? (org.omg.sysml.lang.sysml.Package) eResolveProxy((InternalEObject) owningNamespace)
				: owningNamespace;
	}
	...
	public BasicEList<Element> getOwnedElement() {
		BasicEList<Element> ownedElements = new EObjectEList<Element>(Element.class, this,
				SysMLPackage.ELEMENT__OWNED_ELEMENT);
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.ELEMENT__IDENTIFIER, oldIdentifier,
					identifier));
	}
	...
	public EList<Relationship> getOwnedRelationship() {
		if (ownedRelationship == null) {
			ownedRelationship = new EObjectContainmentWithInverseEList<Relationship>(Relationship.class, this,
					SysMLPackage.ELEMENT__OWNED_RELATIONSHIP, SysMLPackage.RELATIONSHIP__OWNING_RELATED_ELEMENT);
		}
	...
	public static <T> EList<T> filter(List<?> elements, Class<T> class_) {
		...
		list.addAll(
				(List<T>) elements.stream().filter(element -> class_.isInstance(element)).collect(Collectors.toList()));
		return list;
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case SysMLPackage.ELEMENT__OWNING_RELATIONSHIP:
			return eInternalContainer().eInverseRemove(this, SysMLPackage.RELATIONSHIP__OWNED_RELATED_ELEMENT,
