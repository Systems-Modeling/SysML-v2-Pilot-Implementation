		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getConnectorDefinitionAccess().getAlternatives(), "rule__ConnectorDefinition__Alternatives");
					put(grammarAccess.getConnectorEndAccess().getAlternatives_0_1(), "rule__ConnectorEnd__Alternatives_0_1");
					...
					put(grammarAccess.getAssociationEndFeatureMemberAccess().getGroup_2_3(), "rule__AssociationEndFeatureMember__Group_2_3__0");
					...
					put(grammarAccess.getConnectorDefinitionAccess().getGroup_0_0_1(), "rule__ConnectorDefinition__Group_0_0_1__0");
					put(grammarAccess.getConnectorDefinitionAccess().getGroup_1(), "rule__ConnectorDefinition__Group_1__0");
					put(grammarAccess.getConnectorDefinitionAccess().getGroup_1_1(), "rule__ConnectorDefinition__Group_1_1__0");
					put(grammarAccess.getConnectorDefinitionAccess().getGroup_1_6(), "rule__ConnectorDefinition__Group_1_6__0");
					...
					put(grammarAccess.getConnectorEndAccess().getGroup_2(), "rule__ConnectorEnd__Group_2__0");
					put(grammarAccess.getConnectorEndAccess().getGroup_2_1(), "rule__ConnectorEnd__Group_2_1__0");
					...
					put(grammarAccess.getFeatureClassMemberAccess().getDirectionAssignment_2_1_0(), "rule__FeatureClassMember__DirectionAssignment_2_1_0");
					put(grammarAccess.getFeatureClassMemberAccess().getOwnedMemberElementAssignment_2_1_1(), "rule__FeatureClassMember__OwnedMemberElementAssignment_2_1_1");
					put(grammarAccess.getFeatureClassMemberAccess().getMemberNameAssignment_2_2_0(), "rule__FeatureClassMember__MemberNameAssignment_2_2_0");
					put(grammarAccess.getFeatureClassMemberAccess().getMemberElementAssignment_2_2_2(), "rule__FeatureClassMember__MemberElementAssignment_2_2_2");
					put(grammarAccess.getFeatureMemberElementAccess().getIsCompositeAssignment_0_0_1(), "rule__FeatureMemberElement__IsCompositeAssignment_0_0_1");
					...
					put(grammarAccess.getFeatureMemberElementAccess().getOwnedMemberElementAssignment_0_2(), "rule__FeatureMemberElement__OwnedMemberElementAssignment_0_2");
					put(grammarAccess.getFeatureMemberElementAccess().getIsCompositeAssignment_1_0_1(), "rule__FeatureMemberElement__IsCompositeAssignment_1_0_1");
					...
					put(grammarAccess.getFeatureMemberElementAccess().getMemberElementAssignment_1_3(), "rule__FeatureMemberElement__MemberElementAssignment_1_3");
					put(grammarAccess.getFeatureMemberElementAccess().getOwnedMemberElementAssignment_2_1(), "rule__FeatureMemberElement__OwnedMemberElementAssignment_2_1");
					...
					put(grammarAccess.getFeatureMemberElementAccess().getMemberElementAssignment_3_3(), "rule__FeatureMemberElement__MemberElementAssignment_3_3");
					...
					put(grammarAccess.getAssociationEndFeatureMemberAccess().getMemberNameAssignment_2_1_1(), "rule__AssociationEndFeatureMember__MemberNameAssignment_2_1_1");
					put(grammarAccess.getAssociationEndFeatureMemberAccess().getMemberElementAssignment_2_1_3(), "rule__AssociationEndFeatureMember__MemberElementAssignment_2_1_3");
					put(grammarAccess.getAssociationEndFeatureMemberAccess().getDirectionAssignment_2_2_0(), "rule__AssociationEndFeatureMember__DirectionAssignment_2_2_0");
					put(grammarAccess.getAssociationEndFeatureMemberAccess().getOwnedMemberElementAssignment_2_2_1(), "rule__AssociationEndFeatureMember__OwnedMemberElementAssignment_2_2_1");
					put(grammarAccess.getAssociationEndFeatureMemberAccess().getMemberNameAssignment_2_3_0(), "rule__AssociationEndFeatureMember__MemberNameAssignment_2_3_0");
					put(grammarAccess.getAssociationEndFeatureMemberAccess().getMemberElementAssignment_2_3_2(), "rule__AssociationEndFeatureMember__MemberElementAssignment_2_3_2");
					...
					put(grammarAccess.getMultiplicityAccess().getIsOrderedAssignment_4_0(), "rule__Multiplicity__IsOrderedAssignment_4_0");
					put(grammarAccess.getMultiplicityAccess().getIsNonuniqueAssignment_4_1(), "rule__Multiplicity__IsNonuniqueAssignment_4_1");
					...
					put(grammarAccess.getConnectorDefinitionAccess().getNameAssignment_0_0_0(), "rule__ConnectorDefinition__NameAssignment_0_0_0");
					put(grammarAccess.getConnectorDefinitionAccess().getAssociationAssignment_0_0_1_1(), "rule__ConnectorDefinition__AssociationAssignment_0_0_1_1");
					put(grammarAccess.getConnectorDefinitionAccess().getConnectorEndAssignment_0_1(), "rule__ConnectorDefinition__ConnectorEndAssignment_0_1");
					put(grammarAccess.getConnectorDefinitionAccess().getConnectorEndAssignment_0_3(), "rule__ConnectorDefinition__ConnectorEndAssignment_0_3");
					put(grammarAccess.getConnectorDefinitionAccess().getNameAssignment_1_0(), "rule__ConnectorDefinition__NameAssignment_1_0");
					put(grammarAccess.getConnectorDefinitionAccess().getAssociationAssignment_1_1_1(), "rule__ConnectorDefinition__AssociationAssignment_1_1_1");
					put(grammarAccess.getConnectorDefinitionAccess().getConnectorEndAssignment_1_3(), "rule__ConnectorDefinition__ConnectorEndAssignment_1_3");
					put(grammarAccess.getConnectorDefinitionAccess().getConnectorEndAssignment_1_5(), "rule__ConnectorDefinition__ConnectorEndAssignment_1_5");
					put(grammarAccess.getConnectorDefinitionAccess().getConnectorEndAssignment_1_6_1(), "rule__ConnectorDefinition__ConnectorEndAssignment_1_6_1");
					put(grammarAccess.getConnectorEndAccess().getEndAssignment_0_0(), "rule__ConnectorEnd__EndAssignment_0_0");
					put(grammarAccess.getConnectorEndAccess().getFeatureAssignment_1(), "rule__ConnectorEnd__FeatureAssignment_1");
					put(grammarAccess.getConnectorEndAccess().getLowerAssignment_2_1_0(), "rule__ConnectorEnd__LowerAssignment_2_1_0");
					put(grammarAccess.getConnectorEndAccess().getUpperAssignment_2_2(), "rule__ConnectorEnd__UpperAssignment_2_2");
					...
					put(grammarAccess.getMultiplicityAccess().getUnorderedGroup_4(), "rule__Multiplicity__UnorderedGroup_4");
				}
			};
		}
