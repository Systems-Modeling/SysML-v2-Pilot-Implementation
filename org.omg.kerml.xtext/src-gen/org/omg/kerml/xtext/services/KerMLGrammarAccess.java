...
public class KerMLGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class RealValueElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cFRACTIONAL_VALUETerminalRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cEXP_VALUETerminalRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		
		//RealValue Ecore::EDouble:
		//	FRACTIONAL_VALUE | EXP_VALUE;
		@Override public ParserRule getRule() { return rule; }
		...
		//FRACTIONAL_VALUE
		public RuleCall getFRACTIONAL_VALUETerminalRuleCall_0() { return cFRACTIONAL_VALUETerminalRuleCall_0; }
	...
	private final TerminalRule tFRACTIONAL_VALUE;
	...
	public KerMLGrammarAccess(GrammarProvider grammarProvider) {
		...
		this.tFRACTIONAL_VALUE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.omg.kerml.xtext.KerML.FRACTIONAL_VALUE");
	...
	//terminal FRACTIONAL_VALUE:
	//	(NATURAL_VALUE '.' '0'..'9'* | '.' '0'..'9'+) EXP_SUFFIX?;
	public TerminalRule getFRACTIONAL_VALUERule() {
		return tFRACTIONAL_VALUE;
	}
	
	//terminal EXP_VALUE:
	//	NATURAL_VALUE EXP_SUFFIX;
