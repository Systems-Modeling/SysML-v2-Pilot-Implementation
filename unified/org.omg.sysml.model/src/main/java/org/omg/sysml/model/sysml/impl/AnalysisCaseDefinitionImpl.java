 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.AnalysisCaseDefinitionImpl#getResultExpression <em>Result Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnalysisCaseDefinitionImpl extends CaseDefinitionImpl implements AnalysisCaseDefinition {
	...
	public Expression getResultExpression() {
		return (Expression)eGet(SysMLPackage.Literals.ANALYSIS_CASE_DEFINITION__RESULT_EXPRESSION, true);
	}
	...
	public void setResultExpression(Expression newResultExpression) {
		eSet(SysMLPackage.Literals.ANALYSIS_CASE_DEFINITION__RESULT_EXPRESSION, newResultExpression);
	}
