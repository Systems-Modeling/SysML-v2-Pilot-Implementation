...
public class SysMLAdapterFactory extends AdapterFactoryImpl {
	...
	protected SysMLSwitch<Adapter> modelSwitch =
		new SysMLSwitch<Adapter>() {
			...
			@Override
			public Adapter caseVariableFeatureMembership(VariableFeatureMembership object) {
				return createVariableFeatureMembershipAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.omg.sysml.lang.sysml.VariableFeatureMembership <em>Variable Feature Membership</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.omg.sysml.lang.sysml.VariableFeatureMembership
	 * @generated
	 */
