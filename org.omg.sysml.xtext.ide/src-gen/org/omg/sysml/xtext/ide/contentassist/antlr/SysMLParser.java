...
public class SysMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SysMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getIndividualDefinitionAccess().getOwnedRelationshipAssignment_5(), "rule__IndividualDefinition__OwnedRelationshipAssignment_5");
			...
			builder.put(grammarAccess.getOccurrenceRefUsageAccess().getIsCompositeAssignment_1_1(), "rule__OccurrenceRefUsage__IsCompositeAssignment_1_1");
