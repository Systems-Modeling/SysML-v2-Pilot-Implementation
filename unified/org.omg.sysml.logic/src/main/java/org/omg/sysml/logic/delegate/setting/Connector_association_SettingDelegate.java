...
/**
 * Generated setting delegate for {@code Connector.association}.
 */
public class Connector_association_SettingDelegate extends AbstractSettingDelegate {

    public Connector_association_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "Connector.association";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * inferred fallback for Connector.association
        ...
        var values = new BasicEList<Object>();
        {
            ...
            if (sourceValue instanceof Iterable<?> iterable) {
                for (var candidate : iterable) {
                    if (candidate instanceof Association) {
                        values.add(candidate);
                    }
                }
            } else if (sourceValue instanceof Association) {
