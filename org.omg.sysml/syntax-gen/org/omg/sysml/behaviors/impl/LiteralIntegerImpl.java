 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.behaviors.impl.LiteralIntegerImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralIntegerImpl extends ExpressionImpl implements LiteralInteger {
	...
	protected EClass eStaticClass() {
		return BehaviorsPackage.Literals.LITERAL_INTEGER;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviorsPackage.LITERAL_INTEGER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviorsPackage.LITERAL_INTEGER__VALUE:
				return getValue();
		}
