...
/**
 * Generated setting delegate for {@code FeatureValue.value}.
 */
public class FeatureValue_value_SettingDelegate extends AbstractSettingDelegate {

    public FeatureValue_value_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }
    ...
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * redefines fallback for FeatureValue.value
