 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.owl.owl.Annotation#getAnnotationAnnotations <em>Annotation Annotations</em>}</li>
 *   <li>{@link org.omg.sysml.owl.owl.Annotation#getAnnotationProperty <em>Annotation Property</em>}</li>
 *   <li>{@link org.omg.sysml.owl.owl.Annotation#getAnnotationvalue <em>Annotationvalue</em>}</li>
 * </ul>
 *
 * @see org.omg.sysml.owl.owl.OwlPackage#getAnnotation()
 * @model
 * @generated
 */
public interface Annotation extends EObject
{
   ...
   * @see org.omg.sysml.owl.owl.OwlPackage#getAnnotation_AnnotationAnnotations()
   ...
   * @see org.omg.sysml.owl.owl.OwlPackage#getAnnotation_AnnotationProperty()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.omg.sysml.owl.owl.Annotation#getAnnotationProperty <em>Annotation Property</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Annotationvalue</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Annotationvalue</em>' containment reference.
   * @see #setAnnotationvalue(AnnotationValue)
   * @see org.omg.sysml.owl.owl.OwlPackage#getAnnotation_Annotationvalue()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.omg.sysml.owl.owl.Annotation#getAnnotationvalue <em>Annotationvalue</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
