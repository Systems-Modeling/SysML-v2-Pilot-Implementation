...
public class SysMLSyntacticSequencer extends AbstractSyntacticSequencer {
	 ...
	 *     ownedRelationship_comp+=ActionUsageParameterMember ')' (ambiguity) (rule end)
	 *     ownedRelationship_comp+=EmptyParameterMember (ambiguity) (rule end)
	 *     ownedRelationship_comp+=FeatureValue (ambiguity) (rule end)
	 *     ownedRelationship_comp+=MultiplicityMember (ambiguity) (rule end)
	 *     ownedRelationship_comp+=NodeParameterMember (ambiguity) (rule end)
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) ActionUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     (rule start) (ambiguity) ActionUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     (rule start) (ambiguity) ActionUsageKeyword 'id' humanId=Name
	 *     (rule start) (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     (rule start) (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     (rule start) (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     (rule start) (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     (rule start) (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=Import
	 *     (rule start) (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     (rule start) (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     (rule start) (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     (rule start) (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     (rule start) (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     (rule start) (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     (rule start) (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     (rule start) (ambiguity) ActionUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword 'id' humanId=Name
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isAbstract?='abstract' (ambiguity) ActionUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword 'id' humanId=Name
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isVariation?='variation' (ambiguity) ActionUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 */
	 ...
	 *     (rule start) (ambiguity) ownedRelationship_comp+=ConnectorEndMember
	 *     isAbstract?='abstract' (ambiguity) '(' ownedRelationship_comp+=ConnectorEndMember
	 *     isAbstract?='abstract' (ambiguity) ownedRelationship_comp+=ConnectorEndMember
	 *     isVariation?='variation' (ambiguity) '(' ownedRelationship_comp+=ConnectorEndMember
	 *     isVariation?='variation' (ambiguity) ownedRelationship_comp+=ConnectorEndMember
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword 'id' humanId=Name
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=Import
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ObjectiveMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     (rule start) (ambiguity) AnalysisCaseUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword 'id' humanId=Name
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ObjectiveMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isAbstract?='abstract' (ambiguity) AnalysisCaseUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword 'id' humanId=Name
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ObjectiveMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isVariation?='variation' (ambiguity) AnalysisCaseUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     ownedRelationship_comp+=Annotation (ambiguity) (rule end)
	 *     ownedRelationship_comp+=EmptyAnnotation (ambiguity) (rule end)
	 */
	 ...
	 *     (rule start) (ambiguity) ownedRelationship_comp+=metadataTyping
	 */
	 ...
	 *     (rule start) (ambiguity) name=Name
	 *     (rule start) (ambiguity) ownedRelationship_comp+=MultiplicityMember
	 ...
	 *     isAbstract?='abstract' (ambiguity) ownedRelationship_comp+=MultiplicityMember
	 ...
	 *     isVariation?='variation' (ambiguity) ownedRelationship_comp+=MultiplicityMember
	 */
	 ...
	 *     name=Name (ambiguity) (rule end)
	 *     ownedRelationship_comp+=ActionUsageParameterMember ')' (ambiguity) (rule end)
	 *     ownedRelationship_comp+=CalculationReturnParameterMember (ambiguity) (rule end)
	 *     ownedRelationship_comp+=EmptyReturnParameterMember (ambiguity) (rule end)
	 *     ownedRelationship_comp+=FeatureValue (ambiguity) (rule end)
	 *     ownedRelationship_comp+=MultiplicityMember (ambiguity) (rule end)
	 *     ownedRelationship_comp+=OwnedFeatureTyping (ambiguity) (rule end)
	 *     ownedRelationship_comp+=OwnedRedefinition (ambiguity) (rule end)
	 ...
	 *     ownedRelationship_comp+=TrueLiteralMember (ambiguity) (rule end)
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) CalculationUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     (rule start) (ambiguity) CalculationUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     (rule start) (ambiguity) CalculationUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     (rule start) (ambiguity) CalculationUsageKeyword 'id' humanId=Name
	 *     (rule start) (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     (rule start) (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     (rule start) (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     (rule start) (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     (rule start) (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=Import
	 *     (rule start) (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     (rule start) (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     (rule start) (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     (rule start) (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     (rule start) (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     (rule start) (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     (rule start) (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     (rule start) (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     (rule start) (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     (rule start) (ambiguity) CalculationUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword 'id' humanId=Name
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isAbstract?='abstract' (ambiguity) CalculationUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword 'id' humanId=Name
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isVariation?='variation' (ambiguity) CalculationUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) CaseUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     (rule start) (ambiguity) CaseUsageKeyword 'id' humanId=Name
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=Import
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ObjectiveMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     (rule start) (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     (rule start) (ambiguity) CaseUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword 'id' humanId=Name
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ObjectiveMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isAbstract?='abstract' (ambiguity) CaseUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword 'id' humanId=Name
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ObjectiveMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isVariation?='variation' (ambiguity) CaseUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     (rule start) (ambiguity) ConstraintUsageKeyword 'id' humanId=Name
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=Import
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     (rule start) (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     (rule start) (ambiguity) ConstraintUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword 'id' humanId=Name
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isAbstract?='abstract' (ambiguity) ConstraintUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword 'id' humanId=Name
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isVariation?='variation' (ambiguity) ConstraintUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 */
	 ...
	 *     (rule start) 'ref' SnapshotKeyword (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     (rule start) 'ref' TimeSliceKeyword (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     (rule start) 'ref'? ItemUsageKeyword (ambiguity) (rule start)
	 *     (rule start) 'ref'? PartUsageKeyword (ambiguity) (rule start)
	 ...
	 *     (rule start) (('ref' IndividualUsageKeyword) | ('ref' TimeSliceKeyword) | ('ref' SnapshotKeyword)) (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     (rule start) (('ref' IndividualUsageKeyword) | ('ref' TimeSliceKeyword) | ('ref' SnapshotKeyword)) (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     (rule start) (IndividualUsageKeyword | TimeSliceKeyword | SnapshotKeyword) (ambiguity) (rule start)
	 *     (rule start) (IndividualUsageKeyword | TimeSliceKeyword | SnapshotKeyword) (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     (rule start) (IndividualUsageKeyword | TimeSliceKeyword | SnapshotKeyword) (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 ...
	 *     (rule start) EnumerationUsageKeyword? (ambiguity) (rule start)
	 *     (rule start) IndividualDefKeyword (ambiguity) ownedRelationship_comp+=LifeClassMembership
	 ...
	 *     (rule start) PortDefKeyword (ambiguity) ownedRelationship_comp+=ConjugatedPortDefinitionMember
	 ...
	 *     (rule start) SnapshotKeyword (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     (rule start) TimeSliceKeyword (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     humanId=Name (ambiguity) (rule end)
	 *     humanId=Name (ambiguity) ownedRelationship_comp+=ConjugatedPortDefinitionMember
	 *     humanId=Name (ambiguity) ownedRelationship_comp+=LifeClassMembership
	 *     humanId=Name (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     humanId=Name (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 ...
	 *     isAbstract?='abstract' 'ref' SnapshotKeyword (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     isAbstract?='abstract' 'ref' SnapshotKeyword (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     isAbstract?='abstract' 'ref' TimeSliceKeyword (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     isAbstract?='abstract' 'ref'? ItemUsageKeyword (ambiguity) (rule end)
	 *     isAbstract?='abstract' 'ref'? PartUsageKeyword (ambiguity) (rule end)
	 *     isAbstract?='abstract' AttributeDefKeyword (ambiguity) (rule end)
	 *     isAbstract?='abstract' AttributeUsageKeyword (ambiguity) (rule end)
	 *     isAbstract?='abstract' IndividualDefKeyword (ambiguity) ownedRelationship_comp+=LifeClassMembership
	 ...
	 *     isAbstract?='abstract' PortDefKeyword (ambiguity) ownedRelationship_comp+=ConjugatedPortDefinitionMember
	 ...
	 *     isAbstract?='abstract' SnapshotKeyword (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     isAbstract?='abstract' SnapshotKeyword (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     isAbstract?='abstract' TimeSliceKeyword (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     isComposite?=IndividualUsageKeyword (ambiguity) (rule end)
	 *     isComposite?=IndividualUsageKeyword (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     isComposite?=IndividualUsageKeyword (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 ...
	 *     isComposite?=SnapshotKeyword (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     isComposite?=SnapshotKeyword (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     isComposite?=TimeSliceKeyword (ambiguity) (rule end)
	 *     isComposite?=TimeSliceKeyword (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     isComposite?=TimeSliceKeyword (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     isNonunique?='nonunique' (ambiguity) (rule end)
	 *     isNonunique?='nonunique' (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     isNonunique?='nonunique' (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     isOrdered?='ordered' (ambiguity) (rule end)
	 *     isOrdered?='ordered' (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     isOrdered?='ordered' (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 ...
	 *     isVariation?='variation' 'ref' SnapshotKeyword (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     isVariation?='variation' 'ref' SnapshotKeyword (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     isVariation?='variation' 'ref' TimeSliceKeyword (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     isVariation?='variation' 'ref'? ItemUsageKeyword (ambiguity) (rule end)
	 *     isVariation?='variation' 'ref'? PartUsageKeyword (ambiguity) (rule end)
	 ...
	 *     isVariation?='variation' IndividualDefKeyword (ambiguity) ownedRelationship_comp+=LifeClassMembership
	 ...
	 *     isVariation?='variation' PortDefKeyword (ambiguity) ownedRelationship_comp+=ConjugatedPortDefinitionMember
	 ...
	 *     isVariation?='variation' SnapshotKeyword (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     isVariation?='variation' SnapshotKeyword (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     isVariation?='variation' TimeSliceKeyword (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     name=Name (ambiguity) (rule end)
	 *     name=Name (ambiguity) ownedRelationship_comp+=ConjugatedPortDefinitionMember
	 *     name=Name (ambiguity) ownedRelationship_comp+=LifeClassMembership
	 *     name=Name (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     name=Name (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     ownedRelationship_comp+=FeatureValue (ambiguity) (rule end)
	 *     ownedRelationship_comp+=FeatureValue (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     ownedRelationship_comp+=FeatureValue (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     ownedRelationship_comp+=MultiplicityMember (ambiguity) (rule end)
	 *     ownedRelationship_comp+=MultiplicityMember (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     ownedRelationship_comp+=MultiplicityMember (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     ownedRelationship_comp+=OwnedFeatureTyping (ambiguity) (rule end)
	 *     ownedRelationship_comp+=OwnedFeatureTyping (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     ownedRelationship_comp+=OwnedFeatureTyping (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     ownedRelationship_comp+=OwnedRedefinition (ambiguity) (rule end)
	 *     ownedRelationship_comp+=OwnedRedefinition (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     ownedRelationship_comp+=OwnedRedefinition (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     ownedRelationship_comp+=OwnedSubsetting (ambiguity) (rule end)
	 *     ownedRelationship_comp+=OwnedSubsetting (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     ownedRelationship_comp+=OwnedSubsetting (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     ownedRelationship_comp+=OwnedSuperclassing (ambiguity) (rule end)
	 *     ownedRelationship_comp+=OwnedSuperclassing (ambiguity) ownedRelationship_comp+=ConjugatedPortDefinitionMember
	 *     ownedRelationship_comp+=OwnedSuperclassing (ambiguity) ownedRelationship_comp+=LifeClassMembership
	 *     ownedRelationship_comp+=PortTyping (ambiguity) (rule end)
	 *     ownedRelationship_comp+=SourceItemFlowMember (ambiguity) (rule end)
	 *     ownedRelationship_comp+=SourceItemFlowMember (ambiguity) ownedRelationship_comp+=SnapshotFeatureMember
	 *     ownedRelationship_comp+=SourceItemFlowMember (ambiguity) ownedRelationship_comp+=TimeSliceFeatureMember
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) '=' ownedRelationship_comp+=FeatureValue
	 *     (rule start) (ambiguity) 'id' humanId=Name
	 *     (rule start) (ambiguity) '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     (rule start) (ambiguity) '{' ownedRelationship_comp+=Import
	 *     (rule start) (ambiguity) '{' ownedRelationship_comp+=IndividualUsageMember
	 *     (rule start) (ambiguity) '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     (rule start) (ambiguity) '{' ownedRelationship_comp+=NestedUsageMember
	 *     (rule start) (ambiguity) '{' ownedRelationship_comp+=OwnedDocumentation
	 *     (rule start) (ambiguity) '{' ownedRelationship_comp+=VariantUsageMember
	 *     (rule start) (ambiguity) (';' | ('{' '}')) (rule start)
	 *     (rule start) (ambiguity) DefinedByKeyword ownedRelationship_comp+=OwnedFeatureTyping
	 *     (rule start) (ambiguity) RedefinesKeyword ownedRelationship_comp+=OwnedRedefinition
	 *     (rule start) (ambiguity) SubsetsKeyword ownedRelationship_comp+=OwnedSubsetting
	 *     (rule start) (ambiguity) name=Name
	 *     (rule start) (ambiguity) ownedRelationship_comp+=MultiplicityMember
	 *     (rule start) (ambiguity) ownedRelationship_comp+=SourceItemFlowMember
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) SuccessionKeyword (ambiguity) ownedRelationship_comp+=TransitionSourceMember
	 */
	 ...
	 *     (rule start) (ambiguity) '{' ownedRelationship_comp+=VariantUsageMember
	 *     (rule start) (ambiguity) (';' | ('{' '}')) (rule start)
	 *     (rule start) (ambiguity) (';' | ('{' '}')) ownedRelationship_comp+=SnapshotFeatureMember
	 *     (rule start) (ambiguity) (';' | ('{' '}')) ownedRelationship_comp+=TimeSliceFeatureMember
	 *     (rule start) (ambiguity) DefinedByKeyword ownedRelationship_comp+=OwnedFeatureTyping
	 *     (rule start) (ambiguity) RedefinesKeyword ownedRelationship_comp+=OwnedRedefinition
	 *     (rule start) (ambiguity) SubsetsKeyword ownedRelationship_comp+=OwnedSubsetting
	 *     (rule start) (ambiguity) name=Name
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) InterfaceUsageKeyword (ambiguity) '(' ownedRelationship_comp+=ConnectorEndMember
	 *     (rule start) InterfaceUsageKeyword (ambiguity) ownedRelationship_comp+=ConnectorEndMember
	 *     isAbstract?='abstract' InterfaceUsageKeyword (ambiguity) '(' ownedRelationship_comp+=ConnectorEndMember
	 *     isAbstract?='abstract' InterfaceUsageKeyword (ambiguity) ownedRelationship_comp+=ConnectorEndMember
	 *     isVariation?='variation' InterfaceUsageKeyword (ambiguity) '(' ownedRelationship_comp+=ConnectorEndMember
	 *     isVariation?='variation' InterfaceUsageKeyword (ambiguity) ownedRelationship_comp+=ConnectorEndMember
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) ItemUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     (rule start) (ambiguity) ItemUsageKeyword 'id' humanId=Name
	 *     (rule start) (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     (rule start) (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=Import
	 *     (rule start) (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     (rule start) (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     (rule start) (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     (rule start) (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     (rule start) (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     (rule start) (ambiguity) ItemUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     (rule start) (ambiguity) ItemUsageKeyword ownedRelationship_comp+=SourceItemFlowMember
	 *     isAbstract?='abstract' (ambiguity) ItemUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isAbstract?='abstract' (ambiguity) ItemUsageKeyword 'id' humanId=Name
	 *     isAbstract?='abstract' (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isAbstract?='abstract' (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isAbstract?='abstract' (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isAbstract?='abstract' (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isAbstract?='abstract' (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     isAbstract?='abstract' (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isAbstract?='abstract' (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isAbstract?='abstract' (ambiguity) ItemUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isAbstract?='abstract' (ambiguity) ItemUsageKeyword ownedRelationship_comp+=SourceItemFlowMember
	 *     isVariation?='variation' (ambiguity) ItemUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isVariation?='variation' (ambiguity) ItemUsageKeyword 'id' humanId=Name
	 *     isVariation?='variation' (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isVariation?='variation' (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isVariation?='variation' (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isVariation?='variation' (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isVariation?='variation' (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     isVariation?='variation' (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isVariation?='variation' (ambiguity) ItemUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isVariation?='variation' (ambiguity) ItemUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isVariation?='variation' (ambiguity) ItemUsageKeyword ownedRelationship_comp+=SourceItemFlowMember
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) PartUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     (rule start) (ambiguity) PartUsageKeyword 'id' humanId=Name
	 *     (rule start) (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     (rule start) (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=Import
	 *     (rule start) (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     (rule start) (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     (rule start) (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     (rule start) (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     (rule start) (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     (rule start) (ambiguity) PartUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     (rule start) (ambiguity) PartUsageKeyword ownedRelationship_comp+=SourceItemFlowMember
	 *     isAbstract?='abstract' (ambiguity) PartUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isAbstract?='abstract' (ambiguity) PartUsageKeyword 'id' humanId=Name
	 *     isAbstract?='abstract' (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isAbstract?='abstract' (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isAbstract?='abstract' (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isAbstract?='abstract' (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isAbstract?='abstract' (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     isAbstract?='abstract' (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isAbstract?='abstract' (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isAbstract?='abstract' (ambiguity) PartUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isAbstract?='abstract' (ambiguity) PartUsageKeyword ownedRelationship_comp+=SourceItemFlowMember
	 *     isVariation?='variation' (ambiguity) PartUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isVariation?='variation' (ambiguity) PartUsageKeyword 'id' humanId=Name
	 *     isVariation?='variation' (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isVariation?='variation' (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isVariation?='variation' (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isVariation?='variation' (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isVariation?='variation' (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     isVariation?='variation' (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isVariation?='variation' (ambiguity) PartUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isVariation?='variation' (ambiguity) PartUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isVariation?='variation' (ambiguity) PartUsageKeyword ownedRelationship_comp+=SourceItemFlowMember
	 */
	 ...
	 *     (rule start) (ambiguity) ownedRelationship_comp+=MultiplicityMember
	 *     (rule start) (ambiguity) ownedRelationship_comp+=SourceItemFlowMember
	 *     isAbstract?='abstract' (ambiguity) '=' ownedRelationship_comp+=FeatureValue
	 *     isAbstract?='abstract' (ambiguity) 'id' humanId=Name
	 *     isAbstract?='abstract' (ambiguity) '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isAbstract?='abstract' (ambiguity) '{' ownedRelationship_comp+=Import
	 *     isAbstract?='abstract' (ambiguity) '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isAbstract?='abstract' (ambiguity) '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isAbstract?='abstract' (ambiguity) '{' ownedRelationship_comp+=NestedUsageMember
	 *     isAbstract?='abstract' (ambiguity) '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isAbstract?='abstract' (ambiguity) '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isAbstract?='abstract' (ambiguity) name=Name
	 *     isAbstract?='abstract' (ambiguity) ownedRelationship_comp+=MultiplicityMember
	 *     isAbstract?='abstract' (ambiguity) ownedRelationship_comp+=SourceItemFlowMember
	 *     isVariation?='variation' (ambiguity) '=' ownedRelationship_comp+=FeatureValue
	 *     isVariation?='variation' (ambiguity) 'id' humanId=Name
	 *     isVariation?='variation' (ambiguity) '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isVariation?='variation' (ambiguity) '{' ownedRelationship_comp+=Import
	 *     isVariation?='variation' (ambiguity) '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isVariation?='variation' (ambiguity) '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isVariation?='variation' (ambiguity) '{' ownedRelationship_comp+=NestedUsageMember
	 *     isVariation?='variation' (ambiguity) '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isVariation?='variation' (ambiguity) '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isVariation?='variation' (ambiguity) name=Name
	 *     isVariation?='variation' (ambiguity) ownedRelationship_comp+=MultiplicityMember
	 *     isVariation?='variation' (ambiguity) ownedRelationship_comp+=SourceItemFlowMember
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) RequirementUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     (rule start) (ambiguity) RequirementUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     (rule start) (ambiguity) RequirementUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     (rule start) (ambiguity) RequirementUsageKeyword 'id' humanId=Name
	 *     (rule start) (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     (rule start) (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=Import
	 *     (rule start) (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     (rule start) (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     (rule start) (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     (rule start) (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     (rule start) (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=RequirementConstraintMember
	 *     (rule start) (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=RequirementVerificationMember
	 *     (rule start) (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     (rule start) (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     (rule start) (ambiguity) RequirementUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword 'id' humanId=Name
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=RequirementConstraintMember
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=RequirementVerificationMember
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isAbstract?='abstract' (ambiguity) RequirementUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword 'id' humanId=Name
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=RequirementConstraintMember
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=RequirementVerificationMember
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isVariation?='variation' (ambiguity) RequirementUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) StateUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     (rule start) (ambiguity) StateUsageKeyword ';' (rule start)
	 *     (rule start) (ambiguity) StateUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     (rule start) (ambiguity) StateUsageKeyword 'id' humanId=Name
	 *     (rule start) (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     (rule start) (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=DoActionMember
	 *     (rule start) (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     (rule start) (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=EntryActionMember
	 *     (rule start) (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=ExitActionMember
	 *     (rule start) (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=Import
	 *     (rule start) (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     (rule start) (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     (rule start) (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     (rule start) (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     (rule start) (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     (rule start) (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=TransitionUsageMember
	 *     (rule start) (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     (rule start) (ambiguity) StateUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword ';' (rule end)
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword 'id' humanId=Name
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=DoActionMember
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=EntryActionMember
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=ExitActionMember
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=TransitionUsageMember
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isAbstract?='abstract' (ambiguity) StateUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword ';' (rule end)
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword 'id' humanId=Name
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=DoActionMember
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=EntryActionMember
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=ExitActionMember
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=TransitionUsageMember
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isVariation?='variation' (ambiguity) StateUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) SuccessionKeyword (ambiguity) ownedRelationship_comp+=ConnectorEndMember
	 *     isAbstract?='abstract' SuccessionKeyword (ambiguity) ownedRelationship_comp+=ConnectorEndMember
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) TransitionUsageKeyword (ambiguity) ownedRelationship_comp+=TransitionSourceMember
	 */
	 ...
	 * This ambiguous syntax occurs at:
	 *     ownedRelationship_comp+=ConnectorEndMember (ambiguity) (rule end)
	 *     ownedRelationship_comp+=ItemFlowEndMember (ambiguity) (rule end)
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword 'id' humanId=Name
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=Import
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ObjectiveMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     (rule start) (ambiguity) VerificationCaseUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword 'id' humanId=Name
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ObjectiveMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isAbstract?='abstract' (ambiguity) VerificationCaseUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword 'id' humanId=Name
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ActionNodeMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=BehaviorUsageMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=GuardedSuccessionMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=InitialNodeMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ObjectiveMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ParameterFlowUsageMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ResultExpressionMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=ReturnParameterFlowUsageMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=StructureUsageMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isVariation?='variation' (ambiguity) VerificationCaseUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) ViewUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     (rule start) (ambiguity) ViewUsageKeyword 'id' humanId=Name
	 *     (rule start) (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=ElementFilterMember
	 *     (rule start) (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     (rule start) (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=Expose
	 *     (rule start) (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=Import
	 *     (rule start) (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     (rule start) (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     (rule start) (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     (rule start) (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     (rule start) (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     (rule start) (ambiguity) ViewUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     (rule start) (ambiguity) ViewUsageKeyword ownedRelationship_comp+=SourceItemFlowMember
	 *     isAbstract?='abstract' (ambiguity) ViewUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isAbstract?='abstract' (ambiguity) ViewUsageKeyword 'id' humanId=Name
	 *     isAbstract?='abstract' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=ElementFilterMember
	 *     isAbstract?='abstract' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isAbstract?='abstract' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=Expose
	 *     isAbstract?='abstract' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isAbstract?='abstract' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isAbstract?='abstract' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isAbstract?='abstract' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     isAbstract?='abstract' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isAbstract?='abstract' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isAbstract?='abstract' (ambiguity) ViewUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isAbstract?='abstract' (ambiguity) ViewUsageKeyword ownedRelationship_comp+=SourceItemFlowMember
	 *     isVariation?='variation' (ambiguity) ViewUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isVariation?='variation' (ambiguity) ViewUsageKeyword 'id' humanId=Name
	 *     isVariation?='variation' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=ElementFilterMember
	 *     isVariation?='variation' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isVariation?='variation' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=Expose
	 *     isVariation?='variation' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isVariation?='variation' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isVariation?='variation' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isVariation?='variation' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     isVariation?='variation' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isVariation?='variation' (ambiguity) ViewUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isVariation?='variation' (ambiguity) ViewUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isVariation?='variation' (ambiguity) ViewUsageKeyword ownedRelationship_comp+=SourceItemFlowMember
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) ViewpointUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     (rule start) (ambiguity) ViewpointUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     (rule start) (ambiguity) ViewpointUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     (rule start) (ambiguity) ViewpointUsageKeyword 'id' humanId=Name
	 *     (rule start) (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     (rule start) (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=Import
	 *     (rule start) (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     (rule start) (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     (rule start) (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     (rule start) (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     (rule start) (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=RequirementConstraintMember
	 *     (rule start) (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=RequirementVerificationMember
	 *     (rule start) (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     (rule start) (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     (rule start) (ambiguity) ViewpointUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword 'id' humanId=Name
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=RequirementConstraintMember
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=RequirementVerificationMember
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isAbstract?='abstract' (ambiguity) ViewpointUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword '(' ')' ownedRelationship_comp+=CalculationReturnParameterMember
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword '(' ownedRelationship_comp+=ActionUsageParameterMember
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword '=' ownedRelationship_comp+=FeatureValue
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword 'id' humanId=Name
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=EmptySuccessionMember
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=Import
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=IndividualUsageMember
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=NestedDefinitionMember
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=NestedUsageMember
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=OwnedDocumentation
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=RequirementConstraintMember
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=RequirementVerificationMember
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=SubjectMember
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword '{' ownedRelationship_comp+=VariantUsageMember
	 ...
	 *     isVariation?='variation' (ambiguity) ViewpointUsageKeyword ownedRelationship_comp+=MultiplicityMember
	 */
