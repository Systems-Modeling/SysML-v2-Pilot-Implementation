...
public class InternalKerMLExpressionsLexer extends Lexer {
    ...
    public final void mRULE_DECIMAL_VALUE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerMLExpressions.g:5098:20: ( '0' .. '9' ( '0' .. '9' )* )
            // InternalKerMLExpressions.g:5098:22: '0' .. '9' ( '0' .. '9' )*
            {
            matchRange('0','9'); 
            // InternalKerMLExpressions.g:5098:31: ( '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalKerMLExpressions.g:5098:32: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_EXP_VALUE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerMLExpressions.g:5100:16: ( RULE_DECIMAL_VALUE ( 'e' | 'E' ) ( '+' | '-' )? RULE_DECIMAL_VALUE )
            // InternalKerMLExpressions.g:5100:18: RULE_DECIMAL_VALUE ( 'e' | 'E' ) ( '+' | '-' )? RULE_DECIMAL_VALUE
            {
            mRULE_DECIMAL_VALUE(); 
            ...
            // InternalKerMLExpressions.g:5100:47: ( '+' | '-' )?
            int alt2=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerMLExpressions.g:5102:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalKerMLExpressions.g:5102:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            ...
            // InternalKerMLExpressions.g:5102:35: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_UNRESTRICTED_NAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerMLExpressions.g:5104:24: ( '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            // InternalKerMLExpressions.g:5104:26: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
            {
            match('\''); 
            // InternalKerMLExpressions.g:5104:31: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
            loop4:
            do {
                int alt4=3;
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalKerMLExpressions.g:5104:32: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
            	    ...
            	    break;
            	case 2 :
            	    // InternalKerMLExpressions.g:5104:73: ~ ( ( '\\\\' | '\\'' ) )
            	    {
    ...
    public final void mRULE_STRING_VALUE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerMLExpressions.g:5106:19: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalKerMLExpressions.g:5106:21: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalKerMLExpressions.g:5106:25: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
            loop5:
            do {
                int alt5=3;
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalKerMLExpressions.g:5106:26: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
            	    if ( input.LA(1)=='\"'||input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||input.LA(1)=='t' ) {
            	        input.consume();
            	    ...
            	    break;
            	case 2 :
            	    // InternalKerMLExpressions.g:5106:67: ~ ( ( '\\\\' | '\"' ) )
            	    {
            	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='!')||(input.LA(1)>='#' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
            	        input.consume();
    ...
    public final void mRULE_REGULAR_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerMLExpressions.g:5108:22: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalKerMLExpressions.g:5108:24: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalKerMLExpressions.g:5108:29: ( options {greedy=false; } : . )*
            loop6:
            do {
                int alt6=2;
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalKerMLExpressions.g:5108:57: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_ML_NOTE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerMLExpressions.g:5110:14: ( '//*' ( options {greedy=false; } : . )* '*/' )
            // InternalKerMLExpressions.g:5110:16: '//*' ( options {greedy=false; } : . )* '*/'
            {
            match("//*"); 

            // InternalKerMLExpressions.g:5110:22: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalKerMLExpressions.g:5110:50: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_NOTE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerMLExpressions.g:5112:14: ( '//' (~ ( ( '\\n' | '\\r' ) ) (~ ( ( '\\n' | '\\r' ) ) )* )? ( ( '\\r' )? '\\n' )? )
            // InternalKerMLExpressions.g:5112:16: '//' (~ ( ( '\\n' | '\\r' ) ) (~ ( ( '\\n' | '\\r' ) ) )* )? ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalKerMLExpressions.g:5112:21: (~ ( ( '\\n' | '\\r' ) ) (~ ( ( '\\n' | '\\r' ) ) )* )?
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalKerMLExpressions.g:5112:22: ~ ( ( '\\n' | '\\r' ) ) (~ ( ( '\\n' | '\\r' ) ) )*
                    {
                    ...
                    // InternalKerMLExpressions.g:5112:37: (~ ( ( '\\n' | '\\r' ) ) )*
                    loop8:
                    do {
                        int alt8=2;
            ...
            // InternalKerMLExpressions.g:5112:55: ( ( '\\r' )? '\\n' )?
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalKerMLExpressions.g:5112:56: ( '\\r' )? '\\n'
                    {
                    // InternalKerMLExpressions.g:5112:56: ( '\\r' )?
                    int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKerMLExpressions.g:5114:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalKerMLExpressions.g:5114:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalKerMLExpressions.g:5114:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public void mTokens() throws RecognitionException {
        ...
        switch (alt13) {
            ...
            case 61 :
                ...
                break;
            case 62 :
                // InternalKerMLExpressions.g:1:444: RULE_ML_NOTE
                {
                mRULE_ML_NOTE(); 
                ...
                break;
            case 63 :
                // InternalKerMLExpressions.g:1:457: RULE_SL_NOTE
                {
                mRULE_SL_NOTE(); 
                ...
                break;
            case 64 :
                // InternalKerMLExpressions.g:1:470: RULE_WS
                {
                mRULE_WS(); 
    ...
    static final String DFA13_eotS =
        "\1\uffff\1\53\2\46\1\uffff\2\46\1\uffff\1\46\1\67\1\uffff\1\46\1\73\1\46\1\76\1\100\1\103\1\uffff\1\105\1\107\1\112\3\uffff\1\46\11\uffff\2\46\1\uffff\1\121\6\uffff\1\46\1\124\2\46\1\127\1\130\2\46\1\133\1\46\1\136\1\uffff\1\140\1\46\2\uffff\1\46\14\uffff\1\144\1\uffff\5\46\1\121\2\uffff\1\46\1\uffff\2\46\2\uffff\1\155\1\156\1\uffff\1\157\4\uffff\2\46\1\144\1\uffff\1\166\1\167\3\46\1\173\2\46\3\uffff\1\46\1\u0080\2\144\1\uffff\1\144\2\uffff\1\u0083\1\u0084\1\46\1\uffff\4\46\1\uffff\1\u0082\3\uffff\1\u008a\1\46\1\u008c\2\46\1\uffff\1\u008f\1\uffff\1\u0090\1\46\2\uffff\1\u0092\1\uffff";
    static final String DFA13_eofS =
        "\u0093\uffff";
    static final String DFA13_minS =
        "\1\11\1\77\1\154\1\146\1\uffff\1\162\1\157\1\uffff\1\154\2\75\1\141\1\100\1\145\2\75\1\56\1\uffff\1\76\2\52\3\uffff\1\145\11\uffff\1\162\1\141\1\uffff\1\60\6\uffff\1\163\1\60\1\160\1\164\2\60\1\162\1\144\1\60\1\154\1\75\1\uffff\1\75\1\163\2\uffff\1\164\14\uffff\1\52\1\uffff\1\164\1\167\1\154\1\165\1\154\1\60\2\uffff\1\145\1\uffff\1\154\1\171\2\uffff\2\60\1\uffff\1\60\4\uffff\1\164\1\141\1\0\1\uffff\2\60\1\154\1\145\1\163\1\60\1\151\1\160\3\uffff\1\171\1\60\4\0\2\uffff\2\60\1\145\1\uffff\2\145\1\160\1\141\1\uffff\1\0\3\uffff\1\60\1\163\1\60\1\145\1\164\1\uffff\1\60\1\uffff\1\60\1\141\2\uffff\1\60\1\uffff";
    static final String DFA13_maxS =
        "\1\176\1\77\1\154\1\163\1\uffff\1\162\1\157\1\uffff\1\163\2\75\1\141\1\100\1\145\2\75\1\77\1\uffff\1\76\1\52\1\57\3\uffff\1\165\11\uffff\1\162\1\141\1\uffff\1\145\6\uffff\1\163\1\172\1\160\1\164\2\172\1\162\1\144\1\172\1\154\1\75\1\uffff\1\75\1\163\2\uffff\1\164\14\uffff\1\52\1\uffff\1\164\1\167\1\154\1\165\1\154\1\145\2\uffff\1\145\1\uffff\1\154\1\171\2\uffff\2\172\1\uffff\1\172\4\uffff\1\164\1\141\1\uffff\1\uffff\2\172\1\154\1\145\1\163\1\172\1\151\1\160\3\uffff\1\171\1\172\4\uffff\2\uffff\2\172\1\145\1\uffff\2\145\1\160\1\141\1\uffff\1\uffff\3\uffff\1\172\1\163\1\172\1\145\1\164\1\uffff\1\172\1\uffff\1\172\1\141\2\uffff\1\172\1\uffff";
    static final String DFA13_acceptS =
        "\4\uffff\1\6\2\uffff\1\11\11\uffff\1\32\3\uffff\1\36\1\40\1\41\1\uffff\1\45\1\46\1\47\1\50\1\51\1\54\1\55\1\56\1\60\2\uffff\1\67\1\uffff\1\72\1\73\1\74\1\100\1\4\1\1\13\uffff\1\63\2\uffff\1\22\1\21\1\uffff\1\27\1\25\1\30\1\26\1\31\1\53\1\44\1\52\1\33\1\37\1\34\1\75\1\uffff\1\35\6\uffff\1\70\1\71\1\uffff\1\3\2\uffff\1\57\1\7\2\uffff\1\23\1\uffff\1\15\1\13\1\16\1\14\3\uffff\1\77\10\uffff\1\10\1\12\1\43\6\uffff\1\42\1\62\3\uffff\1\2\4\uffff\1\24\1\uffff\1\76\1\64\1\65\5\uffff\1\66\1\uffff\1\20\2\uffff\1\5\1\17\1\uffff\1\61";
    static final String DFA13_specialS =
        "\143\uffff\1\5\16\uffff\1\4\1\3\1\1\1\0\13\uffff\1\2\21\uffff}>";
    static final String[] DFA13_transitionS = {
            ...
            "",
            "\1\176",
            "\12\46\7\uffff\32\46\4\uffff\1\46\1\uffff\3\46\1\177\26\46",
            "\12\163\1\165\2\163\1\164\34\163\1\162\4\163\1\u0081\uffd0\163",
            "\12\163\1\165\2\163\1\164\34\163\1\162\uffd5\163",
            "\12\u0082\1\165\ufff5\u0082",
            "\0\u0082",
            "",
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    ...
                    case 1 : 
                        ...
                        s = -1;
                        if ( ((LA13_116>='\u0000' && LA13_116<='\t')||(LA13_116>='\u000B' && LA13_116<='\uFFFF')) ) {s = 130;}
                    ...
                    case 2 : 
                        ...
                        else if ( (LA13_129=='\r') ) {s = 116;}

                        else if ( (LA13_129=='\n') ) {s = 117;}

                        else if ( ((LA13_129>='\u0000' && LA13_129<='\t')||(LA13_129>='\u000B' && LA13_129<='\f')||(LA13_129>='\u000E' && LA13_129<=')')||(LA13_129>='+' && LA13_129<='\uFFFF')) ) {s = 115;}
                    ...
                    case 3 : 
                        ...
                        else if ( ((LA13_115>='\u0000' && LA13_115<='\t')||(LA13_115>='\u000B' && LA13_115<='\f')||(LA13_115>='\u000E' && LA13_115<=')')||(LA13_115>='+' && LA13_115<='\uFFFF')) ) {s = 115;}
                    ...
                    case 4 : 
                        ...
                        else if ( (LA13_114=='*') ) {s = 114;}

                        else if ( (LA13_114=='\r') ) {s = 116;}

                        else if ( (LA13_114=='\n') ) {s = 117;}

                        else if ( ((LA13_114>='\u0000' && LA13_114<='\t')||(LA13_114>='\u000B' && LA13_114<='\f')||(LA13_114>='\u000E' && LA13_114<=')')||(LA13_114>='+' && LA13_114<='.')||(LA13_114>='0' && LA13_114<='\uFFFF')) ) {s = 115;}
                    ...
                    case 5 : 
                        ...
                        else if ( ((LA13_99>='\u0000' && LA13_99<='\t')||(LA13_99>='\u000B' && LA13_99<='\f')||(LA13_99>='\u000E' && LA13_99<=')')||(LA13_99>='+' && LA13_99<='\uFFFF')) ) {s = 115;}

                        else if ( (LA13_99=='\r') ) {s = 116;}
