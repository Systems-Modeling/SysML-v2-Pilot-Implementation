...
public enum FeatureDirectionKind implements Enumerator {
	 ...
	 * @generated
	 */
	private static final FeatureDirectionKind[] VALUES_ARRAY = new FeatureDirectionKind[] { IN, INOUT, OUT, };

	/**
	 * A public read-only list of all the '<em><b>Feature Direction Kind</b></em>'
	...
	/**
	 * Returns the '<em><b>Feature Direction Kind</b></em>' literal with the
