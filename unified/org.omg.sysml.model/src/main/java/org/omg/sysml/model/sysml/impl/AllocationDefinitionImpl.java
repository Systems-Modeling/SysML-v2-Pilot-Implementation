 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.AllocationDefinitionImpl#getAllocation <em>Allocation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AllocationDefinitionImpl extends ConnectionDefinitionImpl implements AllocationDefinition {
	...
	protected EClass eStaticClass() {
		return SysMLPackage.Literals.ALLOCATION_DEFINITION;
	}
	...
	public EList<AllocationUsage> getAllocation() {
		return (EList<AllocationUsage>)eGet(SysMLPackage.Literals.ALLOCATION_DEFINITION__ALLOCATION, true);
	}
