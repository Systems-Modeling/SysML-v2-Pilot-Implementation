 ...
 * Membership</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.omg.sysml.lang.sysml.impl.FeatureMembershipImpl#getMemberFeature
 * <em>Member Feature</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.FeatureMembershipImpl#isDerived
 * <em>Is Derived</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.FeatureMembershipImpl#isReadOnly
 * <em>Is Read Only</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.FeatureMembershipImpl#getOwnedMemberFeature
 * <em>Owned Member Feature</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.FeatureMembershipImpl#isPart <em>Is
 * Part</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.FeatureMembershipImpl#isPortion
 * <em>Is Portion</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.FeatureMembershipImpl#isPort <em>Is
 * Port</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.FeatureMembershipImpl#getDirection
 * <em>Direction</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.FeatureMembershipImpl#getOwningType
...
public class FeatureMembershipImpl extends MembershipImpl implements FeatureMembership {
	/**
	 * The cached value of the '{@link #getMemberFeature() <em>Member Feature</em>}'
	...
	/**
	 * The default value of the '{@link #isDerived() <em>Is Derived</em>}'
	...
	/**
	 * The default value of the '{@link #isReadOnly() <em>Is Read Only</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isReadOnly()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isReadOnly() <em>Is Read Only</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isReadOnly()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getOwnedMemberFeature() <em>Owned Member
	 * Feature</em>}' containment reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The default value of the '{@link #isPortion() <em>Is Portion</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isPortion()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getOwningType() <em>Owning Type</em>}'
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOwningType()
	 * @generated
			...
			if (memberFeature != oldMemberFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SysMLPackage.FEATURE_MEMBERSHIP__MEMBER_FEATURE, oldMemberFeature, memberFeature));
			}
		}
	...
	public void setMemberFeature(Feature newMemberFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.FEATURE_MEMBERSHIP__MEMBER_FEATURE,
					oldMemberFeature, memberFeature));
	...
	public void setIsDerived(boolean newIsDerived) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.FEATURE_MEMBERSHIP__IS_DERIVED,
	...
	public void setIsReadOnly(boolean newIsReadOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.FEATURE_MEMBERSHIP__IS_READ_ONLY,
	...
	public void setIsPart(boolean newIsPart) {
		...
		isPart = newIsPart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.FEATURE_MEMBERSHIP__IS_PART, oldIsPart,
					isPart));
	}
	...
	public void setIsPortion(boolean newIsPortion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.FEATURE_MEMBERSHIP__IS_PORTION,
					oldIsPortion, isPortion));
	}
	...
	public void setIsPort(boolean newIsPort) {
		...
		isPort = newIsPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.FEATURE_MEMBERSHIP__IS_PORT, oldIsPort,
					isPort));
	}
	...
	public void setDirection(FeatureDirectionKind newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.FEATURE_MEMBERSHIP__DIRECTION,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case SysMLPackage.FEATURE_MEMBERSHIP__OWNED_MEMBER_FEATURE:
			if (ownedMemberFeature != null)
				msgs = ((InternalEObject) ownedMemberFeature).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SysMLPackage.FEATURE_MEMBERSHIP__OWNED_MEMBER_FEATURE, null, msgs);
			return basicSetOwnedMemberFeature((Feature) otherEnd, msgs);
		case SysMLPackage.FEATURE_MEMBERSHIP__OWNING_TYPE:
			if (owningType != null)
				msgs = ((InternalEObject) owningType).eInverseRemove(this, SysMLPackage.TYPE__OWNED_FEATURE_MEMBERSHIP,
						Type.class, msgs);
	...
	public NotificationChain basicSetOwnedMemberFeature(Feature newOwnedMemberFeature, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SysMLPackage.FEATURE_MEMBERSHIP__OWNED_MEMBER_FEATURE, oldOwnedMemberFeature,
					newOwnedMemberFeature);
			if (msgs == null)
				msgs = notification;
			else
