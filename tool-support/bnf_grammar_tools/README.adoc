...
[source,shell]
----
usage: bnf_grammar_extractor [-h] [-i [INPUT_DIR]] [-o [OUTPUT_DIR]] SOURCE_DATA

Extract textual and/or graphical grammars from given KerML or SysML specifications and generate txt and html BNF grammar files.

positional arguments:
  SOURCE_DATA           JSON file defining source data
...
Temporarily, example input and output directories with files can be found in repository
https://github.com/Systems-Modeling/Graphical-Specification-WG, as follows:

- `INPUT_DIR`: `KerML_and_SysML_spec_sources`
- `OUTPUT-DIR`: `KerML_and_SysML_grammars`
- `SOURCE_DATA`: `KerML_and_SysML_spec_sources/sources.json`
