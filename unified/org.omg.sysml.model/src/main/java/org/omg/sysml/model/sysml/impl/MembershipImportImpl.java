 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.MembershipImportImpl#getImportedMembership <em>Imported Membership</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MembershipImportImpl extends ImportImpl implements MembershipImport {
	...
	public Membership getImportedMembership() {
		return (Membership)eGet(SysMLPackage.Literals.MEMBERSHIP_IMPORT__IMPORTED_MEMBERSHIP, true);
	}
	...
	public void setImportedMembership(Membership newImportedMembership) {
		eSet(SysMLPackage.Literals.MEMBERSHIP_IMPORT__IMPORTED_MEMBERSHIP, newImportedMembership);
	}
	...
	public EList<Element> getTarget() {
		var sourceValue = this.getImportedMembership();
