...
public class KerMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KerMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getStepDefinitionAccess().getAlternatives_2_2_0(), "rule__StepDefinition__Alternatives_2_2_0");
			builder.put(grammarAccess.getExpressionDefinitionAccess().getAlternatives_2(), "rule__ExpressionDefinition__Alternatives_2");
			builder.put(grammarAccess.getExpressionDefinitionAccess().getAlternatives_2_2_0(), "rule__ExpressionDefinition__Alternatives_2_2_0");
			...
			builder.put(grammarAccess.getStepDefinitionAccess().getGroup_2_2(), "rule__StepDefinition__Group_2_2__0");
			...
			builder.put(grammarAccess.getNonFeatureMemberElementAccess().getOwnedRelatedElementAssignment_9(), "rule__NonFeatureMemberElement__OwnedRelatedElementAssignment_9");
			...
			builder.put(grammarAccess.getFeaturePackageMemberElementAccess().getOwnedRelatedElementAssignment_3(), "rule__FeaturePackageMemberElement__OwnedRelatedElementAssignment_3");
			builder.put(grammarAccess.getFeaturePackageMemberElementAccess().getMemberNameAssignment_4_1(), "rule__FeaturePackageMemberElement__MemberNameAssignment_4_1");
			builder.put(grammarAccess.getFeaturePackageMemberElementAccess().getMemberElementAssignment_4_3(), "rule__FeaturePackageMemberElement__MemberElementAssignment_4_3");
			...
			builder.put(grammarAccess.getStepDefinitionAccess().getIsCompositeAssignment_1(), "rule__StepDefinition__IsCompositeAssignment_1");
			builder.put(grammarAccess.getStepDefinitionAccess().getNameAssignment_2_0_0(), "rule__StepDefinition__NameAssignment_2_0_0");
			builder.put(grammarAccess.getStepDefinitionAccess().getOwnedRelationshipAssignment_2_2_1(), "rule__StepDefinition__OwnedRelationshipAssignment_2_2_1");
