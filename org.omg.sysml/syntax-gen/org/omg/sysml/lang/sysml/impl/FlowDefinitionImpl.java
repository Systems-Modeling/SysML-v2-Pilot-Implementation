 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.lang.sysml.impl.FlowDefinitionImpl#getOwningRelatedElement <em>Owning Related Element</em>}</li>
 *   <li>{@link org.omg.sysml.lang.sysml.impl.FlowDefinitionImpl#getOwnedRelatedElement <em>Owned Related Element</em>}</li>
 *   <li>{@link org.omg.sysml.lang.sysml.impl.FlowDefinitionImpl#isImplied <em>Is Implied</em>}</li>
 *   <li>{@link org.omg.sysml.lang.sysml.impl.FlowDefinitionImpl#getRelatedType <em>Related Type</em>}</li>
 *   <li>{@link org.omg.sysml.lang.sysml.impl.FlowDefinitionImpl#getSourceType <em>Source Type</em>}</li>
 *   <li>{@link org.omg.sysml.lang.sysml.impl.FlowDefinitionImpl#getTargetType <em>Target Type</em>}</li>
 *   <li>{@link org.omg.sysml.lang.sysml.impl.FlowDefinitionImpl#getFlowEnd <em>Flow End</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FlowDefinitionImpl extends ActionDefinitionImpl implements FlowDefinition {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate FLOW_END__ESETTING_DELEGATE = ((EStructuralFeature.Internal)SysMLPackage.Literals.FLOW_DEFINITION__FLOW_END).getSettingDelegate();
	...
	public Element getOwningRelatedElement() {
		if (eContainerFeatureID() != SysMLPackage.FLOW_DEFINITION__OWNING_RELATED_ELEMENT) return null;
	...
	public NotificationChain basicSetOwningRelatedElement(Element newOwningRelatedElement, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwningRelatedElement, SysMLPackage.FLOW_DEFINITION__OWNING_RELATED_ELEMENT, msgs);
		return msgs;
	}
	...
	public void setOwningRelatedElement(Element newOwningRelatedElement) {
		if (newOwningRelatedElement != eInternalContainer() || (eContainerFeatureID() != SysMLPackage.FLOW_DEFINITION__OWNING_RELATED_ELEMENT && newOwningRelatedElement != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.FLOW_DEFINITION__OWNING_RELATED_ELEMENT, newOwningRelatedElement, newOwningRelatedElement));
	}
	...
	public EList<Element> getOwnedRelatedElement() {
		if (ownedRelatedElement == null) {
			ownedRelatedElement = new EObjectContainmentWithInverseEList<Element>(Element.class, this, SysMLPackage.FLOW_DEFINITION__OWNED_RELATED_ELEMENT, SysMLPackage.ELEMENT__OWNING_RELATIONSHIP);
		}
	...
	public void setIsImplied(boolean newIsImplied) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.FLOW_DEFINITION__IS_IMPLIED, oldIsImplied, isImplied));
	}
	...
	public EList<Usage> getFlowEnd() {
		return (EList<Usage>)FLOW_END__ESETTING_DELEGATE.dynamicGet(this, null, 0, true, false);
	}
	 ...
	 * @generated
	 */
	public boolean isSetFlowEnd() {
		return !getFlowEnd().isEmpty();
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SysMLPackage.FLOW_DEFINITION__FLOW_END:
				getFlowEnd().clear();
				getFlowEnd().addAll((Collection<? extends Usage>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SysMLPackage.FLOW_DEFINITION__END_FEATURE:
	 ...
	 * @ordered
	 */
	protected static final int[] RELATED_ELEMENT_ESUBSETS = new int[] {SysMLPackage.FLOW_DEFINITION__TARGET, SysMLPackage.FLOW_DEFINITION__SOURCE, SysMLPackage.FLOW_DEFINITION__OWNING_RELATED_ELEMENT, SysMLPackage.FLOW_DEFINITION__OWNED_RELATED_ELEMENT};
	...
	public EList<Feature> getAssociationEnd() {
		@SuppressWarnings("unchecked")
		EList<Feature> flowEnd = (EList<Feature>)((EList<?>)getFlowEnd());
		return flowEnd;
	}
