 ...
 * </p>
 * <ul>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ItemFlowImpl#getItemType <em>Item
 * Type</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ItemFlowImpl#getTargetInputFeature
 * <em>Target Input Feature</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ItemFlowImpl#getSourceOutputFeature
 * <em>Source Output Feature</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ItemFlowImpl#getItemFlowEnd <em>Item
 * Flow End</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ItemFlowImpl#getItemFlowFeature
 * <em>Item Flow Feature</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ItemFlowImpl#getItemFeature <em>Item
 * Feature</em>}</li>
 * </ul>
 *
 * @generated
...
public class ItemFlowImpl extends ConnectorImpl implements ItemFlow {
	...
	public EList<Classifier> getItemType() {
		EList<Classifier> itemType = new EObjectEList<Classifier>(Classifier.class, this,
				SysMLPackage.ITEM_FLOW__ITEM_TYPE);
		getItemFeature().stream().flatMap(f -> f.getType().stream()).filter(t -> t instanceof Classifier)
				.map(t -> (Classifier) t).forEachOrdered(itemType::add);
		return itemType;
	}
	...
	public EList<ItemFeature> getItemFeature() {
		return new DerivedEObjectEList<ItemFeature>(ItemFeature.class, this, SysMLPackage.ITEM_FLOW__ITEM_FEATURE,
	...
	public EList<Feature> getSourceOutputFeature() {
		EList<Feature> sourceOutputFeature = new EObjectEList<Feature>(Feature.class, this,
				SysMLPackage.ITEM_FLOW__SOURCE_OUTPUT_FEATURE);
	...
	public EList<ItemFlowEnd> getItemFlowEnd() {
		EList<ItemFlowEnd> itemFlows = new EObjectEList<ItemFlowEnd>(ItemFlowEnd.class, this,
				SysMLPackage.ITEM_FLOW__ITEM_FLOW_END);
		getConnectorEnd().stream().filter(end -> end instanceof ItemFlowEnd).map(end -> (ItemFlowEnd) end)
	...
	public EList<ItemFlowFeature> getItemFlowFeature() {
		EList<ItemFlowFeature> itemFlowFeatures = new EObjectResolvingEList<ItemFlowFeature>(ItemFlowFeature.class,
				this, SysMLPackage.ITEM_FLOW__ITEM_FLOW_FEATURE);
		getItemFlowEnd().stream().map(end -> (ItemFlowFeature) end.getOwnedFeature().get(0))
	...
	public EList<Feature> getTargetInputFeature() {
		EList<Feature> targetInputFeature = new EObjectResolvingEList<Feature>(Feature.class, this,
				SysMLPackage.ITEM_FLOW__TARGET_INPUT_FEATURE);
	...
	public EList<Subsetting> getOwnedSubsetting() {
		return getOwnedSubsettingWithDefault(
				isSubtransfer() ? ITEM_FLOW_SUBSETTING_PERFORMANCE_DEFAULT : ITEM_FLOW_SUBSETTING_BASE_DEFAULT);
	}
