 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.usage.sysML.Sign#getPLUS <em>PLUS</em>}</li>
 *   <li>{@link org.omg.sysml.usage.sysML.Sign#getMINUS <em>MINUS</em>}</li>
 * </ul>
 *
 * @see org.omg.sysml.usage.sysML.SysMLPackage#getSign()
 * @model
 * @generated
 */
public interface Sign extends EObject
{
   ...
   * @see #setPLUS(String)
   * @see org.omg.sysml.usage.sysML.SysMLPackage#getSign_PLUS()
   * @model
   * @generated
   */
  String getPLUS();
  ...
  /**
   * Sets the value of the '{@link org.omg.sysml.usage.sysML.Sign#getPLUS <em>PLUS</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setMINUS(String)
   * @see org.omg.sysml.usage.sysML.SysMLPackage#getSign_MINUS()
   * @model
   * @generated
   */
  String getMINUS();
  ...
  /**
   * Sets the value of the '{@link org.omg.sysml.usage.sysML.Sign#getMINUS <em>MINUS</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
