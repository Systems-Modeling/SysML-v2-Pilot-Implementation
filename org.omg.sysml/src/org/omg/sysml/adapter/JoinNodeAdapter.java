...
public class JoinNodeAdapter extends ControlNodeAdapter {

	public static final String JOIN_NODE_SUBSETTING_BASE_DEFAULT = "Actions::Action::joins";

	public JoinNodeAdapter(JoinNode element) {
		super(element);
	}
	
	@Override
	public JoinNode getTarget() {
		return (JoinNode)super.getTarget();
	}
