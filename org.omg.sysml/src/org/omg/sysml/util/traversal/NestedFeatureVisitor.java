 ...
 *
 */
public class NestedFeatureVisitor extends ElementVisitor {
	 ...
	 */
	public NestedFeatureVisitor(Element element, NestedFeatureTraversal traversal) {
	 ...
	 */
	public Object visit() {
		if (((NestedFeatureTraversal) this.getTraversal()).getCurrentDebug().equals(NestedFeatureTraversal.DebugLevel.TRACE)) {
	...
	protected void postProcess() {
		for (Relationship relation : element.getOwnedRelationship()) {
			...
			((NestedFeatureTraversal) this.getTraversal()).visit(element, relation);
		}
	}
