...
/**
 * Generated setting delegate for {@code ConstraintUsage.constraintDefinition}.
 */
public class ConstraintUsage_constraintDefinition_SettingDelegate extends AbstractSettingDelegate {

    public ConstraintUsage_constraintDefinition_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "ConstraintUsage.constraintDefinition";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * inferred fallback for ConstraintUsage.constraintDefinition
