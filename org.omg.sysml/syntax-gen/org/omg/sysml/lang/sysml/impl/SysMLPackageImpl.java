...
public class SysMLPackageImpl extends EPackageImpl implements SysMLPackage {
	 ...
	 * @generated
	 */
	private EClass featureDomainEClass = null;
	 ...
	 * @generated
	 */
	public EReference getMembership_OwningPackage() {
	 ...
	 * @generated
	 */
	public EReference getGeneralization_OwningClass() {
	 ...
	 * @generated
	 */
	public EReference getClass_OwnedFeatureMembership() {
	 ...
	 * @generated
	 */
	public EReference getClass_OwningFeature() {
	 ...
	 * @generated
	 */
	public EReference getFeature_OwningClass() {
	 ...
	 * @generated
	 */
	public EReference getFeatureMembership_OwningClass() {
	 ...
	 * @generated
	 */
	public EReference getAssociation_SourceParticipant() {
	 ...
	 * @generated
	 */
	public EReference getAssociation_TargetParticipant() {
	 ...
	 * @generated
	 */
	public EClass getFeatureDomain() {
		return featureDomainEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getFeatureDomain_Feature() {
		return (EReference)featureDomainEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getFeatureDomain_Domain() {
		return (EReference)featureDomainEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getFeatureDomain_EndOfAssociation() {
		return (EReference)featureDomainEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(classEClass, CLASS__OWNED_FEATURE_MEMBERSHIP);
		createEReference(classEClass, CLASS__OWNING_FEATURE);
		...
		createEReference(membershipEClass, MEMBERSHIP__OWNING_PACKAGE);
		...
		createEReference(featureEClass, FEATURE__OWNING_CLASS);
		...
		createEReference(generalizationEClass, GENERALIZATION__OWNING_CLASS);
		...
		createEReference(featureMembershipEClass, FEATURE_MEMBERSHIP__OWNING_CLASS);
		...
		createEReference(associationEClass, ASSOCIATION__SOURCE_PARTICIPANT);
		createEReference(associationEClass, ASSOCIATION__TARGET_PARTICIPANT);
		...
		featureDomainEClass = createEClass(FEATURE_DOMAIN);
		createEReference(featureDomainEClass, FEATURE_DOMAIN__FEATURE);
		createEReference(featureDomainEClass, FEATURE_DOMAIN__DOMAIN);
		createEReference(featureDomainEClass, FEATURE_DOMAIN__END_OF_ASSOCIATION);
	...
	public void initializePackageContents() {
		...
		featureEClass.getESuperTypes().add(this.getClass_());
		...
		featureMembershipEClass.getESuperTypes().add(this.getFeatureDomain());
		associationEClass.getESuperTypes().add(this.getRelationship());
		associationEClass.getESuperTypes().add(this.getClass_());
		featureDomainEClass.getESuperTypes().add(this.getRelationship());
		...
		initEReference(getClass_Feature(), this.getFeature(), null, "feature", null, 0, -1, org.omg.sysml.lang.sysml.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_OwnedFeature(), this.getFeature(), this.getFeature_OwningClass(), "ownedFeature", null, 0, -1, org.omg.sysml.lang.sysml.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEReference(getClass_OwnedGeneralization(), this.getGeneralization(), this.getGeneralization_OwningClass(), "ownedGeneralization", null, 0, -1, org.omg.sysml.lang.sysml.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getClass_OwnedFeatureMembership(), this.getFeatureMembership(), this.getFeatureMembership_OwningClass(), "ownedFeatureMembership", null, 0, -1, org.omg.sysml.lang.sysml.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_OwningFeature(), this.getFeature(), this.getFeature_OwnedType(), "owningFeature", null, 0, 1, org.omg.sysml.lang.sysml.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getMembership_OwningPackage(), this.getPackage(), this.getPackage_OwnedMembership(), "owningPackage", null, 1, 1, Membership.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getFeature_OwningClass(), this.getClass_(), this.getClass_OwnedFeature(), "owningClass", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEReference(getFeature_Type(), this.getClass_(), null, "type", null, 0, -1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getFeature_OwnedType(), this.getClass_(), this.getClass_OwningFeature(), "ownedType", null, 0, -1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getFeature_ParticipantOfAssociation(), this.getAssociation(), this.getAssociation_Participant(), "participantOfAssociation", null, 0, -1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getPackage_OwnedMembership(), this.getMembership(), this.getMembership_OwningPackage(), "ownedMembership", null, 0, -1, org.omg.sysml.lang.sysml.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getGeneralization_OwningClass(), this.getClass_(), this.getClass_OwnedGeneralization(), "owningClass", null, 0, 1, Generalization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getSubset_SubsettedFeature(), this.getFeature(), null, "subsettedFeature", null, 0, 1, Subset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getFeatureMembership_IsPort(), ecorePackage.getEBoolean(), "isPort", null, 1, 1, FeatureMembership.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEReference(getFeatureMembership_MemberFeature(), this.getFeature(), null, "memberFeature", null, 0, 1, FeatureMembership.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getFeatureMembership_OwningClass(), this.getClass_(), this.getClass_OwnedFeatureMembership(), "owningClass", null, 0, 1, FeatureMembership.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(associationEClass, Association.class, "Association", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAssociation_RelatedType(), this.getClass_(), null, "relatedType", null, 2, 2, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEReference(getAssociation_SourceType(), this.getClass_(), null, "sourceType", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEReference(getAssociation_TargetType(), this.getClass_(), null, "targetType", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEReference(getAssociation_Participant(), this.getFeature(), this.getFeature_ParticipantOfAssociation(), "participant", null, 2, 2, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEReference(getAssociation_SourceParticipant(), this.getFeature(), null, "sourceParticipant", null, 2, 2, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getAssociation_TargetParticipant(), this.getFeature(), null, "targetParticipant", null, 2, 2, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getAssociation_End(), this.getFeatureDomain(), this.getFeatureDomain_EndOfAssociation(), "end", null, 1, 2, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEReference(getAssociation_TargetEnd(), this.getFeatureDomain(), null, "targetEnd", null, 2, 2, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getAssociation_SourceEnd(), this.getFeatureDomain(), null, "sourceEnd", null, 2, 2, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(featureDomainEClass, FeatureDomain.class, "FeatureDomain", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFeatureDomain_Feature(), this.getFeature(), null, "feature", null, 0, 1, FeatureDomain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getFeatureDomain_Domain(), this.getClass_(), null, "domain", null, 0, 1, FeatureDomain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getFeatureDomain_EndOfAssociation(), this.getAssociation(), this.getAssociation_End(), "endOfAssociation", null, 0, 1, FeatureDomain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
