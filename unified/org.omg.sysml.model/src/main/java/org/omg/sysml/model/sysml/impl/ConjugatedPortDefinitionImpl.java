 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.ConjugatedPortDefinitionImpl#getOriginalPortDefinition <em>Original Port Definition</em>}</li>
 *   <li>{@link org.omg.sysml.model.sysml.impl.ConjugatedPortDefinitionImpl#getOwnedPortConjugator <em>Owned Port Conjugator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConjugatedPortDefinitionImpl extends PortDefinitionImpl implements ConjugatedPortDefinition {
	...
	public PortDefinition getOriginalPortDefinition() {
		return (PortDefinition)eGet(SysMLPackage.Literals.CONJUGATED_PORT_DEFINITION__ORIGINAL_PORT_DEFINITION, true);
	}
	...
	public void setOriginalPortDefinition(PortDefinition newOriginalPortDefinition) {
		eSet(SysMLPackage.Literals.CONJUGATED_PORT_DEFINITION__ORIGINAL_PORT_DEFINITION, newOriginalPortDefinition);
	}
	...
	public PortConjugation getOwnedPortConjugator() {
		return (PortConjugation)eGet(SysMLPackage.Literals.CONJUGATED_PORT_DEFINITION__OWNED_PORT_CONJUGATOR, true);
	}
	...
	public void setOwnedPortConjugator(PortConjugation newOwnedPortConjugator) {
		eSet(SysMLPackage.Literals.CONJUGATED_PORT_DEFINITION__OWNED_PORT_CONJUGATOR, newOwnedPortConjugator);
	}
	...
	public Conjugation getOwnedConjugator() {
		var sourceValue = this.getOwnedPortConjugator();
		Object source = sourceValue;
		if (source instanceof Iterable<?> values) {
			for (var value : values) {
				if (value instanceof Conjugation typedValue) {
					return typedValue;
				}
			}
			return null;
		}
		if (sourceValue instanceof Conjugation typedValue) {
			return typedValue;
		}
		return null;
	}
