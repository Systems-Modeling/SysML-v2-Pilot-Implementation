 ...
 * <li>{@link org.omg.sysml.lang.sysml.impl.ConnectorImpl#getOwnedRelatedElement_comp
...
public class ConnectorImpl extends FeatureImpl implements Connector {
	...
	public EList<Element> getOwnedRelatedElement_comp() {
		if (ownedRelatedElement_comp == null) {
			ownedRelatedElement_comp = new EObjectContainmentWithInverseEList<Element>(Element.class, this,
					SysMLPackage.CONNECTOR__OWNED_RELATED_ELEMENT_COMP, SysMLPackage.ELEMENT__OWNING_RELATIONSHIP);
		}
	...
	protected String getDefaultSupertype() {
		return getConnectorEnd().size() > 2 ? CONNECTOR_SUBSETTING_DEFAULT : BINARY_CONNECTOR_SUBSETTING_DEFAULT;
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Relationship.class) {
			...
			case SysMLPackage.RELATIONSHIP__OWNED_RELATED_ELEMENT_COMP:
				return SysMLPackage.CONNECTOR__OWNED_RELATED_ELEMENT_COMP;
