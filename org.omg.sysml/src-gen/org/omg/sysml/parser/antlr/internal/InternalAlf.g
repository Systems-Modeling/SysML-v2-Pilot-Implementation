...
entryRuleAnonymousClassDefinition returns [EObject current=null]:
	...
	{ $current=$iv_ruleAnonymousClassDefinition.current; }
	EOF;

// Rule AnonymousClassDefinition
ruleAnonymousClassDefinition returns [EObject current=null]
@init {
	enterRule();
}
@after {
