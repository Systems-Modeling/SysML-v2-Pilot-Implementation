...
public class Type_feature_SettingDelegate extends BasicDerivedListSettingDelegate {
	...
	public Type_feature_SettingDelegate(EStructuralFeature eStructuralFeature) {
		super(eStructuralFeature);
	}

	@Override
	protected EList<?> basicGet(InternalEObject owner) {
		EList<Feature> features = new NonNotifyingEObjectEList<>(Feature.class, owner, SysMLPackage.TYPE__FEATURE);
