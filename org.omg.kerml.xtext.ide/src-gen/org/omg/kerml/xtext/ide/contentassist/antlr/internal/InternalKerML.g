...
:
	...
	|
	(
		{ before(grammarAccess.getNonFeatureElementAccess().getTypeFeaturingParserRuleCall_20()); }
		ruleTypeFeaturing
		{ after(grammarAccess.getNonFeatureElementAccess().getTypeFeaturingParserRuleCall_20()); }
	)
;
finally {
	restoreStackSize(stackSize);
