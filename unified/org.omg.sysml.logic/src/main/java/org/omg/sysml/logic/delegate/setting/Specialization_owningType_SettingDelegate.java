...
/**
 * Generated setting delegate for {@code Specialization.owningType}.
 */
public class Specialization_owningType_SettingDelegate extends AbstractSettingDelegate {

    public Specialization_owningType_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "Specialization.owningType";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * subsets fallback for Specialization.owningType
         * subsets Relationship.owningRelatedElement
         * subsets Specialization.specific
         */
