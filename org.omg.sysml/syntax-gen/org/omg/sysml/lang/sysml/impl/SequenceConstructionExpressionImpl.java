 ...
 * </p>
 * <ul>
 * <li>{@link org.omg.sysml.lang.sysml.impl.SequenceConstructionExpressionImpl#getElement
 * <em>Element</em>}</li>
 * </ul>
 *
 * @generated
...
public class SequenceConstructionExpressionImpl extends ExpressionImpl implements SequenceConstructionExpression {
	/**
	 * The cached value of the '{@link #getElement() <em>Element</em>}' containment
	...
	public EList<Expression> getElement() {
		if (element == null) {
			element = new EObjectContainmentEList<Expression>(Expression.class, this,
					SysMLPackage.SEQUENCE_CONSTRUCTION_EXPRESSION__ELEMENT);
		}
		return element;
	}
