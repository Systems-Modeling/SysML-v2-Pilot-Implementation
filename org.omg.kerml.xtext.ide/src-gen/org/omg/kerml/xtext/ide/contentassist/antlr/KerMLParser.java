...
public class KerMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KerMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getUnitDocumentationAccess().getGroup_0_0(), "rule__UnitDocumentation__Group_0_0__0");
			builder.put(grammarAccess.getUnitDocumentationAccess().getGroup_1(), "rule__UnitDocumentation__Group_1__0");
			builder.put(grammarAccess.getUnitDocumentationAccess().getGroup_1_0(), "rule__UnitDocumentation__Group_1_0__0");
			...
			builder.put(grammarAccess.getUnitDocumentationAccess().getHumanIdAssignment_1_0_1_1(), "rule__UnitDocumentation__HumanIdAssignment_1_0_1_1");
			builder.put(grammarAccess.getUnitDocumentationAccess().getBodyAssignment_1_1(), "rule__UnitDocumentation__BodyAssignment_1_1");
			...
			builder.put(grammarAccess.getPackageBodyAccess().getDocumentation_compAssignment_1_0(), "rule__PackageBody__Documentation_compAssignment_1_0");
			builder.put(grammarAccess.getPackageBodyAccess().getOwnedMembership_compAssignment_1_1(), "rule__PackageBody__OwnedMembership_compAssignment_1_1");
			builder.put(grammarAccess.getPackageBodyAccess().getOwnedImport_compAssignment_1_2(), "rule__PackageBody__OwnedImport_compAssignment_1_2");
			...
			builder.put(grammarAccess.getBehaviorBodyAccess().getDocumentation_compAssignment_1_1_0(), "rule__BehaviorBody__Documentation_compAssignment_1_1_0");
			builder.put(grammarAccess.getBehaviorBodyAccess().getOwnedMembership_compAssignment_1_1_1(), "rule__BehaviorBody__OwnedMembership_compAssignment_1_1_1");
			builder.put(grammarAccess.getBehaviorBodyAccess().getOwnedFeatureMembership_compAssignment_1_1_2(), "rule__BehaviorBody__OwnedFeatureMembership_compAssignment_1_1_2");
			builder.put(grammarAccess.getBehaviorBodyAccess().getOwnedRelationship_compAssignment_1_1_3(), "rule__BehaviorBody__OwnedRelationship_compAssignment_1_1_3");
