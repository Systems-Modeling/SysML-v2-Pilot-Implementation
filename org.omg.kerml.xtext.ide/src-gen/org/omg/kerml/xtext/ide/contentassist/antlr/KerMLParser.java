...
public class KerMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KerMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFeatureMemberAccess().getOwnedRelatedElementAssignment_1_0(), "rule__FeatureMember__OwnedRelatedElementAssignment_1_0");
			builder.put(grammarAccess.getFeatureMemberAccess().getMemberNameAssignment_1_1_1(), "rule__FeatureMember__MemberNameAssignment_1_1_1");
			builder.put(grammarAccess.getFeatureMemberAccess().getMemberFeatureAssignment_1_1_3(), "rule__FeatureMember__MemberFeatureAssignment_1_1_3");
