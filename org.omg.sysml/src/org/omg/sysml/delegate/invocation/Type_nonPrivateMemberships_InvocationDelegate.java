...
public class Type_nonPrivateMemberships_InvocationDelegate extends BasicInvocationDelegate {
	...
	public Object dynamicInvoke(InternalEObject target, EList<?> arguments) throws InvocationTargetException {
		...
		return TypeUtil.getNonPrivateMembershipFor(self, new HashSet<Namespace>(excludedNamespaces), new HashSet<>(excludedTypes), excludeImplied);
	}
