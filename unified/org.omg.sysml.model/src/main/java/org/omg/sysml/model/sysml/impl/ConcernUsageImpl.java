 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.ConcernUsageImpl#getConcernDefinition <em>Concern Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConcernUsageImpl extends RequirementUsageImpl implements ConcernUsage {
	...
	public ConcernDefinition getConcernDefinition() {
		return (ConcernDefinition)eGet(SysMLPackage.Literals.CONCERN_USAGE__CONCERN_DEFINITION, true);
	}
	...
	public void setConcernDefinition(ConcernDefinition newConcernDefinition) {
		eSet(SysMLPackage.Literals.CONCERN_USAGE__CONCERN_DEFINITION, newConcernDefinition);
	}
	...
	public RequirementDefinition getRequirementDefinition() {
		var sourceValue = this.getConcernDefinition();
