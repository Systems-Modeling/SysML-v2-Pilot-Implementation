 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.DocumentationImpl#getDocumentedElement <em>Documented Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentationImpl extends CommentImpl implements Documentation {
	...
	public Element getDocumentedElement() {
		return (Element)eGet(SysMLPackage.Literals.DOCUMENTATION__DOCUMENTED_ELEMENT, true);
	}
	...
	public void setDocumentedElement(Element newDocumentedElement) {
		eSet(SysMLPackage.Literals.DOCUMENTATION__DOCUMENTED_ELEMENT, newDocumentedElement);
	}
	...
	public EList<Element> getAnnotatedElement() {
		var sourceValue = this.getDocumentedElement();
