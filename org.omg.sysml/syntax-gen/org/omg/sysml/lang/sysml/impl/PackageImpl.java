 ...
 * <li>{@link org.omg.sysml.lang.sysml.impl.PackageImpl#getOwnedRelationship
...
public class PackageImpl extends ElementImpl implements org.omg.sysml.lang.sysml.Package {
	/**
	 * The cached value of the '{@link #getOwnedImport() <em>Owned Import</em>}'
	...
	/**
	 * The cached value of the '{@link #getOwnedMembership() <em>Owned
	 * Membership</em>}' reference list. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 ...
	 * comp</em>}' reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * Membership comp</em>}' reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	protected static final int[] MEMBERSHIP_ESUBSETS = new int[] { SysMLPackage.PACKAGE__IMPORTED_MEMBERSHIP,
			SysMLPackage.PACKAGE__OWNED_MEMBERSHIP_COMP };
	...
	public EList<Element> getMember() {
		...
		members.addAll(getMembership().stream().map(m -> ((MembershipImpl) m).getMemberElement()).filter(m -> m != null)
	...
	public EList<Import> getOwnedImport() {
		return new DerivedEObjectEList<Import>(Import.class, this, SysMLPackage.PACKAGE__OWNED_IMPORT,
				new int[] { SysMLPackage.ELEMENT__OWNED_RELATIONSHIP });
	}

	/**
	 * The array of subset feature identifiers for the '{@link #getOwnedImport()
	...
	public EList<Element> getOwnedMember() {
		EList<Element> ownedMembers = new EObjectEList<Element>(Element.class, this,
				SysMLPackage.PACKAGE__OWNED_MEMBER);
...
//			System.out.println("Caching importedMembership for " + this);
	...
	public EList<Membership> getOwnedMembership_comp() {
		if (ownedMembership_comp == null) {
			ownedMembership_comp = new SubsetSupersetEObjectWithInverseResolvingEList<Membership>(Membership.class,
					this, SysMLPackage.PACKAGE__OWNED_MEMBERSHIP_COMP, OWNED_MEMBERSHIP_COMP_ESUPERSETS, null,
					SysMLPackage.MEMBERSHIP__MEMBERSHIP_OWNING_PACKAGE);
		}
	...
	public EList<Membership> getOwnedMembership() {
		EList<Membership> membership = new EObjectEList<Membership>(Membership.class, this,
				SysMLPackage.PACKAGE__OWNED_MEMBERSHIP);
		getOwnedRelationship().stream().filter(rel -> rel instanceof Membership).map(rel -> (Membership) rel)
				.forEachOrdered(membership::add);
		return membership;
	}

	/**
	 * The array of subset feature identifiers for the '{@link #getOwnedMembership()
	 * <em>Owned Membership</em>}' reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getOwnedMembership()
	 * @generated
	...
	public EList<Relationship> getOwnedRelationship() {
		if (ownedRelationship == null) {
			ownedRelationship = new SubsetSupersetEObjectContainmentWithInverseEList<Relationship>(Relationship.class,
					this, SysMLPackage.PACKAGE__OWNED_RELATIONSHIP, null, OWNED_RELATIONSHIP_ESUBSETS,
	 ...
	 * @ordered
	 */
	protected static final int[] OWNED_RELATIONSHIP_ESUBSETS = new int[] { SysMLPackage.PACKAGE__OWNED_MEMBERSHIP,
			SysMLPackage.PACKAGE__OWNED_IMPORT };
	...
	public EList<Import> getOwnedImport_comp() {
		if (ownedImport_comp == null) {
			ownedImport_comp = new SubsetSupersetEObjectWithInverseResolvingEList<Import>(Import.class, this,
					SysMLPackage.PACKAGE__OWNED_IMPORT_COMP, OWNED_IMPORT_COMP_ESUPERSETS, null,
					SysMLPackage.IMPORT__IMPORT_OWNING_PACKAGE);
		}
	...
	/**
	 * The array of superset feature identifiers for the
	 * '{@link #getOwnedImport_comp() <em>Owned Import comp</em>}' reference list.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOwnedImport_comp()
	 * @generated
	 ...
	 * @ordered
	 */
	protected static final int[] OWNED_MEMBERSHIP_COMP_ESUPERSETS = new int[] {
			SysMLPackage.PACKAGE__OWNED_MEMBERSHIP };
	...
	public EList<Membership> getImportedMembership(Collection<org.omg.sysml.lang.sysml.Package> excludedPackages,
		...
		EList<Membership> importedMembership = new EObjectEList<Membership>(Membership.class, this,
				SysMLPackage.PACKAGE__IMPORTED_MEMBERSHIP);
	...
	public boolean isSetMembership() {
		return eIsSet(SysMLPackage.PACKAGE__IMPORTED_MEMBERSHIP) || eIsSet(SysMLPackage.PACKAGE__OWNED_MEMBERSHIP_COMP);
	}
