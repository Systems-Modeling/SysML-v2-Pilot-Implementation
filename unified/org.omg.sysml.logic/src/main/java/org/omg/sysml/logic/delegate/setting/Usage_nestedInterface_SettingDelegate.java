...
/**
 * Generated setting delegate for {@code Usage.nestedInterface}.
 */
public class Usage_nestedInterface_SettingDelegate extends AbstractSettingDelegate {

    public Usage_nestedInterface_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "Usage.nestedInterface";
    }
    ...
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * OCL2.0 deriveUsageNestedInterface
