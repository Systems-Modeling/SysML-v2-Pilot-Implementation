 ...
 * </p>
 * <ul>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ConnectorImpl#getRelatedElement
 * <em>Related Element</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ConnectorImpl#getTarget
 * <em>Target</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ConnectorImpl#getSource
 * <em>Source</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ConnectorImpl#getOwningRelatedElement
 * <em>Owning Related Element</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ConnectorImpl#getOwnedRelatedElement
 * <em>Owned Related Element</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ConnectorImpl#getRelatedFeature
 * <em>Related Feature</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ConnectorImpl#getAssociation
 * <em>Association</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ConnectorImpl#getOwnedAssociationType
 * <em>Owned Association Type</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ConnectorImpl#isDirected <em>Is
 * Directed</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.ConnectorImpl#getConnectorEnd
...
public class ConnectorImpl extends FeatureImpl implements Connector {
	 ...
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated NOT // derived (inherited from Relationship.relatedElement)
	 */
	 ...
	 * @ordered
	 */
	protected static final int[] RELATED_ELEMENT_ESUBSETS = new int[] { SysMLPackage.CONNECTOR__TARGET,
			SysMLPackage.CONNECTOR__SOURCE, SysMLPackage.CONNECTOR__OWNING_RELATED_ELEMENT,
			SysMLPackage.CONNECTOR__OWNED_RELATED_ELEMENT, SysMLPackage.CONNECTOR__RELATED_FEATURE };
	...
	public boolean isSetRelatedElement() {
		return eIsSet(SysMLPackage.CONNECTOR__TARGET) || eIsSet(SysMLPackage.CONNECTOR__SOURCE)
	...
	public EList<Element> getOwnedRelatedElement() {
		if (ownedRelatedElement == null) {
			ownedRelatedElement = new EObjectContainmentWithInverseEList<Element>(Element.class, this,
					SysMLPackage.CONNECTOR__OWNED_RELATED_ELEMENT, SysMLPackage.ELEMENT__OWNING_RELATIONSHIP);
		}
	...
	public Element getOwningRelatedElement() {
		if (eContainerFeatureID() != SysMLPackage.CONNECTOR__OWNING_RELATED_ELEMENT)
			return null;
	...
	public NotificationChain basicSetOwningRelatedElement(Element newOwningRelatedElement, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newOwningRelatedElement,
				SysMLPackage.CONNECTOR__OWNING_RELATED_ELEMENT, msgs);
		return msgs;
	}
	...
	public void setOwningRelatedElement(Element newOwningRelatedElement) {
		if (newOwningRelatedElement != eInternalContainer()
				|| (eContainerFeatureID() != SysMLPackage.CONNECTOR__OWNING_RELATED_ELEMENT
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.CONNECTOR__OWNING_RELATED_ELEMENT,
	...
	public EList<Association> getAssociation() {
		EList<Association> associations = new EObjectEList<Association>(Association.class, this,
				SysMLPackage.CONNECTOR__ASSOCIATION);
	...
	public void setIsDirected(boolean newIsDirected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.CONNECTOR__IS_DIRECTED, oldIsDirected,
					isDirected));
	}
	...
	public EList<Feature> getConnectorEnd() {
		return new DerivedEObjectEList<Feature>(Feature.class, this, SysMLPackage.CONNECTOR__CONNECTOR_END,
			...
			protected Feature derive(Object object) {
				return object instanceof EndFeatureMembership ? ((EndFeatureMembership) object).getMemberFeature()
						: null;
			}
		};
	}
	...
	private static void getPath(EList<Feature> path, org.omg.sysml.lang.sysml.Package start, Feature feature) {
		if (feature != null) {
	...
	public EList<Subsetting> getOwnedSubsetting() {
		return getOwnedSubsettingWithDefault(
				getConnectorEnd().size() > 2 ? CONNECTOR_SUBSETTING_DEFAULT : BINARY_CONNECTOR_SUBSETTING_DEFAULT);
	}
	...
	public static void setRelatedFeature(Feature connectorEnd, Feature relatedFeature) {
		((FeatureImpl) connectorEnd).getFirstSubsetting()
				.orElseGet(() -> ((FeatureImpl) connectorEnd).createSubsetting()).setSubsettedFeature(relatedFeature);
	}
