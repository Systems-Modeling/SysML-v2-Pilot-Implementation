...
/**
 * Generated setting delegate for {@code CaseDefinition.subjectParameter}.
 */
public class CaseDefinition_subjectParameter_SettingDelegate extends AbstractSettingDelegate {

    public CaseDefinition_subjectParameter_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "CaseDefinition.subjectParameter";
    }
    ...
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * OCL2.0 deriveCaseDefinitionSubjectParameter
         * subjectParameter =
