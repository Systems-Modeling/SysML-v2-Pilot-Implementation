...
/**
 * Generated invocation delegate for {@code Type::supertypes}.
 */
public class Type_supertypes_InvocationDelegate extends AbstractInvocationDelegate {
    ...
    public Object dynamicInvoke(InternalEObject target, EList<?> arguments) throws InvocationTargetException {
        ...
        if (target instanceof Type self) {
            var excludeImplied = arguments != null && !arguments.isEmpty() && arguments.getFirst() instanceof Boolean value
                    ? value.booleanValue()
                    : false;
            if (self.isIsConjugated()) {
                ...
                for (var specialization : self.getOwnedSpecialization()) {
