 ...
 * </p>
 * <ul>
 * <li>{@link org.omg.sysml.lang.sysml.impl.RedefinitionImpl#getRedefiningFeature
 * <em>Redefining Feature</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.RedefinitionImpl#getRedefinedFeature
...
public class RedefinitionImpl extends SubsettingImpl implements Redefinition {
	/**
	 * The cached value of the '{@link #getRedefiningFeature() <em>Redefining
	...
	/**
	 * The cached value of the '{@link #getRedefinedFeature() <em>Redefined
	 * Feature</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
			...
			if (redefiningFeature != oldRedefiningFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SysMLPackage.REDEFINITION__REDEFINING_FEATURE, oldRedefiningFeature, redefiningFeature));
			}
		}
	...
	public void setRedefiningFeature(Feature newRedefiningFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.REDEFINITION__REDEFINING_FEATURE,
					oldRedefiningFeature, redefiningFeature));
	}
	...
	public Feature getRedefinedFeature() {
		if (redefinedFeature != null && redefinedFeature.eIsProxy()) {
			...
			if (redefinedFeature != oldRedefinedFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SysMLPackage.REDEFINITION__REDEFINED_FEATURE, oldRedefinedFeature, redefinedFeature));
			}
		}
	...
	public void setRedefinedFeature(Feature newRedefinedFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.REDEFINITION__REDEFINED_FEATURE,
					oldRedefinedFeature, redefinedFeature));
	}
