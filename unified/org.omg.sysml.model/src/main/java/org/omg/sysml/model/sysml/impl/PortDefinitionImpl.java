 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.PortDefinitionImpl#getConjugatedPortDefinition <em>Conjugated Port Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PortDefinitionImpl extends OccurrenceDefinitionImpl implements PortDefinition {
	...
	public ConjugatedPortDefinition getConjugatedPortDefinition() {
		return (ConjugatedPortDefinition)eGet(SysMLPackage.Literals.PORT_DEFINITION__CONJUGATED_PORT_DEFINITION, true);
	}
	...
	public void setConjugatedPortDefinition(ConjugatedPortDefinition newConjugatedPortDefinition) {
		eSet(SysMLPackage.Literals.PORT_DEFINITION__CONJUGATED_PORT_DEFINITION, newConjugatedPortDefinition);
	}
