...
/**
 * Generated setting delegate for {@code CaseUsage.objectiveRequirement}.
 */
public class CaseUsage_objectiveRequirement_SettingDelegate extends AbstractSettingDelegate {

    public CaseUsage_objectiveRequirement_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "CaseUsage.objectiveRequirement";
    }
    ...
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * OCL2.0 deriveCaseUsageObjectiveRequirement
