 ...
 *
 */
public class AlfRepositorySaveUtil extends AlfTraversalUtil {
	
	/**
	 * A string representation of the UUID of the Porject in the repository to which Elements and
	...
	public static void main(String[] args) {
		new AlfRepositorySaveUtil().run(args);
	}
