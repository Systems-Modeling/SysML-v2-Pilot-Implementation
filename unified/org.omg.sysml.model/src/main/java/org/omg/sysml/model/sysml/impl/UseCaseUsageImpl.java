 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.UseCaseUsageImpl#getIncludedUseCase <em>Included Use Case</em>}</li>
 *   <li>{@link org.omg.sysml.model.sysml.impl.UseCaseUsageImpl#getUseCaseDefinition <em>Use Case Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UseCaseUsageImpl extends CaseUsageImpl implements UseCaseUsage {
	...
	public EList<UseCaseUsage> getIncludedUseCase() {
		return (EList<UseCaseUsage>)eGet(SysMLPackage.Literals.USE_CASE_USAGE__INCLUDED_USE_CASE, true);
	}
	...
	public UseCaseDefinition getUseCaseDefinition() {
		return (UseCaseDefinition)eGet(SysMLPackage.Literals.USE_CASE_USAGE__USE_CASE_DEFINITION, true);
	}
	...
	public void setUseCaseDefinition(UseCaseDefinition newUseCaseDefinition) {
		eSet(SysMLPackage.Literals.USE_CASE_USAGE__USE_CASE_DEFINITION, newUseCaseDefinition);
	}
	...
	public CaseDefinition getCaseDefinition() {
		var sourceValue = this.getUseCaseDefinition();
