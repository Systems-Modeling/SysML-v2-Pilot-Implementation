 ...
 *     if owningType <> null and owningType.oclIsKindOf(Feature) and 
 *         owningType.oclAsType(Feature).isOwnedCrossFeature() then
 *         owningType.oclAsType(Feature).owningType.oclAsType(Feature).featuringType
 *     else
 *         featuringType
 *     endif in
