...
public class KerMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KerMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNonFeaturePackageMemberAccess().getAlternatives(), "rule__NonFeaturePackageMember__Alternatives");
			builder.put(grammarAccess.getNonFeaturePackageMemberAccess().getAlternatives_1_0(), "rule__NonFeaturePackageMember__Alternatives_1_0");
			...
			builder.put(grammarAccess.getNonFeaturePackageMemberAccess().getGroup_1(), "rule__NonFeaturePackageMember__Group_1__0");
			builder.put(grammarAccess.getNonFeaturePackageMemberAccess().getGroup_1_2(), "rule__NonFeaturePackageMember__Group_1_2__0");
			...
			builder.put(grammarAccess.getNonFeaturePackageMemberAccess().getOwnedMemberElement_compAssignment_0(), "rule__NonFeaturePackageMember__OwnedMemberElement_compAssignment_0");
			builder.put(grammarAccess.getNonFeaturePackageMemberAccess().getMemberElementAssignment_1_1(), "rule__NonFeaturePackageMember__MemberElementAssignment_1_1");
			builder.put(grammarAccess.getNonFeaturePackageMemberAccess().getMemberNameAssignment_1_2_1(), "rule__NonFeaturePackageMember__MemberNameAssignment_1_2_1");
