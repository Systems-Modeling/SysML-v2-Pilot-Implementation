...
public class ForkNodeAdapter extends ControlNodeAdapter {

	public static final String FORK_NODE_SUBSETTING_BASE_DEFAULT = "Actions::Action::forks";

	public ForkNodeAdapter(ForkNode element) {
		super(element);
	}
	
	@Override
	public ForkNode getTarget() {
		return (ForkNode)super.getTarget();
	}
