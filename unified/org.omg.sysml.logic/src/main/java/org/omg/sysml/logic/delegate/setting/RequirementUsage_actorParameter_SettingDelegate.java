...
/**
 * Generated setting delegate for {@code RequirementUsage.actorParameter}.
 */
public class RequirementUsage_actorParameter_SettingDelegate extends AbstractSettingDelegate {

    public RequirementUsage_actorParameter_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "RequirementUsage.actorParameter";
    }
    ...
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * OCL2.0 deriveRequirementUsageActorParameter
