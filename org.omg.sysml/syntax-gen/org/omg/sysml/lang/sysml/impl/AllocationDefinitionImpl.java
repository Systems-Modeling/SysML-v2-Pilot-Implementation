 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.lang.sysml.impl.AllocationDefinitionImpl#getAllocation <em>Allocation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AllocationDefinitionImpl extends ConnectionDefinitionImpl implements AllocationDefinition {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SysMLPackage.ALLOCATION_DEFINITION__ALLOCATION:
				getAllocation().clear();
				getAllocation().addAll((Collection<? extends AllocationUsage>)newValue);
				return;
		}
