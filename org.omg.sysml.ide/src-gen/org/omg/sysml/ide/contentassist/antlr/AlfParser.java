		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFeatureClassMemberAccess().getAlternatives_1(), "rule__FeatureClassMember__Alternatives_1");
					...
					put(grammarAccess.getFeatureClassMemberAccess().getGroup_1_1(), "rule__FeatureClassMember__Group_1_1__0");
					put(grammarAccess.getFeatureClassMemberAccess().getGroup_1_2(), "rule__FeatureClassMember__Group_1_2__0");
					put(grammarAccess.getClassMemberPrefixAccess().getGroup(), "rule__ClassMemberPrefix__Group__0");
					...
					put(grammarAccess.getPackageImportAccess().getOwnedElementAssignment_0(), "rule__PackageImport__OwnedElementAssignment_0");
					...
					put(grammarAccess.getPackageMemberPrefixAccess().getOwnedElementAssignment_0(), "rule__PackageMemberPrefix__OwnedElementAssignment_0");
					...
					put(grammarAccess.getFeatureClassMemberAccess().getDirectionAssignment_1_1_0(), "rule__FeatureClassMember__DirectionAssignment_1_1_0");
					put(grammarAccess.getFeatureClassMemberAccess().getOwnedMemberElementAssignment_1_1_1(), "rule__FeatureClassMember__OwnedMemberElementAssignment_1_1_1");
					put(grammarAccess.getFeatureClassMemberAccess().getMemberNameAssignment_1_2_0(), "rule__FeatureClassMember__MemberNameAssignment_1_2_0");
					put(grammarAccess.getFeatureClassMemberAccess().getMemberElementAssignment_1_2_2(), "rule__FeatureClassMember__MemberElementAssignment_1_2_2");
					put(grammarAccess.getClassMemberPrefixAccess().getOwnedElementAssignment_0(), "rule__ClassMemberPrefix__OwnedElementAssignment_0");
					put(grammarAccess.getClassMemberPrefixAccess().getVisibilityAssignment_1(), "rule__ClassMemberPrefix__VisibilityAssignment_1");
					...
					put(grammarAccess.getAssociationEndFeatureMemberAccess().getDirectionAssignment_1_0_1(), "rule__AssociationEndFeatureMember__DirectionAssignment_1_0_1");
					put(grammarAccess.getAssociationEndFeatureMemberAccess().getOwnedMemberElementAssignment_1_0_2(), "rule__AssociationEndFeatureMember__OwnedMemberElementAssignment_1_0_2");
					put(grammarAccess.getAssociationEndFeatureMemberAccess().getMemberNameAssignment_1_1_1(), "rule__AssociationEndFeatureMember__MemberNameAssignment_1_1_1");
					put(grammarAccess.getAssociationEndFeatureMemberAccess().getMemberElementAssignment_1_1_3(), "rule__AssociationEndFeatureMember__MemberElementAssignment_1_1_3");
					...
					put(grammarAccess.getAssociationEndFeatureMemberAccess().getOwnedMemberElementAssignment_1_2_1(), "rule__AssociationEndFeatureMember__OwnedMemberElementAssignment_1_2_1");
					...
					put(grammarAccess.getAssociationEndFeatureMemberAccess().getMemberElementAssignment_1_3_2(), "rule__AssociationEndFeatureMember__MemberElementAssignment_1_3_2");
