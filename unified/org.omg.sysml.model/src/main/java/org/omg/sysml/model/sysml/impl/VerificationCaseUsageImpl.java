 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.VerificationCaseUsageImpl#getVerificationCaseDefinition <em>Verification Case Definition</em>}</li>
 *   <li>{@link org.omg.sysml.model.sysml.impl.VerificationCaseUsageImpl#getVerifiedRequirement <em>Verified Requirement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VerificationCaseUsageImpl extends CaseUsageImpl implements VerificationCaseUsage {
	...
	public VerificationCaseDefinition getVerificationCaseDefinition() {
		return (VerificationCaseDefinition)eGet(SysMLPackage.Literals.VERIFICATION_CASE_USAGE__VERIFICATION_CASE_DEFINITION, true);
	}
	...
	public void setVerificationCaseDefinition(VerificationCaseDefinition newVerificationCaseDefinition) {
		eSet(SysMLPackage.Literals.VERIFICATION_CASE_USAGE__VERIFICATION_CASE_DEFINITION, newVerificationCaseDefinition);
	}
	...
	public EList<RequirementUsage> getVerifiedRequirement() {
		return (EList<RequirementUsage>)eGet(SysMLPackage.Literals.VERIFICATION_CASE_USAGE__VERIFIED_REQUIREMENT, true);
	}
