 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.lang.sysml.impl.InterfaceDefinitionImpl#getOwnedPort <em>Owned Port</em>}</li>
 *   <li>{@link org.omg.sysml.lang.sysml.impl.InterfaceDefinitionImpl#getFlowProperty <em>Flow Property</em>}</li>
 *   <li>{@link org.omg.sysml.lang.sysml.impl.InterfaceDefinitionImpl#getOwnedProperty <em>Owned Property</em>}</li>
 *   <li>{@link org.omg.sysml.lang.sysml.impl.InterfaceDefinitionImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link org.omg.sysml.lang.sysml.impl.InterfaceDefinitionImpl#getOwnedAction <em>Owned Action</em>}</li>
 *   <li>{@link org.omg.sysml.lang.sysml.impl.InterfaceDefinitionImpl#getOwnedUsage <em>Owned Usage</em>}</li>
...
public class InterfaceDefinitionImpl extends AssociationImpl implements InterfaceDefinition {
	...
	public EList<Action> getOwnedAction() {
		return new DerivedEObjectEList<Action>(Action.class, this, SysMLPackage.DEFINITION__OWNED_ACTION, new int[] {SysMLPackage.TYPE__OWNED_FEATURE});
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SysMLPackage.INTERFACE_DEFINITION__OWNED_PORT:
				return getOwnedPort();
			case SysMLPackage.INTERFACE_DEFINITION__FLOW_PROPERTY:
				return getFlowProperty();
			case SysMLPackage.INTERFACE_DEFINITION__OWNED_PROPERTY:
				return getOwnedProperty();
			case SysMLPackage.INTERFACE_DEFINITION__PROPERTY:
				return getProperty();
			case SysMLPackage.INTERFACE_DEFINITION__OWNED_ACTION:
				return getOwnedAction();
			case SysMLPackage.INTERFACE_DEFINITION__OWNED_USAGE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Definition.class) {
			switch (derivedFeatureID) {
				case SysMLPackage.INTERFACE_DEFINITION__OWNED_PORT: return SysMLPackage.DEFINITION__OWNED_PORT;
				case SysMLPackage.INTERFACE_DEFINITION__FLOW_PROPERTY: return SysMLPackage.DEFINITION__FLOW_PROPERTY;
				case SysMLPackage.INTERFACE_DEFINITION__OWNED_PROPERTY: return SysMLPackage.DEFINITION__OWNED_PROPERTY;
				case SysMLPackage.INTERFACE_DEFINITION__PROPERTY: return SysMLPackage.DEFINITION__PROPERTY;
				case SysMLPackage.INTERFACE_DEFINITION__OWNED_ACTION: return SysMLPackage.DEFINITION__OWNED_ACTION;
				case SysMLPackage.INTERFACE_DEFINITION__OWNED_USAGE: return SysMLPackage.DEFINITION__OWNED_USAGE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Definition.class) {
			switch (baseFeatureID) {
				case SysMLPackage.DEFINITION__OWNED_PORT: return SysMLPackage.INTERFACE_DEFINITION__OWNED_PORT;
				case SysMLPackage.DEFINITION__FLOW_PROPERTY: return SysMLPackage.INTERFACE_DEFINITION__FLOW_PROPERTY;
				case SysMLPackage.DEFINITION__OWNED_PROPERTY: return SysMLPackage.INTERFACE_DEFINITION__OWNED_PROPERTY;
				case SysMLPackage.DEFINITION__PROPERTY: return SysMLPackage.INTERFACE_DEFINITION__PROPERTY;
				case SysMLPackage.DEFINITION__OWNED_ACTION: return SysMLPackage.INTERFACE_DEFINITION__OWNED_ACTION;
				case SysMLPackage.DEFINITION__OWNED_USAGE: return SysMLPackage.INTERFACE_DEFINITION__OWNED_USAGE;
				default: return -1;
			}
		}
