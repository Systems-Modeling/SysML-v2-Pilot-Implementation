...
/**
 * Generated setting delegate for {@code FeatureReferenceExpression.referent}.
 */
public class FeatureReferenceExpression_referent_SettingDelegate extends AbstractSettingDelegate {

    public FeatureReferenceExpression_referent_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "FeatureReferenceExpression.referent";
    }
    ...
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * OCL2.0 deriveFeatureReferenceExpressionReferent
         * referent =
         ...
         */
        Object result = null;
        if (owner instanceof FeatureReferenceExpression self) {
            for (var ownedMembership : self.getOwnedMembership()) {
                if (!(ownedMembership instanceof ParameterMembership)
                        && ownedMembership.getMemberElement() instanceof Feature feature) {
                    result = feature;
                    break;
                }
            }
