 ...
 * <em>Membership</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.TypeImpl#getOwnedRelationship_comp
 * <em>Owned Relationship comp</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.TypeImpl#getConjugator
 * <em>Conjugator</em>}</li>
 ...
 * <li>{@link org.omg.sysml.lang.sysml.impl.TypeImpl#getOwnedFeatureMembership_comp
 * <em>Owned Feature Membership comp</em>}</li>
 ...
 * Sufficient</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.TypeImpl#getOwnedConjugator
 * <em>Owned Conjugator</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.TypeImpl#isConjugated <em>Is
 * Conjugated</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.TypeImpl#getFeatureMembership
 * <em>Feature Membership</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.TypeImpl#getInheritedFeature
 * <em>Inherited Feature</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.TypeImpl#getMultiplicity
...
public class TypeImpl extends PackageImpl implements Type {
	...
	/**
	 * The cached value of the '{@link #getConjugator() <em>Conjugator</em>}'
	...
	/**
	 * The cached value of the '{@link #getOwnedFeatureMembership_comp() <em>Owned
	 * Feature Membership comp</em>}' containment reference list. <!--
	...
	/**
	 * The default value of the '{@link #isConjugated() <em>Is Conjugated</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isConjugated()
	 * @generated
	...
	protected static final int[] MEMBERSHIP_ESUBSETS = new int[] { SysMLPackage.TYPE__IMPORTED_MEMBERSHIP,
			SysMLPackage.TYPE__OWNED_MEMBERSHIP, SysMLPackage.TYPE__INHERITED_MEMBERSHIP };
	...
	public EList<Relationship> getOwnedRelationship_comp() {
		if (ownedRelationship_comp == null) {
			ownedRelationship_comp = new EObjectContainmentWithInverseEList<Relationship>(Relationship.class, this,
					SysMLPackage.TYPE__OWNED_RELATIONSHIP_COMP, SysMLPackage.RELATIONSHIP__OWNING_RELATED_ELEMENT);
		}
		...
		if (conjugator != null && conjugator.eIsProxy()) {
			...
			if (conjugator != oldConjugator) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SysMLPackage.TYPE__CONJUGATOR,
							oldConjugator, conjugator));
			}
		}
		return conjugator;
	}
	...
	public Conjugation basicGetConjugator() {
		if (conjugator == null) {
			conjugator = (Conjugation) getOwnedRelationship_comp().stream().filter(r -> r instanceof Conjugation)
	...
	public NotificationChain basicSetConjugator(Conjugation newConjugator, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SysMLPackage.TYPE__CONJUGATOR, oldConjugator, newConjugator);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setConjugator(Conjugation newConjugator) {
		if (newConjugator != conjugator) {
			...
			if (conjugator != null)
				msgs = ((InternalEObject) conjugator).eInverseRemove(this, SysMLPackage.CONJUGATION__CONJUGATED_TYPE,
						Conjugation.class, msgs);
			if (newConjugator != null)
				msgs = ((InternalEObject) newConjugator).eInverseAdd(this, SysMLPackage.CONJUGATION__CONJUGATED_TYPE,
						Conjugation.class, msgs);
			msgs = basicSetConjugator(newConjugator, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.TYPE__CONJUGATOR, newConjugator,
					newConjugator));
	}
	...
	public EList<Membership> getOwnedMembership_comp() {
		if (ownedMembership_comp == null) {
			ownedMembership_comp = new EObjectContainmentWithInverseEList<Membership>(Membership.class, this,
					SysMLPackage.TYPE__OWNED_MEMBERSHIP_COMP, SysMLPackage.MEMBERSHIP__MEMBERSHIP_OWNING_PACKAGE);
		}
	...
	public EList<Generalization> getOwnedGeneralization() {
		...
		basicGetOwnedGeneralization().stream().filter(gen -> ((GeneralizationImpl) gen).basicGetGeneral() != null)
				.forEachOrdered(generalizations::add);
		generalizations.addAll(implicitGeneralizations.values());
		return new UnmodifiableEList<Generalization>(this, SysMLPackage.eINSTANCE.getType_OwnedGeneralization(),
				generalizations.size(), generalizations.toArray());
	}
	...
	protected <T extends Generalization> EList<T> basicGetOwnedGeneralization(Class<T> kind, int featureID) {
		List<T> generalizations = new ArrayList<T>();
		...
		return new UnmodifiableEList<T>(this, this.eClass().getEStructuralFeature(featureID), generalizations.size(),
	...
	public EList<Relationship> getOwnedRelationship() {
		...
		ownedRelationships.addAll(implicitGeneralizations.values());
	...
	protected void addImplicitGeneralization(EClass generalizationEClass, String... superTypeNames) {
		...
		implicitGeneralizations.computeIfAbsent(generalizationEClass,
				eClass -> doComputeImplicitGeneralization(eClass, superTypeNames));
	}
	...
	private Generalization doComputeImplicitGeneralization(EClass generalizationEClass, String... superTypeNames) {
		return getDefaultGeneralization(
				basicGetOwnedGeneralization((Class<? extends Generalization>) generalizationEClass.getInstanceClass(),
	...
	protected <T extends Generalization> Generalization getDefaultGeneralization(EList<T> generalizations,
	...
	public EList<FeatureMembership> getOwnedFeatureMembership() {
		List<FeatureMembership> ownedFeatureMemberships = new ArrayList<FeatureMembership>();
		ownedFeatureMemberships.addAll(getOwnedFeatureMembership_comp());
		return new UnmodifiableEList<FeatureMembership>(this, SysMLPackage.eINSTANCE.getType_OwnedFeatureMembership(),
				ownedFeatureMemberships.size(), ownedFeatureMemberships.toArray());
	}
...
//			System.out.println("Caching inheritedMembership for " + this);
	...
	public Conjugation getOwnedConjugator() {
		...
		return ownedConjugator != null && ownedConjugator.eIsProxy()
				? (Conjugation) eResolveProxy((InternalEObject) ownedConjugator)
				: ownedConjugator;
	}
	...
	public EList<FeatureMembership> getFeatureMembership() {
		EList<FeatureMembership> featureMemberships = new EObjectEList<FeatureMembership>(FeatureMembership.class, this,
				SysMLPackage.TYPE__FEATURE_MEMBERSHIP);
		getMembership().stream().filter(m -> m instanceof FeatureMembership).map(m -> (FeatureMembership) m)
	...
	public EList<Feature> getInheritedFeature() {
		...
		getInheritedMembership().stream().filter(m -> m instanceof FeatureMembership)
				.map(m -> ((FeatureMembership) m).getMemberFeature()).filter(f -> f != null)
	...
	public Multiplicity getMultiplicity() {
		...
		return multiplicity != null && multiplicity.eIsProxy()
				? (Multiplicity) eResolveProxy((InternalEObject) multiplicity)
				: multiplicity;
	}
	...
	protected Multiplicity getMultiplicity(Set<Type> visited) {
		Multiplicity multiplicity = (Multiplicity) getOwnedFeature().stream()
				.filter(feature -> feature instanceof Multiplicity).findFirst().orElse(null);
	...
	public EList<Feature> getOwnedEndFeature() {
		...
		return new UnmodifiableEList<Feature>(this, SysMLPackage.eINSTANCE.getType_EndFeature(), features.size(),
				features.toArray());
	}
	...
	public EList<Membership> getInheritedMembership(Collection<org.omg.sysml.lang.sysml.Package> excludedPackages,
		...
		if (conjugator != null) {
			...
			if (originalType != null && !excludedTypes.contains(originalType)) {
				inheritedMemberships.addAll(
						((TypeImpl) originalType).getMembership(excludedPackages, excludedTypes, includeProtected));
			}
		}
	...
	public Collection<Feature> getRedefinedFeatures() {
		return getOwnedFeature().stream().flatMap(feature -> feature.getOwnedGeneralization().stream())
				.filter(Redefinition.class::isInstance)
				.map(redefinition -> ((Redefinition) redefinition).getRedefinedFeature()).collect(Collectors.toSet());
	}
	 ...
	 * @ordered
	 */
	protected static final int[] OWNED_GENERALIZATION_ESUPERSETS = new int[] {
			SysMLPackage.TYPE__OWNED_RELATIONSHIP_COMP };
	...
	public EList<FeatureMembership> getOwnedFeatureMembership_comp() {
		if (ownedFeatureMembership_comp == null) {
			ownedFeatureMembership_comp = new EObjectContainmentWithInverseEList<FeatureMembership>(
					FeatureMembership.class, this, SysMLPackage.TYPE__OWNED_FEATURE_MEMBERSHIP_COMP,
					SysMLPackage.FEATURE_MEMBERSHIP__OWNING_TYPE);
		}
	...
	public FeatureDirectionKind directionOf(Feature feature) {
		...
		return isInput && isOutput ? FeatureDirectionKind.INOUT
				: isInput ? FeatureDirectionKind.IN : isOutput ? FeatureDirectionKind.OUT : null;
	}
	...
	public EList<Membership> getOwnedMembership() {
		...
		ownedMemberships.addAll(super.getOwnedMembership());
	...
	protected boolean conformsTo(Type supertype, Set<Type> visited) {
		if (this == supertype) {
			...
			if (isConjugated()) {
				...
				return getOwnedGeneralization().stream().anyMatch(gen -> !visited.contains(gen.getGeneral())
	...
	public List<Feature> getOwnedEndFeatures() {
		return getOwnedFeature().stream().filter(Feature::isEnd).collect(Collectors.toList());
	}
	...
	protected Parameter getResultParameter() {
		return getAllParameters().stream().filter(parameter -> ((ParameterImpl) parameter).isResultParameter())
				.findFirst().orElse(null);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case SysMLPackage.TYPE__OWNED_FEATURE_MEMBERSHIP_COMP:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getOwnedFeatureMembership_comp())
