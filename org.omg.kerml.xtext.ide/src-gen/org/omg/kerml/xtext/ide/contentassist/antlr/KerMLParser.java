...
public class KerMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KerMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getImportAccess().getImportedNamespaceAssignment_3_0_0(), "rule__Import__ImportedNamespaceAssignment_3_0_0");
			builder.put(grammarAccess.getImportAccess().getImportedNamespaceAssignment_3_1_0(), "rule__Import__ImportedNamespaceAssignment_3_1_0");
			builder.put(grammarAccess.getImportAccess().getImportedNamespaceAssignment_3_2_0(), "rule__Import__ImportedNamespaceAssignment_3_2_0");
			builder.put(grammarAccess.getImportAccess().getIsRecursiveAssignment_4_1(), "rule__Import__IsRecursiveAssignment_4_1");
