...
/**
 * Generated setting delegate for {@code StateUsage.exitAction}.
 */
public class StateUsage_exitAction_SettingDelegate extends AbstractSettingDelegate {

    public StateUsage_exitAction_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "StateUsage.exitAction";
    }
    ...
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * OCL2.0 deriveStateUsageExitAction
         * exitAction =
        ...
        if (owner instanceof StateUsage self) {
            for (var ownedMembership : self.getOwnedMembership()) {
                if (ownedMembership instanceof StateSubactionMembership stateSubactionMembership
                        && stateSubactionMembership.getKind() == StateSubactionKind.EXIT) {
