...
/**
 * Generated setting delegate for {@code ActionUsage.actionDefinition}.
 */
public class ActionUsage_actionDefinition_SettingDelegate extends AbstractSettingDelegate {

    public ActionUsage_actionDefinition_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "ActionUsage.actionDefinition";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * inferred fallback for ActionUsage.actionDefinition
        ...
        var values = new BasicEList<Object>();
        {
            ...
            if (sourceValue instanceof Iterable<?> iterable) {
                for (var candidate : iterable) {
                    if (candidate instanceof Behavior) {
                        values.add(candidate);
                    }
                }
            } else if (sourceValue instanceof Behavior) {
