...
public class FlowConnectionDefinitionItemProvider extends ActionDefinitionItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFlowConnectionEndPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Flow Connection End feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFlowConnectionEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FlowConnectionDefinition_flowConnectionEnd_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FlowConnectionDefinition_flowConnectionEnd_feature", "_UI_FlowConnectionDefinition_type"),
				 SysMLPackage.Literals.FLOW_CONNECTION_DEFINITION__FLOW_CONNECTION_END,
				 true,
				 false,
				 true,
				 null,
