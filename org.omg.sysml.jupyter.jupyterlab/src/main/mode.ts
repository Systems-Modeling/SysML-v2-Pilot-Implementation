	...
	CodeMirror.defineMode(SI_MODE, (gc_mode, gc_parser) => {
		return CodeMirror.getMode(gc_mode, {
			...
			keywords: [
				...
				'bind', 'block', 'by', 'calc', 'case', 'comment', 'concern', 'connect', 'connection', 'constraint', 'decide', 'def', 'defined', 'dependency', 'do', 'doc', 'else', 'end', 'entry', 'enum', 
				'exhibit', 'exit', 'expose', 'filter', 'first', 'flow', 'for', 'fork', 'frame', 'from', 'hastype', 'id', 'if', 'import', 'in', 'inout', 'instanceof', 'interface', 'individual', 'involve', 'istype', 
				...
				'redefines', 'ref', 'render', 'rendering', 'rep', 'require', 'requirement', 'return', 'satisfy', 'send', 'snapshot', 'specializes', 'stakeholder', 'state', 'stream', 'subsets', 'subject', 'succession', 
				'then', 'timeslice', 'to', 'transition', 'type', 'value', 'variant', 'variation', 'verification', 'verify', 'view', 'viewpoint',
			].reduce(f_wordify, {}),
			defKeywords: [
				'action', 'activity', 'allocation', 'analysis', 'assoc', 'attribute', 'block', 'calc', 'case', 'comment', 'concern', 'connection', 'constraint', 'doc', 'def', 'enum', 'id', 'link', 'individual', 
				'interface', 'item', 'metadata', 'package', 'objective', 'part', 'port', 'ref', 'rendering', 'rep', 'requirement', 'snapshot', 'stakeholder', 'state', 'timeslice', 'transition', 'type', 'value', 
