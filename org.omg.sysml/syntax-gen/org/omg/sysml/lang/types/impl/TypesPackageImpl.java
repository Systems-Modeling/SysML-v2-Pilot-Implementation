...
public class TypesPackageImpl extends EPackageImpl implements TypesPackage {
	...
	public static TypesPackage init() {
		...
		SysMLPackageImpl theSysMLPackage = (SysMLPackageImpl) (registeredPackage instanceof SysMLPackageImpl
				? registeredPackage
	...
	public void initializePackageContents() {
		...
		initEDataType(unlimitedNaturalEDataType, int.class, "UnlimitedNatural", IS_SERIALIZABLE,
	...
	protected void createUMLAnnotations() {
		...
		addAnnotation(this, source, new String[] { "originalName", "primitiveTypes" });
	}
