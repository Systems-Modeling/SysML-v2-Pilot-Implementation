...
/**
 * Generated setting delegate for {@code StateUsage.doAction}.
 */
public class StateUsage_doAction_SettingDelegate extends AbstractSettingDelegate {

    public StateUsage_doAction_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "StateUsage.doAction";
    }
    ...
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * OCL2.0 deriveStateUsageDoAction
         * doAction =
