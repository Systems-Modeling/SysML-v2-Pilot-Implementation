 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.ViewRenderingMembershipImpl#getOwnedRendering <em>Owned Rendering</em>}</li>
 *   <li>{@link org.omg.sysml.model.sysml.impl.ViewRenderingMembershipImpl#getReferencedRendering <em>Referenced Rendering</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ViewRenderingMembershipImpl extends FeatureMembershipImpl implements ViewRenderingMembership {
	...
	public RenderingUsage getOwnedRendering() {
		return (RenderingUsage)eGet(SysMLPackage.Literals.VIEW_RENDERING_MEMBERSHIP__OWNED_RENDERING, true);
	}
	...
	public void setOwnedRendering(RenderingUsage newOwnedRendering) {
		eSet(SysMLPackage.Literals.VIEW_RENDERING_MEMBERSHIP__OWNED_RENDERING, newOwnedRendering);
	}
	...
	public RenderingUsage getReferencedRendering() {
		return (RenderingUsage)eGet(SysMLPackage.Literals.VIEW_RENDERING_MEMBERSHIP__REFERENCED_RENDERING, true);
	}
	...
	public void setReferencedRendering(RenderingUsage newReferencedRendering) {
		eSet(SysMLPackage.Literals.VIEW_RENDERING_MEMBERSHIP__REFERENCED_RENDERING, newReferencedRendering);
	}
	...
	public Feature getOwnedMemberFeature() {
		var sourceValue = this.getOwnedRendering();
