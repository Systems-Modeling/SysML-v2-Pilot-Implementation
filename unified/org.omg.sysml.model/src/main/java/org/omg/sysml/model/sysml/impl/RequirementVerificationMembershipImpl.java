 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.model.sysml.impl.RequirementVerificationMembershipImpl#getOwnedRequirement <em>Owned Requirement</em>}</li>
 *   <li>{@link org.omg.sysml.model.sysml.impl.RequirementVerificationMembershipImpl#getVerifiedRequirement <em>Verified Requirement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequirementVerificationMembershipImpl extends RequirementConstraintMembershipImpl implements RequirementVerificationMembership {
	...
	public RequirementUsage getOwnedRequirement() {
		return (RequirementUsage)eGet(SysMLPackage.Literals.REQUIREMENT_VERIFICATION_MEMBERSHIP__OWNED_REQUIREMENT, true);
	}
	...
	public void setOwnedRequirement(RequirementUsage newOwnedRequirement) {
		eSet(SysMLPackage.Literals.REQUIREMENT_VERIFICATION_MEMBERSHIP__OWNED_REQUIREMENT, newOwnedRequirement);
	}
	...
	public RequirementUsage getVerifiedRequirement() {
		return (RequirementUsage)eGet(SysMLPackage.Literals.REQUIREMENT_VERIFICATION_MEMBERSHIP__VERIFIED_REQUIREMENT, true);
	}
	...
	public void setVerifiedRequirement(RequirementUsage newVerifiedRequirement) {
		eSet(SysMLPackage.Literals.REQUIREMENT_VERIFICATION_MEMBERSHIP__VERIFIED_REQUIREMENT, newVerifiedRequirement);
	}
	...
	public ConstraintUsage getOwnedConstraint() {
		var sourceValue = this.getOwnedRequirement();
	...
	public ConstraintUsage getReferencedConstraint() {
		var sourceValue = this.getVerifiedRequirement();
		Object source = sourceValue;
		if (source instanceof Iterable<?> values) {
			for (var value : values) {
				if (value instanceof ConstraintUsage typedValue) {
