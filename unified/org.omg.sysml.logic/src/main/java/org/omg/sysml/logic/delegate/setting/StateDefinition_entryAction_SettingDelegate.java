...
/**
 * Generated setting delegate for {@code StateDefinition.entryAction}.
 */
public class StateDefinition_entryAction_SettingDelegate extends AbstractSettingDelegate {

    public StateDefinition_entryAction_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "StateDefinition.entryAction";
    }
    ...
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * OCL2.0 deriveStateDefinitionEntryAction
         * entryAction =
