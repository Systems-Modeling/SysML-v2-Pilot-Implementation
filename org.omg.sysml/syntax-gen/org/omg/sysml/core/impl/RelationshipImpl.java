 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.sysml.core.impl.RelationshipImpl#getRelated <em>Related</em>}</li>
 *   <li>{@link org.omg.sysml.core.impl.RelationshipImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link org.omg.sysml.core.impl.RelationshipImpl#getSource <em>Source</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationshipImpl extends ElementImpl implements Relationship {
	...
	public EList<Element> getRelated() {
		if (related == null) {
			related = new EObjectResolvingEList<Element>(Element.class, this, CorePackage.RELATIONSHIP__RELATED);
		}
		return related;
	}
	...
	public void setTarget(Element newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.RELATIONSHIP__TARGET, oldTarget, target));
	}
	...
	public void setSource(Element newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.RELATIONSHIP__SOURCE, oldSource, source));
	}
