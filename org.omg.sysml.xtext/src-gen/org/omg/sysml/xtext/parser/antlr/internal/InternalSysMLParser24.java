...
public abstract class InternalSysMLParser24 extends InternalSysMLParser23 {
    public InternalSysMLParser24(TokenStream input, RecognizerSharedState state) {
        super(input, state);
    }
    ...
    class DFA291 extends DFA {
        ...
        public String getDescription() {
            return "()* loopback of 20189:4: ( ( ruleRequirementBodyItem[null] )=>this_RequirementBodyItem_2= ruleRequirementBodyItem[$current] )*";
        }
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    case 0 : 
                        ...
                        else if ( (LA291_0==174) && (synpred16_InternalSysML())) {s = 2;}

                        else if ( (LA291_0==175) && (synpred16_InternalSysML())) {s = 3;}

                        else if ( (LA291_0==176) && (synpred16_InternalSysML())) {s = 4;}
                        ...
                        else if ( (LA291_0==177) && (synpred16_InternalSysML())) {s = 47;}

                        else if ( (LA291_0==178) && (synpred16_InternalSysML())) {s = 48;}
                        ...
                        else if ( (LA291_0==179) && (synpred16_InternalSysML())) {s = 73;}

                        else if ( (LA291_0==180) && (synpred16_InternalSysML())) {s = 74;}
                        ...
                        else if ( (LA291_0==181) && (synpred16_InternalSysML())) {s = 87;}

                        else if ( (LA291_0==182) && (synpred16_InternalSysML())) {s = 88;}

                        else if ( (LA291_0==183) && (synpred16_InternalSysML())) {s = 89;}

                        else if ( (LA291_0==184) && (synpred16_InternalSysML())) {s = 90;}
    ...
    class DFA293 extends DFA {
        ...
        public String getDescription() {
            return "20220:2: (this_DefinitionBodyItem_0= ruleDefinitionBodyItem[$current] | ( (lv_ownedRelationship_1_0= ruleSubjectMember ) ) | ( (lv_ownedRelationship_2_0= ruleRequirementConstraintMember ) ) | ( (lv_ownedRelationship_3_0= ruleFramedConcernMember ) ) | ( (lv_ownedRelationship_4_0= ruleRequirementVerificationMember ) ) | ( (lv_ownedRelationship_5_0= ruleActorMember ) ) | ( (lv_ownedRelationship_6_0= ruleStakeholderMember ) ) )";
        }
    }
    static final String dfa_277s = "\11\uffff";
    static final String dfa_278s = "\1\40\1\10\1\uffff\1\54\4\10\1\uffff";
}