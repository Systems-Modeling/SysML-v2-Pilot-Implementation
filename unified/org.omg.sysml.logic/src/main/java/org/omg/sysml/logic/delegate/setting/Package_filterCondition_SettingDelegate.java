...
/**
 * Generated setting delegate for {@code Package.filterCondition}.
 */
public class Package_filterCondition_SettingDelegate extends AbstractSettingDelegate {

    public Package_filterCondition_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "Package.filterCondition";
    }
