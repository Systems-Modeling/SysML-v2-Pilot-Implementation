 ...
 * <li>{@link org.omg.sysml.lang.sysml.impl.MembershipImpl#getOwnedRelatedElement_comp
 ...
 * <em>Visibility</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.MembershipImpl#getMembershipOwningNamespace
 * <em>Membership Owning Namespace</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.MembershipImpl#getOwnedMemberElement_comp
 * <em>Owned Member Element comp</em>}</li>
...
public class MembershipImpl extends RelationshipImpl implements Membership {
	...
	/**
	 * The cached value of the '{@link #getOwnedMemberElement_comp() <em>Owned
	 * Member Element comp</em>}' containment reference. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * <!-- begin-user-doc --> Note: This is still necessary, because the Xtext lazy
	 * linker clears the memberElement value set via a call to
	 * setOwnedMemberElement_comp, but does not install a proxy. <!-- end-user-doc
	 * -->
	 * 
	 * @generated NOT
	 */
	...
	public void setMemberElement(Element newMemberElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.MEMBERSHIP__MEMBER_ELEMENT,
					oldMemberElement, memberElement));
		// Note: The generated code below causes the owned member element to be nulled
		// during the Xtext reconcilation process.
...
//		}
	...
	public EList<Element> getOwnedRelatedElement_comp() {
		if (ownedRelatedElement_comp == null) {
			ownedRelatedElement_comp = new EObjectContainmentWithInverseEList<Element>(Element.class, this,
					SysMLPackage.MEMBERSHIP__OWNED_RELATED_ELEMENT_COMP, SysMLPackage.ELEMENT__OWNING_RELATIONSHIP);
		}
	...
	public Namespace getMembershipOwningNamespace() {
		if (eContainerFeatureID() != SysMLPackage.MEMBERSHIP__MEMBERSHIP_OWNING_NAMESPACE)
			return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMembershipOwningNamespace(Namespace newMembershipOwningNamespace,
			NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newMembershipOwningNamespace,
				SysMLPackage.MEMBERSHIP__MEMBERSHIP_OWNING_NAMESPACE, msgs);
		return msgs;
	}
	...
	public void setMembershipOwningNamespace(Namespace newMembershipOwningNamespace) {
		if (newMembershipOwningNamespace != eInternalContainer()
				|| (eContainerFeatureID() != SysMLPackage.MEMBERSHIP__MEMBERSHIP_OWNING_NAMESPACE
						&& newMembershipOwningNamespace != null)) {
			...
			if (newMembershipOwningNamespace != null)
				msgs = ((InternalEObject) newMembershipOwningNamespace).eInverseAdd(this,
						SysMLPackage.NAMESPACE__OWNED_MEMBERSHIP_COMP, Namespace.class, msgs);
			msgs = basicSetMembershipOwningNamespace(newMembershipOwningNamespace, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.MEMBERSHIP__MEMBERSHIP_OWNING_NAMESPACE,
					newMembershipOwningNamespace, newMembershipOwningNamespace));
	}
	...
	public NotificationChain basicSetOwnedMemberElement_comp(Element newOwnedMemberElement_comp,
			NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOwnedMemberElement_compGen(Element newOwnedMemberElement_comp,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SysMLPackage.MEMBERSHIP__OWNED_MEMBER_ELEMENT_COMP, oldOwnedMemberElement_comp,
					newOwnedMemberElement_comp);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setOwnedMemberElement_comp(Element newOwnedMemberElement_comp) {
		if (newOwnedMemberElement_comp != ownedMemberElement_comp) {
			...
			if (ownedMemberElement_comp != null)
				msgs = ((InternalEObject) ownedMemberElement_comp).eInverseRemove(this,
						SysMLPackage.ELEMENT__OWNING_MEMBERSHIP, Element.class, msgs);
			if (newOwnedMemberElement_comp != null)
				msgs = ((InternalEObject) newOwnedMemberElement_comp).eInverseAdd(this,
						SysMLPackage.ELEMENT__OWNING_MEMBERSHIP, Element.class, msgs);
			msgs = basicSetOwnedMemberElement_comp(newOwnedMemberElement_comp, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.MEMBERSHIP__OWNED_MEMBER_ELEMENT_COMP,
					newOwnedMemberElement_comp, newOwnedMemberElement_comp));
	}
	...
	public Element getOwnedMemberElement() {
		Element ownedMemberElement = basicGetOwnedMemberElement();
		return ownedMemberElement != null && ownedMemberElement.eIsProxy()
				? (Element) eResolveProxy((InternalEObject) ownedMemberElement)
				: ownedMemberElement;
	}
...
//			)
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case SysMLPackage.MEMBERSHIP__OWNED_MEMBER_ELEMENT_COMP:
			if (ownedMemberElement_comp != null)
				msgs = ((InternalEObject) ownedMemberElement_comp).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SysMLPackage.MEMBERSHIP__OWNED_MEMBER_ELEMENT_COMP, null, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case SysMLPackage.MEMBERSHIP__MEMBERSHIP_OWNING_NAMESPACE:
			return eInternalContainer().eInverseRemove(this, SysMLPackage.NAMESPACE__OWNED_MEMBERSHIP_COMP,
