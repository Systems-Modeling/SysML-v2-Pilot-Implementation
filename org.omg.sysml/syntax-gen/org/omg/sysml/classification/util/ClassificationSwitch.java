	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ClassificationPackage.CLASS: {
				org.omg.sysml.classification.Class class_ = (org.omg.sysml.classification.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = caseNamespace(class_);
				if (result == null) result = caseElementGroup(class_);
			...
			case ClassificationPackage.FEATURE: {
				...
				if (result == null) result = caseElementGroup(feature);
