...
public class Namespace_resolveVisible_InvocationDelegate extends BasicInvocationDelegate {
	...
	public Object dynamicInvoke(InternalEObject target, EList<?> arguments) throws InvocationTargetException {
		...
		return self.visibleMemberships(new BasicEList<>(), false, false).stream().
				filter(mem->
