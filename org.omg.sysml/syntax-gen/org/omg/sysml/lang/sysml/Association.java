 ...
 *
 * <!-- begin-model-doc --> An Association specifies multiple semantic
 * relationships (pairs) that can occur between individuals of a given Category.
 * It has at least two participant properties to connect Categories. These
 * properties can have further properties nested under them in order to provide
 * navigation between one Category and another. relatedTypes =
 * associationEnd.type <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link org.omg.sysml.lang.sysml.Association#getRelatedType <em>Related
 * Type</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.Association#getOwningConnector <em>Owning
 * Connector</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.Association#getAssociationEnd
...
public interface Association extends org.omg.sysml.lang.sysml.Class, Relationship {
	/**
	 * Returns the value of the '<em><b>Related Type</b></em>' reference list. The
	 ...
	 * </p>
	 * <!-- end-user-doc --> <!-- begin-model-doc --> The types of the endFeatures
	 * of the Association, which are the relatedElements of the Association
	 * considered as a Relationship. <!-- end-model-doc -->
	 * 
	 ...
	 *        body='association'" annotation="redefines"
	 * @generated
	 */
	EList<Type> getRelatedType();

	/**
	 * Returns the value of the '<em><b>Owning Connector</b></em>' reference. It is
	 * bidirectional and its opposite is
	 * '{@link org.omg.sysml.lang.sysml.Connector#getOwnedAssociationType <em>Owned
	 * Association Type</em>}'. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @model opposite="ownedAssociationType" transient="true" volatile="true"
	 ...
	 * Connector</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
