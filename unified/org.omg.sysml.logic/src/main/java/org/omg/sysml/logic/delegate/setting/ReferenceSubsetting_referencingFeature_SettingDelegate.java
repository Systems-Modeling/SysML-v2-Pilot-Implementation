...
/**
 * Generated setting delegate for {@code ReferenceSubsetting.referencingFeature}.
 */
public class ReferenceSubsetting_referencingFeature_SettingDelegate extends AbstractSettingDelegate {

    public ReferenceSubsetting_referencingFeature_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "ReferenceSubsetting.referencingFeature";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * redefines fallback for ReferenceSubsetting.referencingFeature
