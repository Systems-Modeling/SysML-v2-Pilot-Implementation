...
/**
 * Generated setting delegate for {@code AnalysisCaseUsage.resultExpression}.
 */
public class AnalysisCaseUsage_resultExpression_SettingDelegate extends AbstractSettingDelegate {

    public AnalysisCaseUsage_resultExpression_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "AnalysisCaseUsage.resultExpression";
    }
    ...
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * OCL2.0 deriveAnalysisCaseUsageResultExpression
         * resultExpression =
         ...
         */
        Object result = null;
        if (owner instanceof AnalysisCaseUsage self) {
