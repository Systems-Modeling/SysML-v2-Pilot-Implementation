...
public class KerMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KerMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getGeneralTypeAccess().getAlternatives(), "rule__GeneralType__Alternatives");
			...
			builder.put(grammarAccess.getSubsettedFeatureAccess().getAlternatives(), "rule__SubsettedFeature__Alternatives");
			builder.put(grammarAccess.getRedefinitionAccess().getAlternatives_3(), "rule__Redefinition__Alternatives_3");
			builder.put(grammarAccess.getRedefinedFeatureAccess().getAlternatives(), "rule__RedefinedFeature__Alternatives");
			...
			builder.put(grammarAccess.getGeneralTypeAccess().getGeneralAssignment_0(), "rule__GeneralType__GeneralAssignment_0");
			builder.put(grammarAccess.getGeneralTypeAccess().getOwnedRelatedElementAssignment_1(), "rule__GeneralType__OwnedRelatedElementAssignment_1");
			...
			builder.put(grammarAccess.getSubsettedFeatureAccess().getSubsettedFeatureAssignment_0(), "rule__SubsettedFeature__SubsettedFeatureAssignment_0");
			builder.put(grammarAccess.getSubsettedFeatureAccess().getOwnedRelatedElementAssignment_1(), "rule__SubsettedFeature__OwnedRelatedElementAssignment_1");
			...
			builder.put(grammarAccess.getRedefinedFeatureAccess().getRedefinedFeatureAssignment_0(), "rule__RedefinedFeature__RedefinedFeatureAssignment_0");
			builder.put(grammarAccess.getRedefinedFeatureAccess().getOwnedRelatedElementAssignment_1(), "rule__RedefinedFeature__OwnedRelatedElementAssignment_1");
