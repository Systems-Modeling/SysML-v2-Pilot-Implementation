...
/**
 * Generated setting delegate for {@code InterfaceUsage.interfaceDefinition}.
 */
public class InterfaceUsage_interfaceDefinition_SettingDelegate extends AbstractSettingDelegate {

    public InterfaceUsage_interfaceDefinition_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "InterfaceUsage.interfaceDefinition";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * inferred fallback for InterfaceUsage.interfaceDefinition
        ...
        var values = new BasicEList<Object>();
        {
            ...
            } else if (sourceValue instanceof InterfaceDefinition) {
