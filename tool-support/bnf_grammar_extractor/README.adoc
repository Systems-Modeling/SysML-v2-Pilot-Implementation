...
Tool to extract concrete KerML and SysML v2 concrete language grammars from their respective specifications and check them for correctness.
...
> Note: These instructions are for use of View Editor with the FireFox browser. Tested with FireFox v130.0.1 on Windows 11. In other browsers the menu or key to inspect the source code
