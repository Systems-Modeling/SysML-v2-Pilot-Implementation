...
import org.omg.sysml.model.sysml.Class;
import org.omg.sysml.logic.delegate.AbstractSettingDelegate;

/**
 * Generated setting delegate for {@code OccurrenceUsage.occurrenceDefinition}.
 */
public class OccurrenceUsage_occurrenceDefinition_SettingDelegate extends AbstractSettingDelegate {

    public OccurrenceUsage_occurrenceDefinition_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }

    @Override
    protected String delegateId() {
        return "OccurrenceUsage.occurrenceDefinition";
    }

    @Override
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        /*
         * inferred fallback for OccurrenceUsage.occurrenceDefinition
        ...
        var values = new BasicEList<Object>();
        {
            ...
            } else if (sourceValue instanceof Class) {
