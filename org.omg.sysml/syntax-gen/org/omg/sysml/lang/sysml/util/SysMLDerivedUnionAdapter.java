...
public class SysMLDerivedUnionAdapter extends AdapterImpl {
	...
	protected void notifyChanged(Notification notification, EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SysMLPackage.CONSTRAINT_DEFINITION:
				...
				break;
			case SysMLPackage.FUNCTION_USAGE:
				notifyFunctionUsageChanged(notification, eClass);
				break;
			...
			case SysMLPackage.DECISION_NODE:
				...
				break;
			case SysMLPackage.FUNCTION_DEFINITION:
				notifyFunctionDefinitionChanged(notification, eClass);
				break;
	 ...
	 * @generated
	 */
	protected void notifyFunctionDefinitionChanged(Notification notification, EClass eClass) {
		switch (notification.getFeatureID(FunctionDefinition.class)) {
			case SysMLPackage.FUNCTION_DEFINITION__IMPORTED_MEMBERSHIP:
				notifyChanged(notification, eClass, SysMLPackage.Literals.PACKAGE__MEMBERSHIP);
				break;
			case SysMLPackage.FUNCTION_DEFINITION__OWNED_MEMBERSHIP:
				notifyChanged(notification, eClass, SysMLPackage.Literals.PACKAGE__MEMBERSHIP);
				break;
			case SysMLPackage.FUNCTION_DEFINITION__INHERITED_MEMBERSHIP:
				notifyChanged(notification, eClass, SysMLPackage.Literals.PACKAGE__MEMBERSHIP);
				break;
		}
	}
	 ...
	 * @generated
	 */
	protected void notifyFunctionUsageChanged(Notification notification, EClass eClass) {
		switch (notification.getFeatureID(FunctionUsage.class)) {
			case SysMLPackage.FUNCTION_USAGE__IMPORTED_MEMBERSHIP:
				notifyChanged(notification, eClass, SysMLPackage.Literals.PACKAGE__MEMBERSHIP);
				break;
			case SysMLPackage.FUNCTION_USAGE__OWNED_MEMBERSHIP:
				notifyChanged(notification, eClass, SysMLPackage.Literals.PACKAGE__MEMBERSHIP);
				break;
			case SysMLPackage.FUNCTION_USAGE__INHERITED_MEMBERSHIP:
				notifyChanged(notification, eClass, SysMLPackage.Literals.PACKAGE__MEMBERSHIP);
				break;
		}
	}
