...
public class SysMLFactoryImpl extends EFactoryImpl implements SysMLFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SysMLPackage.VARIABLE_FEATURE_MEMBERSHIP: return createVariableFeatureMembership();
			default:
	 ...
	 */
	@Override
	public VariableFeatureMembership createVariableFeatureMembership() {
		VariableFeatureMembershipImpl variableFeatureMembership = new VariableFeatureMembershipImpl();
		return variableFeatureMembership;
	}
