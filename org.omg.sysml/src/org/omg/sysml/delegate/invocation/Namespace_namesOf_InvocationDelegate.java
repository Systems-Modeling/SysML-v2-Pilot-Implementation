...
public class Namespace_namesOf_InvocationDelegate extends BasicInvocationDelegate {
	...
	public Object dynamicInvoke(InternalEObject target, EList<?> arguments) throws InvocationTargetException {
		...
		EList<String> names = new EDataTypeUniqueEList<String>(String.class, target, SysMLPackage.NAMESPACE___NAMES_OF__ELEMENT);
		self.getMembership().stream().
