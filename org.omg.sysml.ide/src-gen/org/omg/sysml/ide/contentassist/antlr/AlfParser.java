...
public class AlfParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AlfGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFeatureCategoryMemberAccess().getOwnedRelatedElementAssignment_1_1_1(), "rule__FeatureCategoryMember__OwnedRelatedElementAssignment_1_1_1");
			...
			builder.put(grammarAccess.getFeatureCategoryMemberAccess().getOwnedRelatedElementAssignment_1_2_2(), "rule__FeatureCategoryMember__OwnedRelatedElementAssignment_1_2_2");
			...
			builder.put(grammarAccess.getFeatureMemberElementAccess().getOwnedRelatedElementAssignment_1_3(), "rule__FeatureMemberElement__OwnedRelatedElementAssignment_1_3");
			builder.put(grammarAccess.getFeatureMemberElementAccess().getOwnedRelatedElementAssignment_2_1_0(), "rule__FeatureMemberElement__OwnedRelatedElementAssignment_2_1_0");
			...
			builder.put(grammarAccess.getFeatureMemberElementAccess().getOwnedRelatedElementAssignment_3_2(), "rule__FeatureMemberElement__OwnedRelatedElementAssignment_3_2");
