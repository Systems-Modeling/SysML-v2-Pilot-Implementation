 ...
 * </p>
 * <ul>
 * <li>{@link org.omg.sysml.lang.sysml.impl.FeatureValueImpl#getOwnedRelatedElement
 * <em>Owned Related Element</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.FeatureValueImpl#getOwningRelatedElement
 * <em>Owning Related Element</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.FeatureValueImpl#getValue
 * <em>Value</em>}</li>
 * <li>{@link org.omg.sysml.lang.sysml.impl.FeatureValueImpl#getFeatureWithValue
 * <em>Feature With Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureValueImpl extends RelationshipImpl implements FeatureValue {
	...
	/**
	 * The cached value of the '{@link #getFeatureWithValue() <em>Feature With
	 * Value</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public EList<Element> getOwnedRelatedElement() {
		if (ownedRelatedElement == null) {
			ownedRelatedElement = new SubsetSupersetEObjectContainmentWithInverseEList<Element>(Element.class, this,
					SysMLPackage.FEATURE_VALUE__OWNED_RELATED_ELEMENT, null, OWNED_RELATED_ELEMENT_ESUBSETS,
	...
	public Element getOwningRelatedElement() {
		if (eContainerFeatureID() != SysMLPackage.FEATURE_VALUE__OWNING_RELATED_ELEMENT)
			return null;
	...
	public NotificationChain basicSetOwningRelatedElement(Element newOwningRelatedElement, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newOwningRelatedElement,
				SysMLPackage.FEATURE_VALUE__OWNING_RELATED_ELEMENT, msgs);
	...
	public void setOwningRelatedElement(Element newOwningRelatedElement) {
		if (newOwningRelatedElement != eInternalContainer()
				|| (eContainerFeatureID() != SysMLPackage.FEATURE_VALUE__OWNING_RELATED_ELEMENT
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.FEATURE_VALUE__OWNING_RELATED_ELEMENT,
		...
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SysMLPackage.FEATURE_VALUE__VALUE,
							oldValue, value));
			}
		}
		return value;
			...
			if (featureWithValue != oldFeatureWithValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SysMLPackage.FEATURE_VALUE__FEATURE_WITH_VALUE, oldFeatureWithValue, featureWithValue));
			}
		}
	...
	public NotificationChain basicSetFeatureWithValue(Feature newFeatureWithValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SysMLPackage.FEATURE_VALUE__FEATURE_WITH_VALUE, oldFeatureWithValue, newFeatureWithValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case SysMLPackage.FEATURE_VALUE__FEATURE_WITH_VALUE:
			if (featureWithValue != null)
				msgs = ((InternalEObject) featureWithValue).eInverseRemove(this, SysMLPackage.FEATURE__VALUATION,
						Feature.class, msgs);
