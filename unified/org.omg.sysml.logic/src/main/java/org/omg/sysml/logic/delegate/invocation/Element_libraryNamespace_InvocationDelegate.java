...
/**
 * Generated invocation delegate for {@code Element::libraryNamespace}.
 */
public class Element_libraryNamespace_InvocationDelegate extends AbstractInvocationDelegate {

    public Element_libraryNamespace_InvocationDelegate(EOperation operation) {
        super(operation);
    }
