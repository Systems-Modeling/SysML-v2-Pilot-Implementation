...
public class SysMLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == SysMLPackage.eINSTANCE)
			...
			case SysMLPackage.PACKAGE:
				sequence_Package(context, (org.omg.sysml.usage.sysML.Package) semanticObject); 
				return; 
	 ...
	 */
	protected void sequence_Package(ISerializationContext context, org.omg.sysml.usage.sysML.Package semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
