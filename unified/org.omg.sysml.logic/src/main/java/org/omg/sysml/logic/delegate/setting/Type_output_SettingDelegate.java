...
/**
 * Generated setting delegate for {@code Type.output}.
 */
public class Type_output_SettingDelegate extends AbstractSettingDelegate {

    public Type_output_SettingDelegate(EStructuralFeature feature) {
        super(feature);
    }
    ...
    protected Object get(InternalEObject owner, boolean resolve, boolean coreType) {
        ...
        if (owner instanceof Type self) {
            for (var feature : self.getFeature()) {
                ...
                if (direction == FeatureDirectionKind.OUT || direction == FeatureDirectionKind.INOUT) {
                    result.add(feature);
                }
            }
        }
